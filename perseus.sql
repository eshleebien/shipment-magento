...
DROP TABLE IF EXISTS `shop_admin_assert`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_admin_assert` (
...
INSERT INTO `shop_admin_role` VALUES (1,0,1,1,'G',0,'Administrators'),(2,1,2,0,'U',1,'Eshlee'),(3,1,2,0,'U',2,'Jonathan'),(4,1,2,0,'U',3,'Perseus');
...
DROP TABLE IF EXISTS `shop_admin_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_admin_rule` (
  ...
  PRIMARY KEY (`rule_id`),
  KEY `IDX_SHOP_ADMIN_RULE_RESOURCE_ID_ROLE_ID` (`resource_id`,`role_id`),
  KEY `IDX_SHOP_ADMIN_RULE_ROLE_ID_RESOURCE_ID` (`role_id`,`resource_id`),
...
INSERT INTO `shop_admin_user` VALUES (1,'Eshlee','Romero','hello@esh.ph','eshleebien','38dfc063b993faccf5b2d9eb1673511a:nATZEwHiFh9Nzhk3xopF5OuTZyjy71tY','2015-07-01 04:30:25','2015-07-01 04:30:25','2015-07-02 05:37:43',4,0,1,'N;',NULL,NULL),(2,'Jonathan','Cepeda','jon.jonathan@gmail.com','jon','95fdae6278c141066bcd26592db7b1d1:zIRFl6YLAFYJ3vSHOW9ll0sU4mLrk4S2','2015-07-01 05:34:33','2015-07-01 05:34:33','2015-07-01 07:20:17',2,0,1,'N;',NULL,NULL),(3,'Perseus','Laguador','laguador.p@gmail.com','perseusl','40060684d2d4993576f45fa3abc6332f:0TAQD5CdC1db4nOm6PVg5cl1NfMqRDYg','2015-07-02 05:43:25','2015-07-02 05:43:25','2015-07-03 22:32:51',3,0,1,'a:1:{s:11:\"configState\";a:28:{s:14:\"design_package\";s:1:\"1\";s:12:\"design_theme\";s:1:\"1\";s:11:\"design_head\";s:1:\"0\";s:13:\"design_header\";s:1:\"0\";s:13:\"design_footer\";s:1:\"0\";s:16:\"design_watermark\";s:1:\"0\";s:17:\"design_pagination\";s:1:\"0\";s:12:\"design_email\";s:1:\"0\";s:16:\"checkout_options\";s:1:\"0\";s:13:\"checkout_cart\";s:1:\"1\";s:18:\"checkout_cart_link\";s:1:\"0\";s:16:\"checkout_sidebar\";s:1:\"0\";s:23:\"checkout_payment_failed\";s:1:\"0\";s:16:\"catalog_frontend\";s:1:\"1\";s:15:\"catalog_sitemap\";s:1:\"0\";s:14:\"catalog_review\";s:1:\"0\";s:21:\"catalog_product_image\";s:1:\"0\";s:20:\"catalog_productalert\";s:1:\"0\";s:25:\"catalog_productalert_cron\";s:1:\"0\";s:19:\"catalog_placeholder\";s:1:\"0\";s:25:\"catalog_recently_products\";s:1:\"0\";s:13:\"catalog_price\";s:1:\"0\";s:26:\"catalog_layered_navigation\";s:1:\"0\";s:18:\"catalog_navigation\";s:1:\"0\";s:11:\"catalog_seo\";s:1:\"0\";s:14:\"catalog_search\";s:1:\"0\";s:20:\"catalog_downloadable\";s:1:\"0\";s:22:\"catalog_custom_options\";s:1:\"0\";}}',NULL,NULL);
...
DROP TABLE IF EXISTS `shop_adminnotification_inbox`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_adminnotification_inbox` (
...
DROP TABLE IF EXISTS `shop_api2_acl_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_api2_acl_attribute` (
  ...
  UNIQUE KEY `UNQ_SHOP_SHOP_API2_ACL_ATTRIBUTE_USER_TYPE_RESOURCE_ID_OPERATION` (`user_type`,`resource_id`,`operation`),
  KEY `IDX_SHOP_API2_ACL_ATTRIBUTE_USER_TYPE` (`user_type`)
...
DROP TABLE IF EXISTS `shop_api2_acl_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_api2_acl_role` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'Updated At',
  `role_name` varchar(255) NOT NULL COMMENT 'Name of role',
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_API2_ACL_ROLE_CREATED_AT` (`created_at`),
...
DROP TABLE IF EXISTS `shop_api2_acl_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_api2_acl_rule` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  `role_id` int(10) unsigned NOT NULL COMMENT 'Role ID',
  `resource_id` varchar(255) NOT NULL COMMENT 'Resource ID',
  `privilege` varchar(20) DEFAULT NULL COMMENT 'ACL Privilege',
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `UNQ_SHOP_SHOP_API2_ACL_RULE_ROLE_ID_RESOURCE_ID_PRIVILEGE` (`role_id`,`resource_id`,`privilege`),
  CONSTRAINT `FK_SHOP_API2_ACL_RULE_ROLE_ID_SHOP_API2_ACL_ROLE_ENTITY_ID` FOREIGN KEY (`role_id`) REFERENCES `shop_api2_acl_role` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_api2_acl_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_api2_acl_user` (
  `admin_id` int(10) unsigned NOT NULL COMMENT 'Admin ID',
  `role_id` int(10) unsigned NOT NULL COMMENT 'Role ID',
  UNIQUE KEY `UNQ_SHOP_SHOP_API2_ACL_USER_ADMIN_ID` (`admin_id`),
  KEY `FK_SHOP_API2_ACL_USER_ROLE_ID_SHOP_API2_ACL_ROLE_ENTITY_ID` (`role_id`),
  CONSTRAINT `FK_SHOP_API2_ACL_USER_ADMIN_ID_SHOP_ADMIN_USER_USER_ID` FOREIGN KEY (`admin_id`) REFERENCES `shop_admin_user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_API2_ACL_USER_ROLE_ID_SHOP_API2_ACL_ROLE_ENTITY_ID` FOREIGN KEY (`role_id`) REFERENCES `shop_api2_acl_role` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_api_assert`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_api_assert` (
  `assert_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Assert id',
  `assert_type` varchar(20) DEFAULT NULL COMMENT 'Assert type',
...
DROP TABLE IF EXISTS `shop_api_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_api_role` (
  `role_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Role id',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Parent role id',
  ...
  `role_name` varchar(50) DEFAULT NULL COMMENT 'Role name',
  PRIMARY KEY (`role_id`),
  KEY `IDX_SHOP_API_ROLE_PARENT_ID_SORT_ORDER` (`parent_id`,`sort_order`),
...
DROP TABLE IF EXISTS `shop_api_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_api_rule` (
  ...
  PRIMARY KEY (`rule_id`),
  KEY `IDX_SHOP_API_RULE_RESOURCE_ID_ROLE_ID` (`resource_id`,`role_id`),
  KEY `IDX_SHOP_API_RULE_ROLE_ID_RESOURCE_ID` (`role_id`,`resource_id`),
  CONSTRAINT `FK_SHOP_API_RULE_ROLE_ID_SHOP_API_ROLE_ROLE_ID` FOREIGN KEY (`role_id`) REFERENCES `shop_api_role` (`role_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_api_session`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_api_session` (
  `user_id` int(10) unsigned NOT NULL COMMENT 'User id',
  `logdate` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Login date',
  `sessid` varchar(40) DEFAULT NULL COMMENT 'Sessioin id',
  KEY `IDX_SHOP_API_SESSION_USER_ID` (`user_id`),
  KEY `IDX_SHOP_API_SESSION_SESSID` (`sessid`),
...
DROP TABLE IF EXISTS `shop_api_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_api_user` (
  `user_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'User id',
...
DROP TABLE IF EXISTS `shop_captcha_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_captcha_log` (
...
DROP TABLE IF EXISTS `shop_catalog_category_anc_categs_index_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_anc_categs_index_idx` (
  `category_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Category ID',
  `path` varchar(255) DEFAULT NULL COMMENT 'Path',
  KEY `IDX_SHOP_CATALOG_CATEGORY_ANC_CATEGS_INDEX_IDX_CATEGORY_ID` (`category_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ANC_CATEGS_INDEX_IDX_PATH_CATEGORY_ID` (`path`,`category_id`)
...
DROP TABLE IF EXISTS `shop_catalog_category_anc_categs_index_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_anc_categs_index_tmp` (
  `category_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Category ID',
  `path` varchar(255) DEFAULT NULL COMMENT 'Path',
  KEY `IDX_SHOP_CATALOG_CATEGORY_ANC_CATEGS_INDEX_TMP_CATEGORY_ID` (`category_id`),
...
DROP TABLE IF EXISTS `shop_catalog_category_anc_products_index_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_anc_products_index_idx` (
  `category_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Category ID',
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  `position` int(10) unsigned DEFAULT NULL COMMENT 'Position',
  KEY `IDX_SHOP_CAT_CTGR_ANC_PRDS_IDX_IDX_CTGR_ID_PRD_ID_POSITION` (`category_id`,`product_id`,`position`)
...
DROP TABLE IF EXISTS `shop_catalog_category_anc_products_index_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_anc_products_index_tmp` (
  `category_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Category ID',
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  `position` int(10) unsigned DEFAULT NULL COMMENT 'Position',
...
DROP TABLE IF EXISTS `shop_catalog_category_entity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_entity` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  ...
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_LEVEL` (`level`),
...
DROP TABLE IF EXISTS `shop_catalog_category_entity_datetime`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_entity_datetime` (
  ...
  UNIQUE KEY `EA4F19E4B4625470A2AAC9DB3ECF06D8` (`entity_type_id`,`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_DATETIME_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_DATETIME_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_DATETIME_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_DTIME_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_DTIME_ENTT_ID_SHOP_CAT_CTGR_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_category_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_DTIME_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_category_entity_decimal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_entity_decimal` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type ID',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_CTGR_ENTT_DEC_ENTT_TYPE_ID_ENTT_ID_ATTR_ID_STORE_ID` (`entity_type_id`,`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_DECIMAL_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_DECIMAL_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_DEC_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_DEC_ENTT_ID_SHOP_CAT_CTGR_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_category_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_catalog_category_entity_int`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_entity_int` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type ID',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_CTGR_ENTT_INT_ENTT_TYPE_ID_ENTT_ID_ATTR_ID_STORE_ID` (`entity_type_id`,`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_INT_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_INT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_INT_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_INT_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_INT_ENTT_ID_SHOP_CAT_CTGR_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_category_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_INT_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_category_entity_text`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_entity_text` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type ID',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `6CA0140F084F4496A0743D326D0846CB` (`entity_type_id`,`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_TEXT_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_TEXT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_TEXT_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_TEXT_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_TEXT_ENTT_ID_SHOP_CAT_CTGR_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_category_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_TEXT_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_category_entity_varchar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_entity_varchar` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type ID',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `F13BA7B3BC98A6F3BCF7B9A8D6840599` (`entity_type_id`,`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_VARCHAR_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_VARCHAR_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_ENTITY_VARCHAR_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_VCHR_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_CTGR_ENTT_VCHR_ENTT_ID_SHOP_CAT_CTGR_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_category_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_catalog_category_flat_store_1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_flat_store_1` (
  ...
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_FLAT_STORE_1_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_FLAT_STORE_1_PATH` (`path`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_FLAT_STORE_1_LEVEL` (`level`),
  CONSTRAINT `FK_SHOP_CAT_CTGR_FLAT_STORE_1_ENTT_ID_SHOP_CAT_CTGR_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_category_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_CTGR_FLAT_STORE_1_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_category_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_product` (
  `category_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Category ID',
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  `position` int(11) NOT NULL DEFAULT '0' COMMENT 'Position',
  PRIMARY KEY (`category_id`,`product_id`),
  KEY `IDX_SHOP_CATALOG_CATEGORY_PRODUCT_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_SHOP_CAT_CTGR_PRD_CTGR_ID_SHOP_CAT_CTGR_ENTT_ENTT_ID` FOREIGN KEY (`category_id`) REFERENCES `shop_catalog_category_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `shop_catalog_category_product` VALUES (2,1,1),(2,2,1);
...
DROP TABLE IF EXISTS `shop_catalog_category_product_index`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_product_index` (
  `category_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Category ID',
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  ...
  KEY `IDX_SHOP_CAT_CTGR_PRD_IDX_PRD_ID_STORE_ID_CTGR_ID_VISIBILITY` (`product_id`,`store_id`,`category_id`,`visibility`),
  KEY `36329A6D4E8E6E3B91F2C7CDEFA2E4B6` (`store_id`,`category_id`,`visibility`,`is_parent`,`position`),
  CONSTRAINT `FK_SHOP_CAT_CTGR_PRD_IDX_CTGR_ID_SHOP_CAT_CTGR_ENTT_ENTT_ID` FOREIGN KEY (`category_id`) REFERENCES `shop_catalog_category_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_CTGR_PRD_IDX_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_CTGR_PRD_IDX_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `shop_catalog_category_product_index` VALUES (2,1,1,1,1,4),(2,2,1,1,1,4);
...
DROP TABLE IF EXISTS `shop_catalog_category_product_index_enbl_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_product_index_enbl_idx` (
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  `visibility` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Visibility',
  KEY `IDX_SHOP_CATALOG_CATEGORY_PRODUCT_INDEX_ENBL_IDX_PRODUCT_ID` (`product_id`),
  KEY `IDX_SHOP_CAT_CTGR_PRD_IDX_ENBL_IDX_PRD_ID_VISIBILITY` (`product_id`,`visibility`)
...
DROP TABLE IF EXISTS `shop_catalog_category_product_index_enbl_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_product_index_enbl_tmp` (
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  `visibility` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Visibility',
  KEY `IDX_SHOP_CATALOG_CATEGORY_PRODUCT_INDEX_ENBL_TMP_PRODUCT_ID` (`product_id`),
...
DROP TABLE IF EXISTS `shop_catalog_category_product_index_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_product_index_idx` (
  `category_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Category ID',
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  `position` int(11) NOT NULL DEFAULT '0' COMMENT 'Position',
  `is_parent` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Is Parent',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  `visibility` smallint(5) unsigned NOT NULL COMMENT 'Visibility',
  KEY `IDX_SHOP_CAT_CTGR_PRD_IDX_IDX_PRD_ID_CTGR_ID_STORE_ID` (`product_id`,`category_id`,`store_id`)
...
DROP TABLE IF EXISTS `shop_catalog_category_product_index_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_category_product_index_tmp` (
  `category_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Category ID',
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  `position` int(11) NOT NULL DEFAULT '0' COMMENT 'Position',
  `is_parent` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Is Parent',
...
DROP TABLE IF EXISTS `shop_catalog_compare_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_compare_item` (
  ...
  KEY `IDX_SHOP_CATALOG_COMPARE_ITEM_CUSTOMER_ID` (`customer_id`),
  KEY `IDX_SHOP_CATALOG_COMPARE_ITEM_PRODUCT_ID` (`product_id`),
  KEY `IDX_SHOP_CATALOG_COMPARE_ITEM_VISITOR_ID_PRODUCT_ID` (`visitor_id`,`product_id`),
  KEY `IDX_SHOP_CATALOG_COMPARE_ITEM_CUSTOMER_ID_PRODUCT_ID` (`customer_id`,`product_id`),
  KEY `IDX_SHOP_CATALOG_COMPARE_ITEM_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CATALOG_COMPARE_ITEM_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_CMP_ITEM_CSTR_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_catalog_eav_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_eav_attribute` (
  ...
  KEY `IDX_SHOP_CATALOG_EAV_ATTRIBUTE_USED_FOR_SORT_BY` (`used_for_sort_by`),
  KEY `IDX_SHOP_CATALOG_EAV_ATTRIBUTE_USED_IN_PRODUCT_LISTING` (`used_in_product_listing`),
  CONSTRAINT `FK_SHOP_CAT_EAV_ATTR_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_bundle_option`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_bundle_option` (
  ...
  KEY `IDX_SHOP_CATALOG_PRODUCT_BUNDLE_OPTION_PARENT_ID` (`parent_id`),
  CONSTRAINT `FK_SHOP_CAT_PRD_BNDL_OPT_PARENT_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`parent_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_bundle_option_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_bundle_option_value` (
  `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `option_id` int(10) unsigned NOT NULL COMMENT 'Option Id',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store Id',
  `title` varchar(255) DEFAULT NULL COMMENT 'Title',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CATALOG_PRODUCT_BUNDLE_OPTION_VALUE_OPTION_ID_STORE_ID` (`option_id`,`store_id`),
...
DROP TABLE IF EXISTS `shop_catalog_product_bundle_price_index`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_bundle_price_index` (
  ...
  KEY `IDX_SHOP_CATALOG_PRODUCT_BUNDLE_PRICE_INDEX_WEBSITE_ID` (`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_BUNDLE_PRICE_INDEX_CUSTOMER_GROUP_ID` (`customer_group_id`),
  CONSTRAINT `FK_AE0F176408086485E416E3E681559370` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_BNDL_PRICE_IDX_ENTT_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_catalog_product_bundle_selection`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_bundle_selection` (
  ...
  KEY `IDX_SHOP_CATALOG_PRODUCT_BUNDLE_SELECTION_OPTION_ID` (`option_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_BUNDLE_SELECTION_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_D53F788FA59FCEBF4C9B021167E52BA1` FOREIGN KEY (`option_id`) REFERENCES `shop_catalog_product_bundle_option` (`option_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_BNDL_SELECTION_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_bundle_selection_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_bundle_selection_price` (
  `selection_id` int(10) unsigned NOT NULL COMMENT 'Selection Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  `selection_price_type` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Selection Price Type',
  `selection_price_value` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Selection Price Value',
  PRIMARY KEY (`selection_id`,`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_BUNDLE_SELECTION_PRICE_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_9588EC276BECDB01B17009E295C148B6` FOREIGN KEY (`selection_id`) REFERENCES `shop_catalog_product_bundle_selection` (`selection_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_BNDL_SELECTION_PRICE_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_bundle_stock_index`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_bundle_stock_index` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
...
DROP TABLE IF EXISTS `shop_catalog_product_enabled_index`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_enabled_index` (
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  `visibility` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Visibility',
  PRIMARY KEY (`product_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENABLED_INDEX_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CAT_PRD_ENABLED_IDX_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_catalog_product_entity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_entity` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type ID',
  ...
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'Update Time',
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_ATTRIBUTE_SET_ID` (`attribute_set_id`),
...
INSERT INTO `shop_catalog_product_entity` VALUES (1,4,4,'simple','k',0,0,'2015-01-07 04:37:27','2015-07-02 07:31:02'),(2,4,4,'simple','3333',0,0,'2015-07-02 07:42:55','2015-07-02 07:42:55');
...
DROP TABLE IF EXISTS `shop_catalog_product_entity_datetime`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_entity_datetime` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type ID',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  ...
  `value` datetime DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_ENTT_DTIME_ENTT_ID_ATTR_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_DATETIME_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_DATETIME_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_DATETIME_ENTITY_ID` (`entity_id`),
...
INSERT INTO `shop_catalog_product_entity_datetime` VALUES (1,4,93,0,1,NULL),(2,4,94,0,1,NULL),(3,4,77,0,1,NULL),(4,4,78,0,1,NULL),(5,4,104,0,1,NULL),(6,4,105,0,1,NULL),(25,4,93,0,2,NULL),(26,4,94,0,2,NULL),(27,4,77,0,2,NULL),(28,4,78,0,2,NULL),(29,4,104,0,2,NULL),(30,4,105,0,2,NULL);
...
DROP TABLE IF EXISTS `shop_catalog_product_entity_decimal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_entity_decimal` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type ID',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  ...
  `value` decimal(12,4) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_ENTT_DEC_ENTT_ID_ATTR_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_DECIMAL_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_DECIMAL_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
...
INSERT INTO `shop_catalog_product_entity_decimal` VALUES (1,4,80,0,1,12.0000),(2,4,75,0,1,10.0000),(3,4,76,0,1,NULL),(4,4,120,0,1,NULL),(14,4,80,0,2,111.0000),(15,4,75,0,2,111.0000),(16,4,76,0,2,NULL),(17,4,120,0,2,NULL);
...
DROP TABLE IF EXISTS `shop_catalog_product_entity_gallery`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_entity_gallery` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type ID',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  ...
  `value` varchar(255) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_ENTT_GLR_ENTT_TYPE_ID_ENTT_ID_ATTR_ID_STORE_ID` (`entity_type_id`,`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_GALLERY_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_GALLERY_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_GALLERY_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CAT_PRD_ENTT_GLR_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_ENTT_GLR_ENTT_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_ENTT_GLR_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_entity_group_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_entity_group_price` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity ID',
  ...
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `68299F621CCD2A982F9DB9629ABEDF3A` (`entity_id`,`all_groups`,`customer_group_id`,`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_GROUP_PRICE_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_GROUP_PRICE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_GROUP_PRICE_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_B016CDA919EBD0E41E5B4478517E97E8` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_F590265E5EAB5E7BFE170276383E0E38` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_ENTT_GROUP_PRICE_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_entity_int`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_entity_int` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  ...
  `value` int(11) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_ENTT_INT_ENTT_ID_ATTR_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_INT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_INT_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_INT_ENTITY_ID` (`entity_id`),
...
INSERT INTO `shop_catalog_product_entity_int` VALUES (1,4,96,0,1,1),(2,4,102,0,1,4),(3,4,121,0,1,0),(4,4,100,0,1,0),(5,4,96,0,2,1),(6,4,102,0,2,4),(7,4,121,0,2,0),(8,4,100,0,2,0);
...
DROP TABLE IF EXISTS `shop_catalog_product_entity_media_gallery`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_entity_media_gallery` (
  `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute ID',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity ID',
  `value` varchar(255) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_MEDIA_GALLERY_ATTRIBUTE_ID` (`attribute_id`),
...
INSERT INTO `shop_catalog_product_entity_media_gallery` VALUES (1,88,1,'/2/0/2015-03-24_11_32_32-cedric_abuso.png'),(2,88,1,'/2/0/2015_03_05_17_07_02_facebook.png'),(3,88,2,'/2/0/2015-03-24_11_43_14-reinald_vergara.png'),(4,88,2,'/2/0/2015-03-24_11_43_52-reinald_vergara.png'),(5,88,2,'/2/0/2015-03-24_11_36_52-din-din_bautista.png');
...
DROP TABLE IF EXISTS `shop_catalog_product_entity_media_gallery_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_entity_media_gallery_value` (
  ...
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_MEDIA_GALLERY_VALUE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_2968037A49914DABFEE7052ACECC88AA` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `shop_catalog_product_entity_media_gallery_value` VALUES (1,0,NULL,1,0),(2,0,NULL,2,0),(3,0,NULL,1,0),(4,0,NULL,2,0),(5,0,NULL,3,0);
...
DROP TABLE IF EXISTS `shop_catalog_product_entity_text`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_entity_text` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `entity_type_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type ID',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  ...
  `value` text COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_ENTT_TEXT_ENTT_ID_ATTR_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_TEXT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_TEXT_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_TEXT_ENTITY_ID` (`entity_id`),
...
INSERT INTO `shop_catalog_product_entity_text` VALUES (1,4,72,0,1,'This is a bottle with a twist'),(2,4,73,0,1,'With a twist inside a bottle'),(3,4,83,0,1,NULL),(4,4,106,0,1,NULL),(11,4,72,0,2,'sample product'),(12,4,73,0,2,'prodduct'),(13,4,83,0,2,NULL),(14,4,106,0,2,NULL);
...
DROP TABLE IF EXISTS `shop_catalog_product_entity_tier_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_entity_tier_price` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity ID',
  `all_groups` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'Is Applicable To All Customer Groups',
  `customer_group_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Customer Group ID',
  ...
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `AB0CA96D748716E066A32160263B6BFE` (`entity_id`,`all_groups`,`customer_group_id`,`qty`,`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_TIER_PRICE_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_TIER_PRICE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_TIER_PRICE_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_18F31A416EF78165C16900BE591936EB` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_8D66E73D8088377D9E5A82B6832CF93A` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_ENTT_TIER_PRICE_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_entity_varchar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_entity_varchar` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `entity_type_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type ID',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  ...
  `value` varchar(255) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_ENTT_VCHR_ENTT_ID_ATTR_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_VARCHAR_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_VARCHAR_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_ENTITY_VARCHAR_ENTITY_ID` (`entity_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COMMENT='Catalog Product Varchar Attribute Backend Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shop_catalog_product_entity_varchar` VALUES (1,4,71,0,1,'Botelya'),(2,4,97,0,1,'botelya'),(3,4,117,0,1,NULL),(4,4,118,0,1,'2'),(5,4,119,0,1,'4'),(6,4,82,0,1,NULL),(7,4,84,0,1,NULL),(8,4,85,0,1,'/2/0/2015-03-24_11_32_32-cedric_abuso.png'),(9,4,86,0,1,'/2/0/2015-03-24_11_32_32-cedric_abuso.png'),(10,4,87,0,1,'/2/0/2015-03-24_11_32_32-cedric_abuso.png'),(11,4,103,0,1,NULL),(12,4,107,0,1,NULL),(13,4,109,0,1,'container1'),(14,4,122,0,1,NULL),(15,4,98,1,1,'botelya.html'),(16,4,98,0,1,'botelya.html'),(17,4,112,0,1,NULL),(32,4,113,0,1,NULL),(33,4,114,0,1,NULL),(43,4,71,0,2,'simple 2'),(44,4,97,0,2,'simple-2'),(45,4,117,0,2,NULL),(46,4,118,0,2,'0'),(47,4,119,0,2,'4'),(48,4,82,0,2,NULL),(49,4,84,0,2,NULL),(50,4,85,0,2,'/2/0/2015-03-24_11_43_14-reinald_vergara.png'),(51,4,86,0,2,'/2/0/2015-03-24_11_43_14-reinald_vergara.png'),(52,4,87,0,2,'/2/0/2015-03-24_11_43_14-reinald_vergara.png'),(53,4,103,0,2,NULL),(54,4,107,0,2,NULL),(55,4,109,0,2,'container1'),(56,4,122,0,2,NULL),(57,4,112,0,2,NULL),(58,4,113,0,2,NULL),(59,4,114,0,2,NULL),(60,4,98,1,2,'simple-2.html'),(61,4,98,0,2,'simple-2.html');
...
DROP TABLE IF EXISTS `shop_catalog_product_flat_1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_flat_1` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'entity_id',
  ...
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_FLAT_1_TYPE_ID` (`type_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_FLAT_1_ATTRIBUTE_SET_ID` (`attribute_set_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_FLAT_1_NAME` (`name`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_FLAT_1_PRICE` (`price`),
  CONSTRAINT `FK_SHOP_SHOP_CAT_PRD_FLAT_1_ENTT_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_index_eav`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_eav` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `attribute_id` smallint(5) unsigned NOT NULL COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store ID',
  `value` int(10) unsigned NOT NULL COMMENT 'Value',
  PRIMARY KEY (`entity_id`,`attribute_id`,`store_id`,`value`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_VALUE` (`value`),
  CONSTRAINT `FK_SHOP_CAT_PRD_IDX_EAV_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_IDX_EAV_ENTT_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `shop_catalog_product_index_eav` VALUES (1,121,1,0),(2,121,1,0);
...
DROP TABLE IF EXISTS `shop_catalog_product_index_eav_decimal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_eav_decimal` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `attribute_id` smallint(5) unsigned NOT NULL COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store ID',
  `value` decimal(12,4) NOT NULL COMMENT 'Value',
  PRIMARY KEY (`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_VALUE` (`value`),
  CONSTRAINT `FK_SHOP_CAT_PRD_IDX_EAV_DEC_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_IDX_EAV_DEC_ENTT_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_IDX_EAV_DEC_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_index_eav_decimal_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_eav_decimal_idx` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `attribute_id` smallint(5) unsigned NOT NULL COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store ID',
  `value` decimal(12,4) NOT NULL COMMENT 'Value',
  PRIMARY KEY (`entity_id`,`attribute_id`,`store_id`,`value`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_IDX_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_IDX_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_IDX_STORE_ID` (`store_id`),
...
DROP TABLE IF EXISTS `shop_catalog_product_index_eav_decimal_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_eav_decimal_tmp` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `attribute_id` smallint(5) unsigned NOT NULL COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store ID',
  `value` decimal(12,4) NOT NULL COMMENT 'Value',
  PRIMARY KEY (`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_TMP_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_TMP_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_TMP_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_DECIMAL_TMP_VALUE` (`value`)
...
DROP TABLE IF EXISTS `shop_catalog_product_index_eav_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_eav_idx` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `attribute_id` smallint(5) unsigned NOT NULL COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store ID',
  `value` int(10) unsigned NOT NULL COMMENT 'Value',
  PRIMARY KEY (`entity_id`,`attribute_id`,`store_id`,`value`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_IDX_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_IDX_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_IDX_STORE_ID` (`store_id`),
...
INSERT INTO `shop_catalog_product_index_eav_idx` VALUES (1,121,1,0),(2,121,1,0);
...
DROP TABLE IF EXISTS `shop_catalog_product_index_eav_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_eav_tmp` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `attribute_id` smallint(5) unsigned NOT NULL COMMENT 'Attribute ID',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store ID',
  `value` int(10) unsigned NOT NULL COMMENT 'Value',
  PRIMARY KEY (`entity_id`,`attribute_id`,`store_id`,`value`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_TMP_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_TMP_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_TMP_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_EAV_TMP_VALUE` (`value`)
...
DROP TABLE IF EXISTS `shop_catalog_product_index_group_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_group_price` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `price` decimal(12,4) DEFAULT NULL COMMENT 'Min Price',
  PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_GROUP_PRICE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_GROUP_PRICE_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_93D01127190E35381D02D126AAC758DF` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_E603BEB12E31E588BE43672369F2AEA6` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  ...
  PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_PRICE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_PRICE_WEBSITE_ID` (`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_PRICE_MIN_PRICE` (`min_price`),
  KEY `IDX_SHOP_CAT_PRD_IDX_PRICE_WS_ID_CSTR_GROUP_ID_MIN_PRICE` (`website_id`,`customer_group_id`,`min_price`),
  CONSTRAINT `FK_0F8728AE9C9F0FE390BBEF669F6756D7` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_IDX_PRICE_ENTT_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_IDX_PRICE_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `shop_catalog_product_index_price` VALUES (1,0,1,0,10.0000,10.0000,10.0000,10.0000,NULL,NULL),(1,1,1,0,10.0000,10.0000,10.0000,10.0000,NULL,NULL),(1,2,1,0,10.0000,10.0000,10.0000,10.0000,NULL,NULL),(1,3,1,0,10.0000,10.0000,10.0000,10.0000,NULL,NULL),(2,0,1,0,111.0000,111.0000,111.0000,111.0000,NULL,NULL),(2,1,1,0,111.0000,111.0000,111.0000,111.0000,NULL,NULL),(2,2,1,0,111.0000,111.0000,111.0000,111.0000,NULL,NULL),(2,3,1,0,111.0000,111.0000,111.0000,111.0000,NULL,NULL);
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_bundle_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_bundle_idx` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity Id',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  `tax_class_id` smallint(5) unsigned DEFAULT '0' COMMENT 'Tax Class Id',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_bundle_opt_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_bundle_opt_idx` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity Id',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  `option_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Option Id',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_bundle_opt_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_bundle_opt_tmp` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity Id',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  `option_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Option Id',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_bundle_sel_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_bundle_sel_idx` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity Id',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  `option_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Option Id',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_bundle_sel_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_bundle_sel_tmp` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity Id',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  `option_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Option Id',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_bundle_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_bundle_tmp` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity Id',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  `tax_class_id` smallint(5) unsigned DEFAULT '0' COMMENT 'Tax Class Id',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_cfg_opt_agr_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_cfg_opt_agr_idx` (
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent ID',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_cfg_opt_agr_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_cfg_opt_agr_tmp` (
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent ID',
  `child_id` int(10) unsigned NOT NULL COMMENT 'Child ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_cfg_opt_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_cfg_opt_idx` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `min_price` decimal(12,4) DEFAULT NULL COMMENT 'Min Price',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_cfg_opt_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_cfg_opt_tmp` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `min_price` decimal(12,4) DEFAULT NULL COMMENT 'Min Price',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_downlod_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_downlod_idx` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_downlod_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_downlod_tmp` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `min_price` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Minimum price',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_final_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_final_idx` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `tax_class_id` smallint(5) unsigned DEFAULT '0' COMMENT 'Tax Class ID',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_final_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_final_tmp` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `tax_class_id` smallint(5) unsigned DEFAULT '0' COMMENT 'Tax Class ID',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_idx` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `tax_class_id` smallint(5) unsigned DEFAULT '0' COMMENT 'Tax Class ID',
  ...
  `group_price` decimal(12,4) DEFAULT NULL COMMENT 'Group price',
  PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_PRICE_IDX_CUSTOMER_GROUP_ID` (`customer_group_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_PRICE_IDX_WEBSITE_ID` (`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_PRICE_IDX_MIN_PRICE` (`min_price`)
...
INSERT INTO `shop_catalog_product_index_price_idx` VALUES (1,0,1,0,10.0000,10.0000,10.0000,10.0000,NULL,NULL),(1,1,1,0,10.0000,10.0000,10.0000,10.0000,NULL,NULL),(1,2,1,0,10.0000,10.0000,10.0000,10.0000,NULL,NULL),(1,3,1,0,10.0000,10.0000,10.0000,10.0000,NULL,NULL),(2,0,1,0,111.0000,111.0000,111.0000,111.0000,NULL,NULL),(2,1,1,0,111.0000,111.0000,111.0000,111.0000,NULL,NULL),(2,2,1,0,111.0000,111.0000,111.0000,111.0000,NULL,NULL),(2,3,1,0,111.0000,111.0000,111.0000,111.0000,NULL,NULL);
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_opt_agr_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_opt_agr_idx` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `option_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Option ID',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_opt_agr_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_opt_agr_tmp` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `option_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Option ID',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_opt_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_opt_idx` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `min_price` decimal(12,4) DEFAULT NULL COMMENT 'Min Price',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_opt_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_opt_tmp` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `min_price` decimal(12,4) DEFAULT NULL COMMENT 'Min Price',
...
DROP TABLE IF EXISTS `shop_catalog_product_index_price_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_price_tmp` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `tax_class_id` smallint(5) unsigned DEFAULT '0' COMMENT 'Tax Class ID',
  ...
  `group_price` decimal(12,4) DEFAULT NULL COMMENT 'Group price',
  PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_PRICE_TMP_CUSTOMER_GROUP_ID` (`customer_group_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_PRICE_TMP_WEBSITE_ID` (`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_PRICE_TMP_MIN_PRICE` (`min_price`)
...
DROP TABLE IF EXISTS `shop_catalog_product_index_tier_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_tier_price` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity ID',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `min_price` decimal(12,4) DEFAULT NULL COMMENT 'Min Price',
  PRIMARY KEY (`entity_id`,`customer_group_id`,`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_TIER_PRICE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_TIER_PRICE_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_D2E74D3F8E14E24949BACCB49E473127` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_IDX_TIER_PRICE_ENTT_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_IDX_TIER_PRICE_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_index_website`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_index_website` (
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  `website_date` date DEFAULT NULL COMMENT 'Website Date',
  `rate` float DEFAULT '1' COMMENT 'Rate',
  PRIMARY KEY (`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_INDEX_WEBSITE_WEBSITE_DATE` (`website_date`),
...
INSERT INTO `shop_catalog_product_index_website` VALUES (1,'2015-07-03',1);
...
DROP TABLE IF EXISTS `shop_catalog_product_link`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_link` (
  `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Link ID',
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  `linked_product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Linked Product ID',
  `link_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Link Type ID',
  PRIMARY KEY (`link_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_LNK_LNK_TYPE_ID_PRD_ID_LNKED_PRD_ID` (`link_type_id`,`product_id`,`linked_product_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_LINK_PRODUCT_ID` (`product_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_LINK_LINKED_PRODUCT_ID` (`linked_product_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_LINK_LINK_TYPE_ID` (`link_type_id`),
...
INSERT INTO `shop_catalog_product_link` VALUES (1,2,1,1);
...
DROP TABLE IF EXISTS `shop_catalog_product_link_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_link_attribute` (
  `product_link_attribute_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Product Link Attribute ID',
  `link_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Link Type ID',
  `product_link_attribute_code` varchar(32) DEFAULT NULL COMMENT 'Product Link Attribute Code',
  `data_type` varchar(32) DEFAULT NULL COMMENT 'Data Type',
  PRIMARY KEY (`product_link_attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_LINK_ATTRIBUTE_LINK_TYPE_ID` (`link_type_id`),
...
DROP TABLE IF EXISTS `shop_catalog_product_link_attribute_decimal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_link_attribute_decimal` (
  `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `product_link_attribute_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Product Link Attribute ID',
  `link_id` int(10) unsigned NOT NULL COMMENT 'Link ID',
  `value` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_LNK_ATTR_DEC_PRD_LNK_ATTR_ID_LNK_ID` (`product_link_attribute_id`,`link_id`),
  KEY `IDX_SHOP_CAT_PRD_LNK_ATTR_DEC_PRD_LNK_ATTR_ID` (`product_link_attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_LINK_ATTRIBUTE_DECIMAL_LINK_ID` (`link_id`),
  CONSTRAINT `FK_8601267DD1B12305A840E1B5BB54F318` FOREIGN KEY (`product_link_attribute_id`) REFERENCES `shop_catalog_product_link_attribute` (`product_link_attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_LNK_ATTR_DEC_LNK_ID_SHOP_CAT_PRD_LNK_LNK_ID` FOREIGN KEY (`link_id`) REFERENCES `shop_catalog_product_link` (`link_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_link_attribute_int`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_link_attribute_int` (
  `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `product_link_attribute_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Product Link Attribute ID',
  `link_id` int(10) unsigned NOT NULL COMMENT 'Link ID',
  `value` int(11) NOT NULL DEFAULT '0' COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_LNK_ATTR_INT_PRD_LNK_ATTR_ID_LNK_ID` (`product_link_attribute_id`,`link_id`),
  KEY `IDX_SHOP_CAT_PRD_LNK_ATTR_INT_PRD_LNK_ATTR_ID` (`product_link_attribute_id`),
...
INSERT INTO `shop_catalog_product_link_attribute_int` VALUES (1,1,1,0);
...
DROP TABLE IF EXISTS `shop_catalog_product_link_attribute_varchar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_link_attribute_varchar` (
  `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `product_link_attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Product Link Attribute ID',
  `link_id` int(10) unsigned NOT NULL COMMENT 'Link ID',
  `value` varchar(255) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_LNK_ATTR_VCHR_PRD_LNK_ATTR_ID_LNK_ID` (`product_link_attribute_id`,`link_id`),
  KEY `IDX_SHOP_CAT_PRD_LNK_ATTR_VCHR_PRD_LNK_ATTR_ID` (`product_link_attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_LINK_ATTRIBUTE_VARCHAR_LINK_ID` (`link_id`),
  CONSTRAINT `FK_2C8F9D589F82755E04EFB204E34A71D9` FOREIGN KEY (`product_link_attribute_id`) REFERENCES `shop_catalog_product_link_attribute` (`product_link_attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_LNK_ATTR_VCHR_LNK_ID_SHOP_CAT_PRD_LNK_LNK_ID` FOREIGN KEY (`link_id`) REFERENCES `shop_catalog_product_link` (`link_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_link_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_link_type` (
...
DROP TABLE IF EXISTS `shop_catalog_product_option`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_option` (
  `option_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option ID',
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  ...
  PRIMARY KEY (`option_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_OPTION_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_SHOP_CAT_PRD_OPT_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_option_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_option_price` (
  ...
  UNIQUE KEY `UNQ_SHOP_CATALOG_PRODUCT_OPTION_PRICE_OPTION_ID_STORE_ID` (`option_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_OPTION_PRICE_OPTION_ID` (`option_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_OPTION_PRICE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CAT_PRD_OPT_PRICE_OPT_ID_SHOP_CAT_PRD_OPT_OPT_ID` FOREIGN KEY (`option_id`) REFERENCES `shop_catalog_product_option` (`option_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_OPT_PRICE_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_option_title`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_option_title` (
  `option_title_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Title ID',
  `option_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Option ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  `title` varchar(255) DEFAULT NULL COMMENT 'Title',
  PRIMARY KEY (`option_title_id`),
  UNIQUE KEY `UNQ_SHOP_CATALOG_PRODUCT_OPTION_TITLE_OPTION_ID_STORE_ID` (`option_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_OPTION_TITLE_OPTION_ID` (`option_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_OPTION_TITLE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CAT_PRD_OPT_TTL_OPT_ID_SHOP_CAT_PRD_OPT_OPT_ID` FOREIGN KEY (`option_id`) REFERENCES `shop_catalog_product_option` (`option_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_catalog_product_option_type_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_option_type_price` (
  ...
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_OPT_TYPE_PRICE_OPT_TYPE_ID_STORE_ID` (`option_type_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_OPTION_TYPE_PRICE_OPTION_TYPE_ID` (`option_type_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_OPTION_TYPE_PRICE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_B7439B283876C439FC9D81C094B8FA49` FOREIGN KEY (`option_type_id`) REFERENCES `shop_catalog_product_option_type_value` (`option_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_OPT_TYPE_PRICE_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_option_type_title`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_option_type_title` (
  `option_type_title_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Type Title ID',
  `option_type_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Option Type ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  `title` varchar(255) DEFAULT NULL COMMENT 'Title',
  PRIMARY KEY (`option_type_title_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_OPT_TYPE_TTL_OPT_TYPE_ID_STORE_ID` (`option_type_id`,`store_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_OPTION_TYPE_TITLE_OPTION_TYPE_ID` (`option_type_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_OPTION_TYPE_TITLE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_8C57A59A3606B76A6E46738505FB0377` FOREIGN KEY (`option_type_id`) REFERENCES `shop_catalog_product_option_type_value` (`option_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_OPT_TYPE_TTL_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_option_type_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_option_type_value` (
  `option_type_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Type ID',
  `option_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Option ID',
  `sku` varchar(64) DEFAULT NULL COMMENT 'SKU',
  `sort_order` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Sort Order',
  PRIMARY KEY (`option_type_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_OPTION_TYPE_VALUE_OPTION_ID` (`option_id`),
...
DROP TABLE IF EXISTS `shop_catalog_product_relation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_relation` (
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent ID',
  `child_id` int(10) unsigned NOT NULL COMMENT 'Child ID',
  PRIMARY KEY (`parent_id`,`child_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_RELATION_CHILD_ID` (`child_id`),
  CONSTRAINT `FK_SHOP_CAT_PRD_RELATION_CHILD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`child_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_RELATION_PARENT_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`parent_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_super_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_super_attribute` (
  `product_super_attribute_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Product Super Attribute ID',
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute ID',
  `position` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Position',
  PRIMARY KEY (`product_super_attribute_id`),
  UNIQUE KEY `UNQ_SHOP_CATALOG_PRODUCT_SUPER_ATTRIBUTE_PRODUCT_ID_ATTRIBUTE_ID` (`product_id`,`attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_SUPER_ATTRIBUTE_PRODUCT_ID` (`product_id`),
...
DROP TABLE IF EXISTS `shop_catalog_product_super_attribute_label`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_super_attribute_label` (
  `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  ...
  `value` varchar(255) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_SPR_ATTR_LBL_PRD_SPR_ATTR_ID_STORE_ID` (`product_super_attribute_id`,`store_id`),
  KEY `IDX_SHOP_CAT_PRD_SPR_ATTR_LBL_PRD_SPR_ATTR_ID` (`product_super_attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_SUPER_ATTRIBUTE_LABEL_STORE_ID` (`store_id`),
  CONSTRAINT `FK_1EEDBF310C4AE0E2FA9AC435E3556040` FOREIGN KEY (`product_super_attribute_id`) REFERENCES `shop_catalog_product_super_attribute` (`product_super_attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_catalog_product_super_attribute_pricing`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_super_attribute_pricing` (
  `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value ID',
  `product_super_attribute_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product Super Attribute ID',
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CAT_PRD_SPR_ATTR_PRICING_PRD_SPR_ATTR_ID_VAL_IDX_WS_ID` (`product_super_attribute_id`,`value_index`,`website_id`),
  KEY `IDX_SHOP_CAT_PRD_SPR_ATTR_PRICING_PRD_SPR_ATTR_ID` (`product_super_attribute_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_SUPER_ATTRIBUTE_PRICING_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_3DF0D87DA4FD5475C5556B8CBB60310D` FOREIGN KEY (`product_super_attribute_id`) REFERENCES `shop_catalog_product_super_attribute` (`product_super_attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_SPR_ATTR_PRICING_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_super_link`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_super_link` (
  `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Link ID',
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Parent ID',
  PRIMARY KEY (`link_id`),
  UNIQUE KEY `UNQ_SHOP_CATALOG_PRODUCT_SUPER_LINK_PRODUCT_ID_PARENT_ID` (`product_id`,`parent_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_SUPER_LINK_PARENT_ID` (`parent_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_SUPER_LINK_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_SHOP_CAT_PRD_SPR_LNK_PARENT_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`parent_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_SPR_LNK_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalog_product_website`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalog_product_website` (
  `product_id` int(10) unsigned NOT NULL COMMENT 'Product ID',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website ID',
  PRIMARY KEY (`product_id`,`website_id`),
  KEY `IDX_SHOP_CATALOG_PRODUCT_WEBSITE_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_SHOP_CAT_PRD_WS_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CAT_PRD_WS_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `shop_catalog_product_website` VALUES (1,1),(2,1);
...
DROP TABLE IF EXISTS `shop_cataloginventory_stock`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_cataloginventory_stock` (
...
DROP TABLE IF EXISTS `shop_cataloginventory_stock_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_cataloginventory_stock_item` (
  ...
  PRIMARY KEY (`item_id`),
  UNIQUE KEY `UNQ_SHOP_CATALOGINVENTORY_STOCK_ITEM_PRODUCT_ID_STOCK_ID` (`product_id`,`stock_id`),
  KEY `IDX_SHOP_CATALOGINVENTORY_STOCK_ITEM_PRODUCT_ID` (`product_id`),
...
INSERT INTO `shop_cataloginventory_stock_item` VALUES (1,1,1,5.0000,0.0000,1,0,0,1,1.0000,1,0.0000,1,1,NULL,NULL,1,0,1,0,1,0.0000,1,0,0),(2,2,1,10.0000,0.0000,1,0,0,1,1.0000,1,0.0000,1,1,NULL,NULL,1,0,1,0,1,0.0000,1,0,0);
...
DROP TABLE IF EXISTS `shop_cataloginventory_stock_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_cataloginventory_stock_status` (
  `product_id` int(10) unsigned NOT NULL COMMENT 'Product Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  `stock_id` smallint(5) unsigned NOT NULL COMMENT 'Stock Id',
  `qty` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Qty',
  ...
  KEY `IDX_SHOP_CATALOGINVENTORY_STOCK_STATUS_STOCK_ID` (`stock_id`),
  KEY `IDX_SHOP_CATALOGINVENTORY_STOCK_STATUS_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_SHOP_CATINV_STOCK_STS_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CATINV_STOCK_STS_STOCK_ID_SHOP_CATINV_STOCK_STOCK_ID` FOREIGN KEY (`stock_id`) REFERENCES `shop_cataloginventory_stock` (`stock_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CATINV_STOCK_STS_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `shop_cataloginventory_stock_status` VALUES (1,1,1,5.0000,1),(2,1,1,10.0000,1);
...
DROP TABLE IF EXISTS `shop_cataloginventory_stock_status_idx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_cataloginventory_stock_status_idx` (
  `product_id` int(10) unsigned NOT NULL COMMENT 'Product Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  `stock_id` smallint(5) unsigned NOT NULL COMMENT 'Stock Id',
  `qty` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Qty',
  `stock_status` smallint(5) unsigned NOT NULL COMMENT 'Stock Status',
  PRIMARY KEY (`product_id`,`website_id`,`stock_id`),
  KEY `IDX_SHOP_CATALOGINVENTORY_STOCK_STATUS_IDX_STOCK_ID` (`stock_id`),
  KEY `IDX_SHOP_CATALOGINVENTORY_STOCK_STATUS_IDX_WEBSITE_ID` (`website_id`)
...
INSERT INTO `shop_cataloginventory_stock_status_idx` VALUES (1,1,1,5.0000,1),(2,1,1,10.0000,1);
...
DROP TABLE IF EXISTS `shop_cataloginventory_stock_status_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_cataloginventory_stock_status_tmp` (
  `product_id` int(10) unsigned NOT NULL COMMENT 'Product Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  `stock_id` smallint(5) unsigned NOT NULL COMMENT 'Stock Id',
  `qty` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Qty',
  `stock_status` smallint(5) unsigned NOT NULL COMMENT 'Stock Status',
  PRIMARY KEY (`product_id`,`website_id`,`stock_id`),
  KEY `IDX_SHOP_CATALOGINVENTORY_STOCK_STATUS_TMP_STOCK_ID` (`stock_id`),
...
DROP TABLE IF EXISTS `shop_catalogrule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalogrule` (
  `rule_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Rule Id',
  `name` varchar(255) DEFAULT NULL COMMENT 'Name',
  `description` text COMMENT 'Description',
  ...
  PRIMARY KEY (`rule_id`),
  KEY `IDX_SHOP_CATALOGRULE_IS_ACTIVE_SORT_ORDER_TO_DATE_FROM_DATE` (`is_active`,`sort_order`,`to_date`,`from_date`)
...
DROP TABLE IF EXISTS `shop_catalogrule_affected_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalogrule_affected_product` (
  `product_id` int(10) unsigned NOT NULL COMMENT 'Product Id',
...
DROP TABLE IF EXISTS `shop_catalogrule_customer_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalogrule_customer_group` (
  `rule_id` int(10) unsigned NOT NULL COMMENT 'Rule Id',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group Id',
  PRIMARY KEY (`rule_id`,`customer_group_id`),
  KEY `IDX_SHOP_CATALOGRULE_CUSTOMER_GROUP_RULE_ID` (`rule_id`),
  KEY `IDX_SHOP_CATALOGRULE_CUSTOMER_GROUP_CUSTOMER_GROUP_ID` (`customer_group_id`),
  CONSTRAINT `FK_5FB43D7271C1369E0FCC3A6D0F439830` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_catalogrule_group_website`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalogrule_group_website` (
  `rule_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Rule Id',
  `customer_group_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Customer Group Id',
  `website_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Website Id',
  PRIMARY KEY (`rule_id`,`customer_group_id`,`website_id`),
  KEY `IDX_SHOP_CATALOGRULE_GROUP_WEBSITE_RULE_ID` (`rule_id`),
  KEY `IDX_SHOP_CATALOGRULE_GROUP_WEBSITE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  KEY `IDX_SHOP_CATALOGRULE_GROUP_WEBSITE_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_F591CD001CC29A47FC0E912D81A0C515` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CATRULE_GROUP_WS_RULE_ID_SHOP_CATRULE_RULE_ID` FOREIGN KEY (`rule_id`) REFERENCES `shop_catalogrule` (`rule_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_catalogrule_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalogrule_product` (
  ...
  UNIQUE KEY `324D06FCFD696ECEA8C837A15BAEEA2D` (`rule_id`,`from_time`,`to_time`,`website_id`,`customer_group_id`,`product_id`,`sort_order`),
  KEY `IDX_SHOP_CATALOGRULE_PRODUCT_RULE_ID` (`rule_id`),
  KEY `IDX_SHOP_CATALOGRULE_PRODUCT_CUSTOMER_GROUP_ID` (`customer_group_id`),
  KEY `IDX_SHOP_CATALOGRULE_PRODUCT_WEBSITE_ID` (`website_id`),
  KEY `IDX_SHOP_CATALOGRULE_PRODUCT_FROM_TIME` (`from_time`),
  KEY `IDX_SHOP_CATALOGRULE_PRODUCT_TO_TIME` (`to_time`),
  KEY `IDX_SHOP_CATALOGRULE_PRODUCT_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_SHOP_CATALOGRULE_PRODUCT_RULE_ID_SHOP_CATALOGRULE_RULE_ID` FOREIGN KEY (`rule_id`) REFERENCES `shop_catalogrule` (`rule_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CATRULE_PRD_CSTR_GROUP_ID_SHOP_CSTR_GROUP_CSTR_GROUP_ID` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CATRULE_PRD_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CATRULE_PRD_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalogrule_product_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalogrule_product_price` (
  ...
  UNIQUE KEY `UNQ_SHOP_CATRULE_PRD_PRICE_RULE_DATE_WS_ID_CSTR_GROUP_ID_PRD_ID` (`rule_date`,`website_id`,`customer_group_id`,`product_id`),
  KEY `IDX_SHOP_CATALOGRULE_PRODUCT_PRICE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  KEY `IDX_SHOP_CATALOGRULE_PRODUCT_PRICE_WEBSITE_ID` (`website_id`),
  KEY `IDX_SHOP_CATALOGRULE_PRODUCT_PRICE_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_53666A2B20C7811A575AF3CBB209E76F` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CATRULE_PRD_PRICE_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CATRULE_PRD_PRICE_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalogrule_website`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalogrule_website` (
  `rule_id` int(10) unsigned NOT NULL COMMENT 'Rule Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  PRIMARY KEY (`rule_id`,`website_id`),
  KEY `IDX_SHOP_CATALOGRULE_WEBSITE_RULE_ID` (`rule_id`),
  KEY `IDX_SHOP_CATALOGRULE_WEBSITE_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_SHOP_CATALOGRULE_WEBSITE_RULE_ID_SHOP_CATALOGRULE_RULE_ID` FOREIGN KEY (`rule_id`) REFERENCES `shop_catalogrule` (`rule_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CATRULE_WS_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_catalogsearch_fulltext`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalogsearch_fulltext` (
...
INSERT INTO `shop_catalogsearch_fulltext` VALUES (5,2,1,'3333|None|simple 2|sample product|prodduct|111|1'),(4,1,1,'k|None|Botelya|This is a bottle with a twist|With a twist inside a bottle|10|1');
...
DROP TABLE IF EXISTS `shop_catalogsearch_query`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalogsearch_query` (
  ...
  KEY `IDX_SHOP_CATALOGSEARCH_QUERY_QUERY_TEXT_STORE_ID_POPULARITY` (`query_text`,`store_id`,`popularity`),
  KEY `IDX_SHOP_CATALOGSEARCH_QUERY_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SHOP_CATALOGSEARCH_QUERY_SYNONYM_FOR` (`synonym_for`),
  CONSTRAINT `FK_SHOP_CATALOGSEARCH_QUERY_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `shop_catalogsearch_query` VALUES (1,'botelya',0,2,NULL,NULL,1,1,1,0,'2015-07-01 04:38:32'),(2,'bote',0,1,NULL,NULL,1,1,1,0,'2015-07-01 04:38:36'),(3,'bot',0,1,NULL,NULL,1,1,1,0,'2015-07-01 04:38:42');
...
DROP TABLE IF EXISTS `shop_catalogsearch_result`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_catalogsearch_result` (
  `query_id` int(10) unsigned NOT NULL COMMENT 'Query ID',
  `product_id` int(10) unsigned NOT NULL COMMENT 'Product ID',
  `relevance` decimal(20,4) NOT NULL DEFAULT '0.0000' COMMENT 'Relevance',
  PRIMARY KEY (`query_id`,`product_id`),
  KEY `IDX_SHOP_CATALOGSEARCH_RESULT_QUERY_ID` (`query_id`),
  KEY `IDX_SHOP_CATALOGSEARCH_RESULT_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_SHOP_CATSRCH_RESULT_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_checkout_agreement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_checkout_agreement` (
...
DROP TABLE IF EXISTS `shop_checkout_agreement_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_checkout_agreement_store` (
  `agreement_id` int(10) unsigned NOT NULL COMMENT 'Agreement Id',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store Id',
  PRIMARY KEY (`agreement_id`,`store_id`),
  KEY `FK_SHOP_CHKT_AGRT_STORE_STORE_ID_SHOP_CORE_STORE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CHKT_AGRT_STORE_AGRT_ID_SHOP_CHKT_AGRT_AGRT_ID` FOREIGN KEY (`agreement_id`) REFERENCES `shop_checkout_agreement` (`agreement_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_cms_block_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_cms_block_store` (
  `block_id` smallint(6) NOT NULL COMMENT 'Block ID',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store ID',
  PRIMARY KEY (`block_id`,`store_id`),
  KEY `IDX_SHOP_CMS_BLOCK_STORE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CMS_BLOCK_STORE_BLOCK_ID_SHOP_CMS_BLOCK_BLOCK_ID` FOREIGN KEY (`block_id`) REFERENCES `shop_cms_block` (`block_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `shop_cms_page` (
  ...
  PRIMARY KEY (`page_id`),
  KEY `IDX_SHOP_CMS_PAGE_IDENTIFIER` (`identifier`)
...
DROP TABLE IF EXISTS `shop_cms_page_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_cms_page_store` (
  `page_id` smallint(6) NOT NULL COMMENT 'Page ID',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store ID',
  PRIMARY KEY (`page_id`,`store_id`),
  KEY `IDX_SHOP_CMS_PAGE_STORE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_CMS_PAGE_STORE_PAGE_ID_SHOP_CMS_PAGE_PAGE_ID` FOREIGN KEY (`page_id`) REFERENCES `shop_cms_page` (`page_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_core_cache`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_cache` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_SHOP_CORE_CACHE_EXPIRE_TIME` (`expire_time`)
...
DROP TABLE IF EXISTS `shop_core_cache_option`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_cache_option` (
...
DROP TABLE IF EXISTS `shop_core_cache_tag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_cache_tag` (
  `tag` varchar(100) NOT NULL COMMENT 'Tag',
  `cache_id` varchar(200) NOT NULL COMMENT 'Cache Id',
  PRIMARY KEY (`tag`,`cache_id`),
  KEY `IDX_SHOP_CORE_CACHE_TAG_CACHE_ID` (`cache_id`)
...
DROP TABLE IF EXISTS `shop_core_config_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_config_data` (
...
INSERT INTO `shop_core_config_data` VALUES (1,'default',0,'general/region/display_all','1'),(2,'default',0,'general/region/state_required','AT,CA,CH,DE,EE,ES,FI,FR,LT,LV,RO,US'),(3,'default',0,'catalog/category/root_id','2'),(4,'default',0,'payment/paypal_express/skip_order_review_step','1'),(5,'default',0,'payment/payflow_link/mobile_optimized','1'),(6,'default',0,'payment/payflow_advanced/mobile_optimized','1'),(7,'default',0,'payment/hosted_pro/mobile_optimized','1'),(8,'default',0,'web/seo/use_rewrites','1'),(9,'default',0,'admin/dashboard/enable_charts','1'),(10,'default',0,'web/unsecure/base_url','http://projshipment.com/'),(11,'default',0,'web/secure/base_url','http://projshipment.com/'),(12,'default',0,'general/locale/code','en_US'),(13,'default',0,'general/locale/timezone','America/Santa_Isabel'),(14,'default',0,'currency/options/base','USD'),(15,'default',0,'currency/options/default','USD'),(16,'default',0,'currency/options/allow','USD'),(17,'default',0,'design/package/name','rb'),(18,'default',0,'design/package/ua_regexp','a:0:{}'),(19,'default',0,'design/theme/locale',NULL),(20,'default',0,'design/theme/template',NULL),(21,'default',0,'design/theme/template_ua_regexp','a:0:{}'),(22,'default',0,'design/theme/skin',NULL),(23,'default',0,'design/theme/skin_ua_regexp','a:0:{}'),(24,'default',0,'design/theme/layout',NULL),(25,'default',0,'design/theme/layout_ua_regexp','a:0:{}'),(26,'default',0,'design/theme/default','default'),(27,'default',0,'design/theme/default_ua_regexp','a:0:{}'),(28,'default',0,'design/head/default_title','Magento Commerce'),(29,'default',0,'design/head/title_prefix',NULL),(30,'default',0,'design/head/title_suffix',NULL),(31,'default',0,'design/head/default_description','Default Description'),(32,'default',0,'design/head/default_keywords','Magento, Varien, E-commerce'),(33,'default',0,'design/head/default_robots','INDEX,FOLLOW'),(34,'default',0,'design/head/includes',NULL),(35,'default',0,'design/head/demonotice','0'),(36,'default',0,'design/header/logo_src','images/logo.gif'),(37,'default',0,'design/header/logo_alt','Magento Commerce'),(38,'default',0,'design/header/logo_src_small','images/logo.gif'),(39,'default',0,'design/header/welcome','Default welcome msg!'),(40,'default',0,'design/footer/copyright','&copy; 2015 Magento Demo Store. All Rights Reserved.'),(41,'default',0,'design/footer/absolute_footer',NULL),(42,'default',0,'design/watermark/image_size',NULL),(43,'default',0,'design/watermark/image_imageOpacity',NULL),(44,'default',0,'design/watermark/image_position','stretch'),(45,'default',0,'design/watermark/small_image_size',NULL),(46,'default',0,'design/watermark/small_image_imageOpacity',NULL),(47,'default',0,'design/watermark/small_image_position','stretch'),(48,'default',0,'design/watermark/thumbnail_size',NULL),(49,'default',0,'design/watermark/thumbnail_imageOpacity',NULL),(50,'default',0,'design/watermark/thumbnail_position','stretch'),(51,'default',0,'design/pagination/pagination_frame','5'),(52,'default',0,'design/pagination/pagination_frame_skip',NULL),(53,'default',0,'design/pagination/anchor_text_for_previous',NULL),(54,'default',0,'design/pagination/anchor_text_for_next',NULL),(55,'default',0,'design/email/logo_alt',NULL),(56,'default',0,'design/email/logo_width',NULL),(57,'default',0,'design/email/logo_height',NULL),(58,'default',0,'design/email/header','design_email_header'),(59,'default',0,'design/email/footer','design_email_footer'),(60,'default',0,'design/email/css_non_inline','email-non-inline.css'),(61,'default',0,'checkout/options/onepage_checkout_enabled','1'),(62,'default',0,'checkout/options/guest_checkout','1'),(63,'default',0,'checkout/options/enable_agreements','0'),(64,'default',0,'checkout/cart/delete_quote_after','30'),(65,'default',0,'checkout/cart/redirect_to_cart','0'),(66,'default',0,'checkout/cart/grouped_product_image','itself'),(67,'default',0,'checkout/cart/configurable_product_image','parent'),(68,'default',0,'checkout/cart_link/use_qty','1'),(69,'default',0,'checkout/sidebar/display','1'),(70,'default',0,'checkout/sidebar/count','3'),(71,'default',0,'checkout/payment_failed/reciever','general'),(72,'default',0,'checkout/payment_failed/identity','general'),(73,'default',0,'checkout/payment_failed/template','checkout_payment_failed_template'),(74,'default',0,'checkout/payment_failed/copy_to',NULL),(75,'default',0,'checkout/payment_failed/copy_method','bcc'),(76,'default',0,'catalog/frontend/list_mode','list-grid'),(77,'default',0,'catalog/frontend/grid_per_page_values','12,24,36'),(78,'default',0,'catalog/frontend/grid_per_page','12'),(79,'default',0,'catalog/frontend/list_per_page_values','5,10,15,20,25'),(80,'default',0,'catalog/frontend/list_per_page','10'),(81,'default',0,'catalog/frontend/list_allow_all','0'),(82,'default',0,'catalog/frontend/default_sort_by','position'),(83,'default',0,'catalog/frontend/flat_catalog_category','0'),(84,'default',0,'catalog/frontend/flat_catalog_product','0'),(85,'default',0,'catalog/frontend/parse_url_directives','1'),(86,'default',0,'catalog/sitemap/tree_mode','0'),(87,'default',0,'catalog/sitemap/lines_perpage','30'),(88,'default',0,'catalog/review/allow_guest','1'),(89,'default',0,'catalog/product_image/base_width','1800'),(90,'default',0,'catalog/product_image/small_width','210'),(91,'default',0,'catalog/productalert/allow_price','0'),(92,'default',0,'catalog/productalert/email_price_template','catalog_productalert_email_price_template'),(93,'default',0,'catalog/productalert/allow_stock','0'),(94,'default',0,'catalog/productalert/email_stock_template','catalog_productalert_email_stock_template'),(95,'default',0,'catalog/productalert/email_identity','general'),(96,'default',0,'catalog/productalert_cron/frequency','D'),(97,'default',0,'crontab/jobs/catalog_product_alert/schedule/cron_expr','0 0 * * *'),(98,'default',0,'crontab/jobs/catalog_product_alert/run/model','productalert/observer::process'),(99,'default',0,'catalog/productalert_cron/time','00,00,00'),(100,'default',0,'catalog/productalert_cron/error_email',NULL),(101,'default',0,'catalog/productalert_cron/error_email_identity','general'),(102,'default',0,'catalog/productalert_cron/error_email_template','catalog_productalert_cron_error_email_template'),(103,'default',0,'catalog/recently_products/scope','website'),(104,'default',0,'catalog/recently_products/viewed_count','5'),(105,'default',0,'catalog/recently_products/compared_count','5'),(106,'default',0,'catalog/price/scope','0'),(107,'default',0,'catalog/layered_navigation/display_product_count','1'),(108,'default',0,'catalog/layered_navigation/price_range_calculation','auto'),(109,'default',0,'catalog/navigation/max_depth','0'),(110,'default',0,'catalog/seo/site_map','1'),(111,'default',0,'catalog/seo/search_terms','1'),(112,'default',0,'catalog/seo/product_url_suffix','.html'),(113,'default',0,'catalog/seo/category_url_suffix','.html'),(114,'default',0,'catalog/seo/product_use_categories','1'),(115,'default',0,'catalog/seo/save_rewrites_history','1'),(116,'default',0,'catalog/seo/title_separator','-'),(117,'default',0,'catalog/seo/category_canonical_tag','0'),(118,'default',0,'catalog/seo/product_canonical_tag','0'),(119,'default',0,'catalog/search/min_query_length','1'),(120,'default',0,'catalog/search/max_query_length','128'),(121,'default',0,'catalog/search/max_query_words','10'),(122,'default',0,'catalog/search/search_type','1'),(123,'default',0,'catalog/search/use_layered_navigation_count','2000'),(124,'default',0,'catalog/downloadable/order_item_status','9'),(125,'default',0,'catalog/downloadable/downloads_number','0'),(126,'default',0,'catalog/downloadable/shareable','0'),(127,'default',0,'catalog/downloadable/samples_title','Samples'),(128,'default',0,'catalog/downloadable/links_title','Links'),(129,'default',0,'catalog/downloadable/links_target_new_window','1'),(130,'default',0,'catalog/downloadable/content_disposition','inline'),(131,'default',0,'catalog/downloadable/disable_guest_checkout','1'),(132,'default',0,'catalog/custom_options/use_calendar','0'),(133,'default',0,'catalog/custom_options/date_fields_order','m,d,y'),(134,'default',0,'catalog/custom_options/time_format','12h'),(135,'default',0,'catalog/custom_options/year_range',',');
...
DROP TABLE IF EXISTS `shop_core_email_queue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_email_queue` (
...
DROP TABLE IF EXISTS `shop_core_email_queue_recipients`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_email_queue_recipients` (
  ...
  UNIQUE KEY `E635B0CD9F686B4178AE7C42B86EF2A1` (`message_id`,`recipient_email`,`email_type`),
...
DROP TABLE IF EXISTS `shop_core_email_template`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_email_template` (
  ...
  UNIQUE KEY `UNQ_SHOP_CORE_EMAIL_TEMPLATE_TEMPLATE_CODE` (`template_code`),
  KEY `IDX_SHOP_CORE_EMAIL_TEMPLATE_ADDED_AT` (`added_at`),
  KEY `IDX_SHOP_CORE_EMAIL_TEMPLATE_MODIFIED_AT` (`modified_at`)
...
DROP TABLE IF EXISTS `shop_core_flag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_flag` (
...
DROP TABLE IF EXISTS `shop_core_layout_link`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_layout_link` (
  ...
  UNIQUE KEY `UNQ_SHOP_CORE_LYT_LNK_STORE_ID_PACKAGE_THEME_LYT_UPDATE_ID` (`store_id`,`package`,`theme`,`layout_update_id`),
  KEY `IDX_SHOP_CORE_LAYOUT_LINK_LAYOUT_UPDATE_ID` (`layout_update_id`),
  CONSTRAINT `FK_A74A971665CFD75D15EC0EA412D42AAA` FOREIGN KEY (`layout_update_id`) REFERENCES `shop_core_layout_update` (`layout_update_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CORE_LAYOUT_LINK_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_core_layout_update`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_layout_update` (
  `layout_update_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Layout Update Id',
  `handle` varchar(255) DEFAULT NULL COMMENT 'Handle',
  `xml` text COMMENT 'Xml',
  `sort_order` smallint(6) NOT NULL DEFAULT '0' COMMENT 'Sort Order',
  PRIMARY KEY (`layout_update_id`),
  KEY `IDX_SHOP_CORE_LAYOUT_UPDATE_HANDLE` (`handle`)
...
DROP TABLE IF EXISTS `shop_core_resource`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_resource` (
...
DROP TABLE IF EXISTS `shop_core_session`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_session` (
...
INSERT INTO `shop_core_session` VALUES ('3fqbd2jd5m4l34mgho7b39j5f6',1435941497,'core|a:5:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:8:\"messages\";O:34:\"Mage_Core_Model_Message_Collection\":2:{s:12:\"\0*\0_messages\";a:0:{}s:20:\"\0*\0_lastAddedMessage\";N;}s:9:\"_form_key\";s:16:\"AdneNvLdYrxeYYk1\";s:12:\"visitor_data\";a:16:{s:0:\"\";N;s:11:\"server_addr\";i:2130706433;s:11:\"remote_addr\";i:2130706433;s:11:\"http_secure\";b:0;s:9:\"http_host\";s:16:\"projshipment.com\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";s:20:\"http_accept_language\";s:14:\"en-US,en;q=0.8\";s:19:\"http_accept_charset\";s:0:\"\";s:11:\"request_uri\";s:1:\"/\";s:10:\"session_id\";s:26:\"3fqbd2jd5m4l34mgho7b39j5f6\";s:12:\"http_referer\";s:0:\"\";s:14:\"first_visit_at\";s:19:\"2015-07-03 15:25:01\";s:14:\"is_new_visitor\";b:0;s:13:\"last_visit_at\";s:19:\"2015-07-03 15:38:17\";s:10:\"visitor_id\";s:1:\"9\";s:11:\"last_url_id\";s:3:\"295\";}s:8:\"last_url\";s:40:\"http://projshipment.com/cms/index/index/\";}customer_base|a:3:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:8:\"messages\";O:34:\"Mage_Core_Model_Message_Collection\":2:{s:12:\"\0*\0_messages\";a:0:{}s:20:\"\0*\0_lastAddedMessage\";N;}s:19:\"wishlist_item_count\";i:0;}checkout|a:2:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:8:\"messages\";O:34:\"Mage_Core_Model_Message_Collection\":2:{s:12:\"\0*\0_messages\";a:0:{}s:20:\"\0*\0_lastAddedMessage\";N;}}catalog|a:3:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:8:\"messages\";O:34:\"Mage_Core_Model_Message_Collection\":2:{s:12:\"\0*\0_messages\";a:0:{}s:20:\"\0*\0_lastAddedMessage\";N;}s:12:\"display_mode\";s:4:\"list\";}store_default|a:1:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}}'),('ce1d7b66jlq60u1dn6k0m6thr2',1435938872,'core|a:5:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:8:\"messages\";O:34:\"Mage_Core_Model_Message_Collection\":2:{s:12:\"\0*\0_messages\";a:0:{}s:20:\"\0*\0_lastAddedMessage\";N;}s:9:\"_form_key\";s:16:\"mtajpjWsEZom0WQx\";s:12:\"visitor_data\";a:16:{s:0:\"\";N;s:11:\"server_addr\";i:2130706433;s:11:\"remote_addr\";i:2130706433;s:11:\"http_secure\";b:0;s:9:\"http_host\";s:16:\"projshipment.com\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";s:20:\"http_accept_language\";s:14:\"en-US,en;q=0.8\";s:19:\"http_accept_charset\";s:0:\"\";s:11:\"request_uri\";s:26:\"/catalog/product/view/id/2\";s:10:\"session_id\";s:26:\"ce1d7b66jlq60u1dn6k0m6thr2\";s:12:\"http_referer\";s:34:\"http://projshipment.com/?mode=list\";s:14:\"first_visit_at\";s:19:\"2015-07-03 14:49:18\";s:14:\"is_new_visitor\";b:0;s:13:\"last_visit_at\";s:19:\"2015-07-03 14:54:32\";s:10:\"visitor_id\";s:1:\"8\";s:11:\"last_url_id\";s:3:\"292\";}s:8:\"last_url\";s:50:\"http://projshipment.com/catalog/product/view/id/2/\";}customer_base|a:3:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:8:\"messages\";O:34:\"Mage_Core_Model_Message_Collection\":2:{s:12:\"\0*\0_messages\";a:0:{}s:20:\"\0*\0_lastAddedMessage\";N;}s:19:\"wishlist_item_count\";i:0;}checkout|a:2:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:8:\"messages\";O:34:\"Mage_Core_Model_Message_Collection\":2:{s:12:\"\0*\0_messages\";a:0:{}s:20:\"\0*\0_lastAddedMessage\";N;}}catalog|a:4:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:8:\"messages\";O:34:\"Mage_Core_Model_Message_Collection\":2:{s:12:\"\0*\0_messages\";a:0:{}s:20:\"\0*\0_lastAddedMessage\";N;}s:12:\"display_mode\";s:4:\"list\";s:22:\"last_viewed_product_id\";s:1:\"2\";}store_default|a:1:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}}reports|a:2:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:26:\"product_index_viewed_count\";i:1;}tag|a:2:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:8:\"messages\";O:34:\"Mage_Core_Model_Message_Collection\":2:{s:12:\"\0*\0_messages\";a:0:{}s:20:\"\0*\0_lastAddedMessage\";N;}}'),('gelkapbeeci8jd2otmq7olnag5',1435939710,'core|a:3:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:9:\"_form_key\";s:16:\"Awxh5aAkxOBYzRfl\";s:8:\"messages\";O:34:\"Mage_Core_Model_Message_Collection\":2:{s:12:\"\0*\0_messages\";a:0:{}s:20:\"\0*\0_lastAddedMessage\";N;}}adminhtml|a:3:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:6:\"locale\";s:5:\"en_US\";s:8:\"messages\";O:34:\"Mage_Core_Model_Message_Collection\":2:{s:12:\"\0*\0_messages\";a:0:{}s:20:\"\0*\0_lastAddedMessage\";O:31:\"Mage_Core_Model_Message_Success\":6:{s:8:\"\0*\0_type\";s:7:\"success\";s:8:\"\0*\0_code\";s:41:\"Total of 7 index(es) have reindexed data.\";s:9:\"\0*\0_class\";s:0:\"\";s:10:\"\0*\0_method\";s:0:\"\";s:14:\"\0*\0_identifier\";N;s:12:\"\0*\0_isSticky\";b:0;}}}admin|a:4:{s:23:\"_session_validator_data\";a:4:{s:11:\"remote_addr\";s:9:\"127.0.0.1\";s:8:\"http_via\";s:0:\"\";s:20:\"http_x_forwarded_for\";s:0:\"\";s:15:\"http_user_agent\";s:109:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36\";}s:23:\"sync_process_stop_watch\";b:0;s:4:\"user\";O:21:\"Mage_Admin_Model_User\":17:{s:15:\"\0*\0_eventPrefix\";s:10:\"admin_user\";s:8:\"\0*\0_role\";N;s:25:\"\0*\0_hasAvailableResources\";b:1;s:15:\"\0*\0_eventObject\";s:6:\"object\";s:16:\"\0*\0_resourceName\";s:10:\"admin/user\";s:12:\"\0*\0_resource\";N;s:26:\"\0*\0_resourceCollectionName\";s:21:\"admin/user_collection\";s:12:\"\0*\0_cacheTag\";b:0;s:19:\"\0*\0_dataSaveAllowed\";b:1;s:15:\"\0*\0_isObjectNew\";N;s:8:\"\0*\0_data\";a:15:{s:7:\"user_id\";s:1:\"3\";s:9:\"firstname\";s:7:\"Perseus\";s:8:\"lastname\";s:8:\"Laguador\";s:5:\"email\";s:20:\"laguador.p@gmail.com\";s:8:\"username\";s:8:\"perseusl\";s:8:\"password\";s:65:\"40060684d2d4993576f45fa3abc6332f:0TAQD5CdC1db4nOm6PVg5cl1NfMqRDYg\";s:7:\"created\";s:19:\"2015-07-01 22:43:25\";s:8:\"modified\";s:19:\"2015-07-01 22:43:25\";s:7:\"logdate\";s:19:\"2015-07-03 15:32:51\";s:6:\"lognum\";s:1:\"3\";s:15:\"reload_acl_flag\";s:1:\"0\";s:9:\"is_active\";s:1:\"1\";s:5:\"extra\";a:1:{s:11:\"configState\";a:28:{s:14:\"design_package\";s:1:\"1\";s:12:\"design_theme\";s:1:\"1\";s:11:\"design_head\";s:1:\"0\";s:13:\"design_header\";s:1:\"0\";s:13:\"design_footer\";s:1:\"0\";s:16:\"design_watermark\";s:1:\"0\";s:17:\"design_pagination\";s:1:\"0\";s:12:\"design_email\";s:1:\"0\";s:16:\"checkout_options\";s:1:\"0\";s:13:\"checkout_cart\";s:1:\"1\";s:18:\"checkout_cart_link\";s:1:\"0\";s:16:\"checkout_sidebar\";s:1:\"0\";s:23:\"checkout_payment_failed\";s:1:\"0\";s:16:\"catalog_frontend\";s:1:\"1\";s:15:\"catalog_sitemap\";s:1:\"0\";s:14:\"catalog_review\";s:1:\"0\";s:21:\"catalog_product_image\";s:1:\"0\";s:20:\"catalog_productalert\";s:1:\"0\";s:25:\"catalog_productalert_cron\";s:1:\"0\";s:19:\"catalog_placeholder\";s:1:\"0\";s:25:\"catalog_recently_products\";s:1:\"0\";s:13:\"catalog_price\";s:1:\"0\";s:26:\"catalog_layered_navigation\";s:1:\"0\";s:18:\"catalog_navigation\";s:1:\"0\";s:11:\"catalog_seo\";s:1:\"0\";s:14:\"catalog_search\";s:1:\"0\";s:20:\"catalog_downloadable\";s:1:\"0\";s:22:\"catalog_custom_options\";s:1:\"0\";}}s:8:\"rp_token\";N;s:19:\"rp_token_created_at\";N;}s:18:\"\0*\0_hasDataChanges\";b:0;s:12:\"\0*\0_origData\";a:15:{s:7:\"user_id\";s:1:\"3\";s:9:\"firstname\";s:7:\"Perseus\";s:8:\"lastname\";s:8:\"Laguador\";s:5:\"email\";s:20:\"laguador.p@gmail.com\";s:8:\"username\";s:8:\"perseusl\";s:8:\"password\";s:65:\"40060684d2d4993576f45fa3abc6332f:0TAQD5CdC1db4nOm6PVg5cl1NfMqRDYg\";s:7:\"created\";s:19:\"2015-07-01 22:43:25\";s:8:\"modified\";s:19:\"2015-07-01 22:43:25\";s:7:\"logdate\";s:19:\"2015-07-03 15:32:51\";s:6:\"lognum\";s:1:\"3\";s:15:\"reload_acl_flag\";s:1:\"0\";s:9:\"is_active\";s:1:\"1\";s:5:\"extra\";a:1:{s:11:\"configState\";a:28:{s:14:\"design_package\";s:1:\"1\";s:12:\"design_theme\";s:1:\"1\";s:11:\"design_head\";s:1:\"0\";s:13:\"design_header\";s:1:\"0\";s:13:\"design_footer\";s:1:\"0\";s:16:\"design_watermark\";s:1:\"0\";s:17:\"design_pagination\";s:1:\"0\";s:12:\"design_email\";s:1:\"0\";s:16:\"checkout_options\";s:1:\"0\";s:13:\"checkout_cart\";s:1:\"1\";s:18:\"checkout_cart_link\";s:1:\"0\";s:16:\"checkout_sidebar\";s:1:\"0\";s:23:\"checkout_payment_failed\";s:1:\"0\";s:16:\"catalog_frontend\";s:1:\"1\";s:15:\"catalog_sitemap\";s:1:\"0\";s:14:\"catalog_review\";s:1:\"0\";s:21:\"catalog_product_image\";s:1:\"0\";s:20:\"catalog_productalert\";s:1:\"0\";s:25:\"catalog_productalert_cron\";s:1:\"0\";s:19:\"catalog_placeholder\";s:1:\"0\";s:25:\"catalog_recently_products\";s:1:\"0\";s:13:\"catalog_price\";s:1:\"0\";s:26:\"catalog_layered_navigation\";s:1:\"0\";s:18:\"catalog_navigation\";s:1:\"0\";s:11:\"catalog_seo\";s:1:\"0\";s:14:\"catalog_search\";s:1:\"0\";s:20:\"catalog_downloadable\";s:1:\"0\";s:22:\"catalog_custom_options\";s:1:\"0\";}}s:8:\"rp_token\";N;s:19:\"rp_token_created_at\";N;}s:15:\"\0*\0_idFieldName\";s:7:\"user_id\";s:13:\"\0*\0_isDeleted\";b:0;s:16:\"\0*\0_oldFieldsMap\";a:0:{}s:17:\"\0*\0_syncFieldsMap\";a:0:{}}s:3:\"acl\";O:20:\"Mage_Admin_Model_Acl\":6:{s:16:\"\0*\0_roleRegistry\";O:34:\"Mage_Admin_Model_Acl_Role_Registry\":1:{s:9:\"\0*\0_roles\";a:4:{s:2:\"G1\";a:3:{s:8:\"instance\";O:31:\"Mage_Admin_Model_Acl_Role_Group\":1:{s:10:\"\0*\0_roleId\";s:2:\"G1\";}s:7:\"parents\";a:0:{}s:8:\"children\";a:3:{s:2:\"U1\";O:30:\"Mage_Admin_Model_Acl_Role_User\":1:{s:10:\"\0*\0_roleId\";s:2:\"U1\";}s:2:\"U2\";O:30:\"Mage_Admin_Model_Acl_Role_User\":1:{s:10:\"\0*\0_roleId\";s:2:\"U2\";}s:2:\"U3\";O:30:\"Mage_Admin_Model_Acl_Role_User\":1:{s:10:\"\0*\0_roleId\";s:2:\"U3\";}}}s:2:\"U1\";a:3:{s:8:\"instance\";r:148;s:7:\"parents\";a:1:{s:2:\"G1\";r:144;}s:8:\"children\";a:0:{}}s:2:\"U2\";a:3:{s:8:\"instance\";r:150;s:7:\"parents\";a:1:{s:2:\"G1\";r:144;}s:8:\"children\";a:0:{}}s:2:\"U3\";a:3:{s:8:\"instance\";r:152;s:7:\"parents\";a:1:{s:2:\"G1\";r:144;}s:8:\"children\";a:0:{}}}}s:13:\"\0*\0_resources\";a:197:{s:3:\"all\";a:3:{s:8:\"instance\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:3:\"all\";}s:6:\"parent\";N;s:8:\"children\";a:0:{}}s:5:\"admin\";a:3:{s:8:\"instance\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:5:\"admin\";}s:6:\"parent\";N;s:8:\"children\";a:11:{s:15:\"admin/dashboard\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:15:\"admin/dashboard\";}s:12:\"admin/system\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:12:\"admin/system\";}s:19:\"admin/global_search\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:19:\"admin/global_search\";}s:9:\"admin/cms\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:9:\"admin/cms\";}s:14:\"admin/customer\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:14:\"admin/customer\";}s:13:\"admin/catalog\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:13:\"admin/catalog\";}s:11:\"admin/promo\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:11:\"admin/promo\";}s:11:\"admin/sales\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:11:\"admin/sales\";}s:12:\"admin/report\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:12:\"admin/report\";}s:16:\"admin/newsletter\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:16:\"admin/newsletter\";}s:16:\"admin/page_cache\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:16:\"admin/page_cache\";}}}s:15:\"admin/dashboard\";a:3:{s:8:\"instance\";r:180;s:6:\"parent\";r:176;s:8:\"children\";a:0:{}}s:12:\"admin/system\";a:3:{s:8:\"instance\";r:182;s:6:\"parent\";r:176;s:8:\"children\";a:16:{s:16:\"admin/system/acl\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:16:\"admin/system/acl\";}s:18:\"admin/system/store\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:18:\"admin/system/store\";}s:19:\"admin/system/design\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:19:\"admin/system/design\";}s:19:\"admin/system/config\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:19:\"admin/system/config\";}s:21:\"admin/system/currency\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:21:\"admin/system/currency\";}s:27:\"admin/system/email_template\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/system/email_template\";}s:21:\"admin/system/variable\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:21:\"admin/system/variable\";}s:22:\"admin/system/myaccount\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:22:\"admin/system/myaccount\";}s:18:\"admin/system/tools\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:18:\"admin/system/tools\";}s:20:\"admin/system/convert\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:20:\"admin/system/convert\";}s:18:\"admin/system/cache\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:18:\"admin/system/cache\";}s:23:\"admin/system/extensions\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:23:\"admin/system/extensions\";}s:30:\"admin/system/adminnotification\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/system/adminnotification\";}s:18:\"admin/system/index\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:18:\"admin/system/index\";}s:27:\"admin/system/order_statuses\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/system/order_statuses\";}s:16:\"admin/system/api\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:16:\"admin/system/api\";}}}s:16:\"admin/system/acl\";a:3:{s:8:\"instance\";r:210;s:6:\"parent\";r:182;s:8:\"children\";a:2:{s:22:\"admin/system/acl/roles\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:22:\"admin/system/acl/roles\";}s:22:\"admin/system/acl/users\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:22:\"admin/system/acl/users\";}}}s:22:\"admin/system/acl/roles\";a:3:{s:8:\"instance\";r:246;s:6:\"parent\";r:210;s:8:\"children\";a:0:{}}s:22:\"admin/system/acl/users\";a:3:{s:8:\"instance\";r:248;s:6:\"parent\";r:210;s:8:\"children\";a:0:{}}s:18:\"admin/system/store\";a:3:{s:8:\"instance\";r:212;s:6:\"parent\";r:182;s:8:\"children\";a:0:{}}s:19:\"admin/system/design\";a:3:{s:8:\"instance\";r:214;s:6:\"parent\";r:182;s:8:\"children\";a:0:{}}s:19:\"admin/system/config\";a:3:{s:8:\"instance\";r:216;s:6:\"parent\";r:182;s:8:\"children\";a:38:{s:27:\"admin/system/config/general\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/system/config/general\";}s:23:\"admin/system/config/web\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:23:\"admin/system/config/web\";}s:26:\"admin/system/config/design\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:26:\"admin/system/config/design\";}s:26:\"admin/system/config/system\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:26:\"admin/system/config/system\";}s:28:\"admin/system/config/advanced\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:28:\"admin/system/config/advanced\";}s:31:\"admin/system/config/trans_email\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:31:\"admin/system/config/trans_email\";}s:23:\"admin/system/config/dev\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:23:\"admin/system/config/dev\";}s:28:\"admin/system/config/currency\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:28:\"admin/system/config/currency\";}s:30:\"admin/system/config/sendfriend\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/system/config/sendfriend\";}s:25:\"admin/system/config/admin\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:25:\"admin/system/config/admin\";}s:23:\"admin/system/config/cms\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:23:\"admin/system/config/cms\";}s:28:\"admin/system/config/customer\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:28:\"admin/system/config/customer\";}s:27:\"admin/system/config/catalog\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/system/config/catalog\";}s:27:\"admin/system/config/payment\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/system/config/payment\";}s:36:\"admin/system/config/payment_services\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:36:\"admin/system/config/payment_services\";}s:25:\"admin/system/config/sales\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:25:\"admin/system/config/sales\";}s:31:\"admin/system/config/sales_email\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:31:\"admin/system/config/sales_email\";}s:29:\"admin/system/config/sales_pdf\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/system/config/sales_pdf\";}s:36:\"admin/system/config/cataloginventory\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:36:\"admin/system/config/cataloginventory\";}s:28:\"admin/system/config/shipping\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:28:\"admin/system/config/shipping\";}s:28:\"admin/system/config/carriers\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:28:\"admin/system/config/carriers\";}s:25:\"admin/system/config/promo\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:25:\"admin/system/config/promo\";}s:28:\"admin/system/config/checkout\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:28:\"admin/system/config/checkout\";}s:26:\"admin/system/config/paypal\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:26:\"admin/system/config/paypal\";}s:27:\"admin/system/config/reports\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/system/config/reports\";}s:26:\"admin/system/config/google\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:26:\"admin/system/config/google\";}s:23:\"admin/system/config/tax\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:23:\"admin/system/config/tax\";}s:28:\"admin/system/config/wishlist\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:28:\"admin/system/config/wishlist\";}s:28:\"admin/system/config/contacts\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:28:\"admin/system/config/contacts\";}s:27:\"admin/system/config/sitemap\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/system/config/sitemap\";}s:23:\"admin/system/config/rss\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:23:\"admin/system/config/rss\";}s:23:\"admin/system/config/api\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:23:\"admin/system/config/api\";}s:25:\"admin/system/config/oauth\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:25:\"admin/system/config/oauth\";}s:34:\"admin/system/config/configswatches\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:34:\"admin/system/config/configswatches\";}s:30:\"admin/system/config/newsletter\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/system/config/newsletter\";}s:32:\"admin/system/config/downloadable\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:32:\"admin/system/config/downloadable\";}s:30:\"admin/system/config/persistent\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/system/config/persistent\";}s:32:\"admin/system/config/moneybookers\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:32:\"admin/system/config/moneybookers\";}}}s:27:\"admin/system/config/general\";a:3:{s:8:\"instance\";r:270;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:23:\"admin/system/config/web\";a:3:{s:8:\"instance\";r:272;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:26:\"admin/system/config/design\";a:3:{s:8:\"instance\";r:274;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:26:\"admin/system/config/system\";a:3:{s:8:\"instance\";r:276;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:28:\"admin/system/config/advanced\";a:3:{s:8:\"instance\";r:278;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:31:\"admin/system/config/trans_email\";a:3:{s:8:\"instance\";r:280;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:23:\"admin/system/config/dev\";a:3:{s:8:\"instance\";r:282;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:28:\"admin/system/config/currency\";a:3:{s:8:\"instance\";r:284;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:30:\"admin/system/config/sendfriend\";a:3:{s:8:\"instance\";r:286;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:25:\"admin/system/config/admin\";a:3:{s:8:\"instance\";r:288;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:23:\"admin/system/config/cms\";a:3:{s:8:\"instance\";r:290;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:28:\"admin/system/config/customer\";a:3:{s:8:\"instance\";r:292;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:27:\"admin/system/config/catalog\";a:3:{s:8:\"instance\";r:294;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:27:\"admin/system/config/payment\";a:3:{s:8:\"instance\";r:296;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:36:\"admin/system/config/payment_services\";a:3:{s:8:\"instance\";r:298;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:25:\"admin/system/config/sales\";a:3:{s:8:\"instance\";r:300;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:31:\"admin/system/config/sales_email\";a:3:{s:8:\"instance\";r:302;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:29:\"admin/system/config/sales_pdf\";a:3:{s:8:\"instance\";r:304;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:36:\"admin/system/config/cataloginventory\";a:3:{s:8:\"instance\";r:306;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:28:\"admin/system/config/shipping\";a:3:{s:8:\"instance\";r:308;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:28:\"admin/system/config/carriers\";a:3:{s:8:\"instance\";r:310;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:25:\"admin/system/config/promo\";a:3:{s:8:\"instance\";r:312;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:28:\"admin/system/config/checkout\";a:3:{s:8:\"instance\";r:314;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:26:\"admin/system/config/paypal\";a:3:{s:8:\"instance\";r:316;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:27:\"admin/system/config/reports\";a:3:{s:8:\"instance\";r:318;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:26:\"admin/system/config/google\";a:3:{s:8:\"instance\";r:320;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:23:\"admin/system/config/tax\";a:3:{s:8:\"instance\";r:322;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:28:\"admin/system/config/wishlist\";a:3:{s:8:\"instance\";r:324;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:28:\"admin/system/config/contacts\";a:3:{s:8:\"instance\";r:326;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:27:\"admin/system/config/sitemap\";a:3:{s:8:\"instance\";r:328;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:23:\"admin/system/config/rss\";a:3:{s:8:\"instance\";r:330;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:23:\"admin/system/config/api\";a:3:{s:8:\"instance\";r:332;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:25:\"admin/system/config/oauth\";a:3:{s:8:\"instance\";r:334;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:34:\"admin/system/config/configswatches\";a:3:{s:8:\"instance\";r:336;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:30:\"admin/system/config/newsletter\";a:3:{s:8:\"instance\";r:338;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:32:\"admin/system/config/downloadable\";a:3:{s:8:\"instance\";r:340;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:30:\"admin/system/config/persistent\";a:3:{s:8:\"instance\";r:342;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:32:\"admin/system/config/moneybookers\";a:3:{s:8:\"instance\";r:344;s:6:\"parent\";r:216;s:8:\"children\";a:0:{}}s:21:\"admin/system/currency\";a:3:{s:8:\"instance\";r:218;s:6:\"parent\";r:182;s:8:\"children\";a:2:{s:27:\"admin/system/currency/rates\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/system/currency/rates\";}s:29:\"admin/system/currency/symbols\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/system/currency/symbols\";}}}s:27:\"admin/system/currency/rates\";a:3:{s:8:\"instance\";r:502;s:6:\"parent\";r:218;s:8:\"children\";a:0:{}}s:29:\"admin/system/currency/symbols\";a:3:{s:8:\"instance\";r:504;s:6:\"parent\";r:218;s:8:\"children\";a:0:{}}s:27:\"admin/system/email_template\";a:3:{s:8:\"instance\";r:220;s:6:\"parent\";r:182;s:8:\"children\";a:0:{}}s:21:\"admin/system/variable\";a:3:{s:8:\"instance\";r:222;s:6:\"parent\";r:182;s:8:\"children\";a:0:{}}s:22:\"admin/system/myaccount\";a:3:{s:8:\"instance\";r:224;s:6:\"parent\";r:182;s:8:\"children\";a:0:{}}s:18:\"admin/system/tools\";a:3:{s:8:\"instance\";r:226;s:6:\"parent\";r:182;s:8:\"children\";a:2:{s:25:\"admin/system/tools/backup\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:25:\"admin/system/tools/backup\";}s:27:\"admin/system/tools/compiler\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/system/tools/compiler\";}}}s:25:\"admin/system/tools/backup\";a:3:{s:8:\"instance\";r:530;s:6:\"parent\";r:226;s:8:\"children\";a:1:{s:34:\"admin/system/tools/backup/rollback\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:34:\"admin/system/tools/backup/rollback\";}}}s:34:\"admin/system/tools/backup/rollback\";a:3:{s:8:\"instance\";r:538;s:6:\"parent\";r:530;s:8:\"children\";a:0:{}}s:27:\"admin/system/tools/compiler\";a:3:{s:8:\"instance\";r:532;s:6:\"parent\";r:226;s:8:\"children\";a:0:{}}s:20:\"admin/system/convert\";a:3:{s:8:\"instance\";r:228;s:6:\"parent\";r:182;s:8:\"children\";a:4:{s:24:\"admin/system/convert/gui\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:24:\"admin/system/convert/gui\";}s:29:\"admin/system/convert/profiles\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/system/convert/profiles\";}s:27:\"admin/system/convert/import\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/system/convert/import\";}s:27:\"admin/system/convert/export\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/system/convert/export\";}}}s:24:\"admin/system/convert/gui\";a:3:{s:8:\"instance\";r:552;s:6:\"parent\";r:228;s:8:\"children\";a:0:{}}s:29:\"admin/system/convert/profiles\";a:3:{s:8:\"instance\";r:554;s:6:\"parent\";r:228;s:8:\"children\";a:0:{}}s:27:\"admin/system/convert/import\";a:3:{s:8:\"instance\";r:556;s:6:\"parent\";r:228;s:8:\"children\";a:0:{}}s:27:\"admin/system/convert/export\";a:3:{s:8:\"instance\";r:558;s:6:\"parent\";r:228;s:8:\"children\";a:0:{}}s:18:\"admin/system/cache\";a:3:{s:8:\"instance\";r:230;s:6:\"parent\";r:182;s:8:\"children\";a:0:{}}s:23:\"admin/system/extensions\";a:3:{s:8:\"instance\";r:232;s:6:\"parent\";r:182;s:8:\"children\";a:2:{s:29:\"admin/system/extensions/local\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/system/extensions/local\";}s:30:\"admin/system/extensions/custom\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/system/extensions/custom\";}}}s:29:\"admin/system/extensions/local\";a:3:{s:8:\"instance\";r:584;s:6:\"parent\";r:232;s:8:\"children\";a:0:{}}s:30:\"admin/system/extensions/custom\";a:3:{s:8:\"instance\";r:586;s:6:\"parent\";r:232;s:8:\"children\";a:0:{}}s:30:\"admin/system/adminnotification\";a:3:{s:8:\"instance\";r:234;s:6:\"parent\";r:182;s:8:\"children\";a:4:{s:43:\"admin/system/adminnotification/show_toolbar\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:43:\"admin/system/adminnotification/show_toolbar\";}s:40:\"admin/system/adminnotification/show_list\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:40:\"admin/system/adminnotification/show_list\";}s:43:\"admin/system/adminnotification/mark_as_read\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:43:\"admin/system/adminnotification/mark_as_read\";}s:37:\"admin/system/adminnotification/remove\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:37:\"admin/system/adminnotification/remove\";}}}s:43:\"admin/system/adminnotification/show_toolbar\";a:3:{s:8:\"instance\";r:600;s:6:\"parent\";r:234;s:8:\"children\";a:0:{}}s:40:\"admin/system/adminnotification/show_list\";a:3:{s:8:\"instance\";r:602;s:6:\"parent\";r:234;s:8:\"children\";a:0:{}}s:43:\"admin/system/adminnotification/mark_as_read\";a:3:{s:8:\"instance\";r:604;s:6:\"parent\";r:234;s:8:\"children\";a:0:{}}s:37:\"admin/system/adminnotification/remove\";a:3:{s:8:\"instance\";r:606;s:6:\"parent\";r:234;s:8:\"children\";a:0:{}}s:18:\"admin/system/index\";a:3:{s:8:\"instance\";r:236;s:6:\"parent\";r:182;s:8:\"children\";a:0:{}}s:27:\"admin/system/order_statuses\";a:3:{s:8:\"instance\";r:238;s:6:\"parent\";r:182;s:8:\"children\";a:0:{}}s:16:\"admin/system/api\";a:3:{s:8:\"instance\";r:240;s:6:\"parent\";r:182;s:8:\"children\";a:7:{s:22:\"admin/system/api/users\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:22:\"admin/system/api/users\";}s:22:\"admin/system/api/roles\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:22:\"admin/system/api/roles\";}s:25:\"admin/system/api/consumer\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:25:\"admin/system/api/consumer\";}s:33:\"admin/system/api/authorizedTokens\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:33:\"admin/system/api/authorizedTokens\";}s:34:\"admin/system/api/oauth_admin_token\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:34:\"admin/system/api/oauth_admin_token\";}s:27:\"admin/system/api/rest_roles\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/system/api/rest_roles\";}s:32:\"admin/system/api/rest_attributes\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:32:\"admin/system/api/rest_attributes\";}}}s:22:\"admin/system/api/users\";a:3:{s:8:\"instance\";r:636;s:6:\"parent\";r:240;s:8:\"children\";a:0:{}}s:22:\"admin/system/api/roles\";a:3:{s:8:\"instance\";r:638;s:6:\"parent\";r:240;s:8:\"children\";a:0:{}}s:25:\"admin/system/api/consumer\";a:3:{s:8:\"instance\";r:640;s:6:\"parent\";r:240;s:8:\"children\";a:2:{s:30:\"admin/system/api/consumer/edit\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/system/api/consumer/edit\";}s:32:\"admin/system/api/consumer/delete\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:32:\"admin/system/api/consumer/delete\";}}}s:30:\"admin/system/api/consumer/edit\";a:3:{s:8:\"instance\";r:662;s:6:\"parent\";r:640;s:8:\"children\";a:0:{}}s:32:\"admin/system/api/consumer/delete\";a:3:{s:8:\"instance\";r:664;s:6:\"parent\";r:640;s:8:\"children\";a:0:{}}s:33:\"admin/system/api/authorizedTokens\";a:3:{s:8:\"instance\";r:642;s:6:\"parent\";r:240;s:8:\"children\";a:0:{}}s:34:\"admin/system/api/oauth_admin_token\";a:3:{s:8:\"instance\";r:644;s:6:\"parent\";r:240;s:8:\"children\";a:0:{}}s:27:\"admin/system/api/rest_roles\";a:3:{s:8:\"instance\";r:646;s:6:\"parent\";r:240;s:8:\"children\";a:3:{s:31:\"admin/system/api/rest_roles/add\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:31:\"admin/system/api/rest_roles/add\";}s:32:\"admin/system/api/rest_roles/edit\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:32:\"admin/system/api/rest_roles/edit\";}s:34:\"admin/system/api/rest_roles/delete\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:34:\"admin/system/api/rest_roles/delete\";}}}s:31:\"admin/system/api/rest_roles/add\";a:3:{s:8:\"instance\";r:686;s:6:\"parent\";r:646;s:8:\"children\";a:0:{}}s:32:\"admin/system/api/rest_roles/edit\";a:3:{s:8:\"instance\";r:688;s:6:\"parent\";r:646;s:8:\"children\";a:0:{}}s:34:\"admin/system/api/rest_roles/delete\";a:3:{s:8:\"instance\";r:690;s:6:\"parent\";r:646;s:8:\"children\";a:0:{}}s:32:\"admin/system/api/rest_attributes\";a:3:{s:8:\"instance\";r:648;s:6:\"parent\";r:240;s:8:\"children\";a:1:{s:37:\"admin/system/api/rest_attributes/edit\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:37:\"admin/system/api/rest_attributes/edit\";}}}s:37:\"admin/system/api/rest_attributes/edit\";a:3:{s:8:\"instance\";r:708;s:6:\"parent\";r:648;s:8:\"children\";a:0:{}}s:19:\"admin/global_search\";a:3:{s:8:\"instance\";r:184;s:6:\"parent\";r:176;s:8:\"children\";a:0:{}}s:9:\"admin/cms\";a:3:{s:8:\"instance\";r:186;s:6:\"parent\";r:176;s:8:\"children\";a:5:{s:15:\"admin/cms/block\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:15:\"admin/cms/block\";}s:14:\"admin/cms/page\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:14:\"admin/cms/page\";}s:23:\"admin/cms/media_gallery\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:23:\"admin/cms/media_gallery\";}s:14:\"admin/cms/poll\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:14:\"admin/cms/poll\";}s:25:\"admin/cms/widget_instance\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:25:\"admin/cms/widget_instance\";}}}s:15:\"admin/cms/block\";a:3:{s:8:\"instance\";r:722;s:6:\"parent\";r:186;s:8:\"children\";a:0:{}}s:14:\"admin/cms/page\";a:3:{s:8:\"instance\";r:724;s:6:\"parent\";r:186;s:8:\"children\";a:2:{s:19:\"admin/cms/page/save\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:19:\"admin/cms/page/save\";}s:21:\"admin/cms/page/delete\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:21:\"admin/cms/page/delete\";}}}s:19:\"admin/cms/page/save\";a:3:{s:8:\"instance\";r:740;s:6:\"parent\";r:724;s:8:\"children\";a:0:{}}s:21:\"admin/cms/page/delete\";a:3:{s:8:\"instance\";r:742;s:6:\"parent\";r:724;s:8:\"children\";a:0:{}}s:23:\"admin/cms/media_gallery\";a:3:{s:8:\"instance\";r:726;s:6:\"parent\";r:186;s:8:\"children\";a:0:{}}s:14:\"admin/cms/poll\";a:3:{s:8:\"instance\";r:728;s:6:\"parent\";r:186;s:8:\"children\";a:0:{}}s:25:\"admin/cms/widget_instance\";a:3:{s:8:\"instance\";r:730;s:6:\"parent\";r:186;s:8:\"children\";a:0:{}}s:14:\"admin/customer\";a:3:{s:8:\"instance\";r:188;s:6:\"parent\";r:176;s:8:\"children\";a:3:{s:20:\"admin/customer/group\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:20:\"admin/customer/group\";}s:21:\"admin/customer/manage\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:21:\"admin/customer/manage\";}s:21:\"admin/customer/online\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:21:\"admin/customer/online\";}}}s:20:\"admin/customer/group\";a:3:{s:8:\"instance\";r:768;s:6:\"parent\";r:188;s:8:\"children\";a:0:{}}s:21:\"admin/customer/manage\";a:3:{s:8:\"instance\";r:770;s:6:\"parent\";r:188;s:8:\"children\";a:0:{}}s:21:\"admin/customer/online\";a:3:{s:8:\"instance\";r:772;s:6:\"parent\";r:188;s:8:\"children\";a:0:{}}s:13:\"admin/catalog\";a:3:{s:8:\"instance\";r:190;s:6:\"parent\";r:176;s:8:\"children\";a:9:{s:24:\"admin/catalog/attributes\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:24:\"admin/catalog/attributes\";}s:24:\"admin/catalog/categories\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:24:\"admin/catalog/categories\";}s:22:\"admin/catalog/products\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:22:\"admin/catalog/products\";}s:31:\"admin/catalog/update_attributes\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:31:\"admin/catalog/update_attributes\";}s:24:\"admin/catalog/urlrewrite\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:24:\"admin/catalog/urlrewrite\";}s:20:\"admin/catalog/search\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:20:\"admin/catalog/search\";}s:29:\"admin/catalog/reviews_ratings\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/catalog/reviews_ratings\";}s:17:\"admin/catalog/tag\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:17:\"admin/catalog/tag\";}s:21:\"admin/catalog/sitemap\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:21:\"admin/catalog/sitemap\";}}}s:24:\"admin/catalog/attributes\";a:3:{s:8:\"instance\";r:790;s:6:\"parent\";r:190;s:8:\"children\";a:2:{s:35:\"admin/catalog/attributes/attributes\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:35:\"admin/catalog/attributes/attributes\";}s:29:\"admin/catalog/attributes/sets\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/catalog/attributes/sets\";}}}s:35:\"admin/catalog/attributes/attributes\";a:3:{s:8:\"instance\";r:812;s:6:\"parent\";r:790;s:8:\"children\";a:0:{}}s:29:\"admin/catalog/attributes/sets\";a:3:{s:8:\"instance\";r:814;s:6:\"parent\";r:790;s:8:\"children\";a:0:{}}s:24:\"admin/catalog/categories\";a:3:{s:8:\"instance\";r:792;s:6:\"parent\";r:190;s:8:\"children\";a:0:{}}s:22:\"admin/catalog/products\";a:3:{s:8:\"instance\";r:794;s:6:\"parent\";r:190;s:8:\"children\";a:0:{}}s:31:\"admin/catalog/update_attributes\";a:3:{s:8:\"instance\";r:796;s:6:\"parent\";r:190;s:8:\"children\";a:0:{}}s:24:\"admin/catalog/urlrewrite\";a:3:{s:8:\"instance\";r:798;s:6:\"parent\";r:190;s:8:\"children\";a:0:{}}s:20:\"admin/catalog/search\";a:3:{s:8:\"instance\";r:800;s:6:\"parent\";r:190;s:8:\"children\";a:0:{}}s:29:\"admin/catalog/reviews_ratings\";a:3:{s:8:\"instance\";r:802;s:6:\"parent\";r:190;s:8:\"children\";a:2:{s:37:\"admin/catalog/reviews_ratings/reviews\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:37:\"admin/catalog/reviews_ratings/reviews\";}s:37:\"admin/catalog/reviews_ratings/ratings\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:37:\"admin/catalog/reviews_ratings/ratings\";}}}s:37:\"admin/catalog/reviews_ratings/reviews\";a:3:{s:8:\"instance\";r:848;s:6:\"parent\";r:802;s:8:\"children\";a:2:{s:41:\"admin/catalog/reviews_ratings/reviews/all\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:41:\"admin/catalog/reviews_ratings/reviews/all\";}s:45:\"admin/catalog/reviews_ratings/reviews/pending\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:45:\"admin/catalog/reviews_ratings/reviews/pending\";}}}s:41:\"admin/catalog/reviews_ratings/reviews/all\";a:3:{s:8:\"instance\";r:856;s:6:\"parent\";r:848;s:8:\"children\";a:0:{}}s:45:\"admin/catalog/reviews_ratings/reviews/pending\";a:3:{s:8:\"instance\";r:858;s:6:\"parent\";r:848;s:8:\"children\";a:0:{}}s:37:\"admin/catalog/reviews_ratings/ratings\";a:3:{s:8:\"instance\";r:850;s:6:\"parent\";r:802;s:8:\"children\";a:0:{}}s:17:\"admin/catalog/tag\";a:3:{s:8:\"instance\";r:804;s:6:\"parent\";r:190;s:8:\"children\";a:2:{s:21:\"admin/catalog/tag/all\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:21:\"admin/catalog/tag/all\";}s:25:\"admin/catalog/tag/pending\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:25:\"admin/catalog/tag/pending\";}}}s:21:\"admin/catalog/tag/all\";a:3:{s:8:\"instance\";r:876;s:6:\"parent\";r:804;s:8:\"children\";a:0:{}}s:25:\"admin/catalog/tag/pending\";a:3:{s:8:\"instance\";r:878;s:6:\"parent\";r:804;s:8:\"children\";a:0:{}}s:21:\"admin/catalog/sitemap\";a:3:{s:8:\"instance\";r:806;s:6:\"parent\";r:190;s:8:\"children\";a:0:{}}s:11:\"admin/promo\";a:3:{s:8:\"instance\";r:192;s:6:\"parent\";r:176;s:8:\"children\";a:2:{s:19:\"admin/promo/catalog\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:19:\"admin/promo/catalog\";}s:17:\"admin/promo/quote\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:17:\"admin/promo/quote\";}}}s:19:\"admin/promo/catalog\";a:3:{s:8:\"instance\";r:896;s:6:\"parent\";r:192;s:8:\"children\";a:0:{}}s:17:\"admin/promo/quote\";a:3:{s:8:\"instance\";r:898;s:6:\"parent\";r:192;s:8:\"children\";a:0:{}}s:11:\"admin/sales\";a:3:{s:8:\"instance\";r:194;s:6:\"parent\";r:176;s:8:\"children\";a:9:{s:17:\"admin/sales/order\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:17:\"admin/sales/order\";}s:19:\"admin/sales/invoice\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:19:\"admin/sales/invoice\";}s:20:\"admin/sales/shipment\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:20:\"admin/sales/shipment\";}s:22:\"admin/sales/creditmemo\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:22:\"admin/sales/creditmemo\";}s:24:\"admin/sales/transactions\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:24:\"admin/sales/transactions\";}s:29:\"admin/sales/recurring_profile\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/sales/recurring_profile\";}s:29:\"admin/sales/billing_agreement\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/sales/billing_agreement\";}s:29:\"admin/sales/checkoutagreement\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/sales/checkoutagreement\";}s:15:\"admin/sales/tax\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:15:\"admin/sales/tax\";}}}s:17:\"admin/sales/order\";a:3:{s:8:\"instance\";r:912;s:6:\"parent\";r:194;s:8:\"children\";a:1:{s:25:\"admin/sales/order/actions\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:25:\"admin/sales/order/actions\";}}}s:25:\"admin/sales/order/actions\";a:3:{s:8:\"instance\";r:934;s:6:\"parent\";r:912;s:8:\"children\";a:15:{s:32:\"admin/sales/order/actions/create\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:32:\"admin/sales/order/actions/create\";}s:30:\"admin/sales/order/actions/view\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/sales/order/actions/view\";}s:31:\"admin/sales/order/actions/email\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:31:\"admin/sales/order/actions/email\";}s:33:\"admin/sales/order/actions/reorder\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:33:\"admin/sales/order/actions/reorder\";}s:30:\"admin/sales/order/actions/edit\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/sales/order/actions/edit\";}s:32:\"admin/sales/order/actions/cancel\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:32:\"admin/sales/order/actions/cancel\";}s:40:\"admin/sales/order/actions/review_payment\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:40:\"admin/sales/order/actions/review_payment\";}s:33:\"admin/sales/order/actions/capture\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:33:\"admin/sales/order/actions/capture\";}s:33:\"admin/sales/order/actions/invoice\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:33:\"admin/sales/order/actions/invoice\";}s:36:\"admin/sales/order/actions/creditmemo\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:36:\"admin/sales/order/actions/creditmemo\";}s:30:\"admin/sales/order/actions/hold\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/sales/order/actions/hold\";}s:32:\"admin/sales/order/actions/unhold\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:32:\"admin/sales/order/actions/unhold\";}s:30:\"admin/sales/order/actions/ship\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/sales/order/actions/ship\";}s:33:\"admin/sales/order/actions/comment\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:33:\"admin/sales/order/actions/comment\";}s:32:\"admin/sales/order/actions/emails\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:32:\"admin/sales/order/actions/emails\";}}}s:32:\"admin/sales/order/actions/create\";a:3:{s:8:\"instance\";r:940;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:30:\"admin/sales/order/actions/view\";a:3:{s:8:\"instance\";r:942;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:31:\"admin/sales/order/actions/email\";a:3:{s:8:\"instance\";r:944;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:33:\"admin/sales/order/actions/reorder\";a:3:{s:8:\"instance\";r:946;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:30:\"admin/sales/order/actions/edit\";a:3:{s:8:\"instance\";r:948;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:32:\"admin/sales/order/actions/cancel\";a:3:{s:8:\"instance\";r:950;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:40:\"admin/sales/order/actions/review_payment\";a:3:{s:8:\"instance\";r:952;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:33:\"admin/sales/order/actions/capture\";a:3:{s:8:\"instance\";r:954;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:33:\"admin/sales/order/actions/invoice\";a:3:{s:8:\"instance\";r:956;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:36:\"admin/sales/order/actions/creditmemo\";a:3:{s:8:\"instance\";r:958;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:30:\"admin/sales/order/actions/hold\";a:3:{s:8:\"instance\";r:960;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:32:\"admin/sales/order/actions/unhold\";a:3:{s:8:\"instance\";r:962;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:30:\"admin/sales/order/actions/ship\";a:3:{s:8:\"instance\";r:964;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:33:\"admin/sales/order/actions/comment\";a:3:{s:8:\"instance\";r:966;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:32:\"admin/sales/order/actions/emails\";a:3:{s:8:\"instance\";r:968;s:6:\"parent\";r:934;s:8:\"children\";a:0:{}}s:19:\"admin/sales/invoice\";a:3:{s:8:\"instance\";r:914;s:6:\"parent\";r:194;s:8:\"children\";a:0:{}}s:20:\"admin/sales/shipment\";a:3:{s:8:\"instance\";r:916;s:6:\"parent\";r:194;s:8:\"children\";a:0:{}}s:22:\"admin/sales/creditmemo\";a:3:{s:8:\"instance\";r:918;s:6:\"parent\";r:194;s:8:\"children\";a:0:{}}s:24:\"admin/sales/transactions\";a:3:{s:8:\"instance\";r:920;s:6:\"parent\";r:194;s:8:\"children\";a:1:{s:30:\"admin/sales/transactions/fetch\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/sales/transactions/fetch\";}}}s:30:\"admin/sales/transactions/fetch\";a:3:{s:8:\"instance\";r:1046;s:6:\"parent\";r:920;s:8:\"children\";a:0:{}}s:29:\"admin/sales/recurring_profile\";a:3:{s:8:\"instance\";r:922;s:6:\"parent\";r:194;s:8:\"children\";a:0:{}}s:29:\"admin/sales/billing_agreement\";a:3:{s:8:\"instance\";r:924;s:6:\"parent\";r:194;s:8:\"children\";a:1:{s:37:\"admin/sales/billing_agreement/actions\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:37:\"admin/sales/billing_agreement/actions\";}}}s:37:\"admin/sales/billing_agreement/actions\";a:3:{s:8:\"instance\";r:1060;s:6:\"parent\";r:924;s:8:\"children\";a:3:{s:42:\"admin/sales/billing_agreement/actions/view\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:42:\"admin/sales/billing_agreement/actions/view\";}s:44:\"admin/sales/billing_agreement/actions/manage\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:44:\"admin/sales/billing_agreement/actions/manage\";}s:41:\"admin/sales/billing_agreement/actions/use\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:41:\"admin/sales/billing_agreement/actions/use\";}}}s:42:\"admin/sales/billing_agreement/actions/view\";a:3:{s:8:\"instance\";r:1066;s:6:\"parent\";r:1060;s:8:\"children\";a:0:{}}s:44:\"admin/sales/billing_agreement/actions/manage\";a:3:{s:8:\"instance\";r:1068;s:6:\"parent\";r:1060;s:8:\"children\";a:0:{}}s:41:\"admin/sales/billing_agreement/actions/use\";a:3:{s:8:\"instance\";r:1070;s:6:\"parent\";r:1060;s:8:\"children\";a:0:{}}s:29:\"admin/sales/checkoutagreement\";a:3:{s:8:\"instance\";r:926;s:6:\"parent\";r:194;s:8:\"children\";a:0:{}}s:15:\"admin/sales/tax\";a:3:{s:8:\"instance\";r:928;s:6:\"parent\";r:194;s:8:\"children\";a:5:{s:32:\"admin/sales/tax/classes_customer\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:32:\"admin/sales/tax/classes_customer\";}s:31:\"admin/sales/tax/classes_product\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:31:\"admin/sales/tax/classes_product\";}s:29:\"admin/sales/tax/import_export\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/sales/tax/import_export\";}s:21:\"admin/sales/tax/rates\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:21:\"admin/sales/tax/rates\";}s:21:\"admin/sales/tax/rules\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:21:\"admin/sales/tax/rules\";}}}s:32:\"admin/sales/tax/classes_customer\";a:3:{s:8:\"instance\";r:1092;s:6:\"parent\";r:928;s:8:\"children\";a:0:{}}s:31:\"admin/sales/tax/classes_product\";a:3:{s:8:\"instance\";r:1094;s:6:\"parent\";r:928;s:8:\"children\";a:0:{}}s:29:\"admin/sales/tax/import_export\";a:3:{s:8:\"instance\";r:1096;s:6:\"parent\";r:928;s:8:\"children\";a:0:{}}s:21:\"admin/sales/tax/rates\";a:3:{s:8:\"instance\";r:1098;s:6:\"parent\";r:928;s:8:\"children\";a:0:{}}s:21:\"admin/sales/tax/rules\";a:3:{s:8:\"instance\";r:1100;s:6:\"parent\";r:928;s:8:\"children\";a:0:{}}s:12:\"admin/report\";a:3:{s:8:\"instance\";r:196;s:6:\"parent\";r:176;s:8:\"children\";a:8:{s:22:\"admin/report/salesroot\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:22:\"admin/report/salesroot\";}s:21:\"admin/report/shopcart\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:21:\"admin/report/shopcart\";}s:21:\"admin/report/products\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:21:\"admin/report/products\";}s:22:\"admin/report/customers\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:22:\"admin/report/customers\";}s:19:\"admin/report/review\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:19:\"admin/report/review\";}s:17:\"admin/report/tags\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:17:\"admin/report/tags\";}s:19:\"admin/report/search\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:19:\"admin/report/search\";}s:23:\"admin/report/statistics\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:23:\"admin/report/statistics\";}}}s:22:\"admin/report/salesroot\";a:3:{s:8:\"instance\";r:1126;s:6:\"parent\";r:196;s:8:\"children\";a:7:{s:48:\"admin/report/salesroot/paypal_settlement_reports\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:48:\"admin/report/salesroot/paypal_settlement_reports\";}s:28:\"admin/report/salesroot/sales\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:28:\"admin/report/salesroot/sales\";}s:26:\"admin/report/salesroot/tax\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:26:\"admin/report/salesroot/tax\";}s:31:\"admin/report/salesroot/shipping\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:31:\"admin/report/salesroot/shipping\";}s:31:\"admin/report/salesroot/invoiced\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:31:\"admin/report/salesroot/invoiced\";}s:31:\"admin/report/salesroot/refunded\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:31:\"admin/report/salesroot/refunded\";}s:30:\"admin/report/salesroot/coupons\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/report/salesroot/coupons\";}}}s:48:\"admin/report/salesroot/paypal_settlement_reports\";a:3:{s:8:\"instance\";r:1146;s:6:\"parent\";r:1126;s:8:\"children\";a:2:{s:53:\"admin/report/salesroot/paypal_settlement_reports/view\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:53:\"admin/report/salesroot/paypal_settlement_reports/view\";}s:54:\"admin/report/salesroot/paypal_settlement_reports/fetch\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:54:\"admin/report/salesroot/paypal_settlement_reports/fetch\";}}}s:53:\"admin/report/salesroot/paypal_settlement_reports/view\";a:3:{s:8:\"instance\";r:1164;s:6:\"parent\";r:1146;s:8:\"children\";a:0:{}}s:54:\"admin/report/salesroot/paypal_settlement_reports/fetch\";a:3:{s:8:\"instance\";r:1166;s:6:\"parent\";r:1146;s:8:\"children\";a:0:{}}s:28:\"admin/report/salesroot/sales\";a:3:{s:8:\"instance\";r:1148;s:6:\"parent\";r:1126;s:8:\"children\";a:0:{}}s:26:\"admin/report/salesroot/tax\";a:3:{s:8:\"instance\";r:1150;s:6:\"parent\";r:1126;s:8:\"children\";a:0:{}}s:31:\"admin/report/salesroot/shipping\";a:3:{s:8:\"instance\";r:1152;s:6:\"parent\";r:1126;s:8:\"children\";a:0:{}}s:31:\"admin/report/salesroot/invoiced\";a:3:{s:8:\"instance\";r:1154;s:6:\"parent\";r:1126;s:8:\"children\";a:0:{}}s:31:\"admin/report/salesroot/refunded\";a:3:{s:8:\"instance\";r:1156;s:6:\"parent\";r:1126;s:8:\"children\";a:0:{}}s:30:\"admin/report/salesroot/coupons\";a:3:{s:8:\"instance\";r:1158;s:6:\"parent\";r:1126;s:8:\"children\";a:0:{}}s:21:\"admin/report/shopcart\";a:3:{s:8:\"instance\";r:1128;s:6:\"parent\";r:196;s:8:\"children\";a:2:{s:29:\"admin/report/shopcart/product\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/report/shopcart/product\";}s:31:\"admin/report/shopcart/abandoned\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:31:\"admin/report/shopcart/abandoned\";}}}s:29:\"admin/report/shopcart/product\";a:3:{s:8:\"instance\";r:1204;s:6:\"parent\";r:1128;s:8:\"children\";a:0:{}}s:31:\"admin/report/shopcart/abandoned\";a:3:{s:8:\"instance\";r:1206;s:6:\"parent\";r:1128;s:8:\"children\";a:0:{}}s:21:\"admin/report/products\";a:3:{s:8:\"instance\";r:1130;s:6:\"parent\";r:196;s:8:\"children\";a:5:{s:33:\"admin/report/products/bestsellers\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:33:\"admin/report/products/bestsellers\";}s:26:\"admin/report/products/sold\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:26:\"admin/report/products/sold\";}s:28:\"admin/report/products/viewed\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:28:\"admin/report/products/viewed\";}s:30:\"admin/report/products/lowstock\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:30:\"admin/report/products/lowstock\";}s:31:\"admin/report/products/downloads\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:31:\"admin/report/products/downloads\";}}}s:33:\"admin/report/products/bestsellers\";a:3:{s:8:\"instance\";r:1220;s:6:\"parent\";r:1130;s:8:\"children\";a:0:{}}s:26:\"admin/report/products/sold\";a:3:{s:8:\"instance\";r:1222;s:6:\"parent\";r:1130;s:8:\"children\";a:0:{}}s:28:\"admin/report/products/viewed\";a:3:{s:8:\"instance\";r:1224;s:6:\"parent\";r:1130;s:8:\"children\";a:0:{}}s:30:\"admin/report/products/lowstock\";a:3:{s:8:\"instance\";r:1226;s:6:\"parent\";r:1130;s:8:\"children\";a:0:{}}s:31:\"admin/report/products/downloads\";a:3:{s:8:\"instance\";r:1228;s:6:\"parent\";r:1130;s:8:\"children\";a:0:{}}s:22:\"admin/report/customers\";a:3:{s:8:\"instance\";r:1132;s:6:\"parent\";r:196;s:8:\"children\";a:3:{s:31:\"admin/report/customers/accounts\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:31:\"admin/report/customers/accounts\";}s:29:\"admin/report/customers/totals\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/report/customers/totals\";}s:29:\"admin/report/customers/orders\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:29:\"admin/report/customers/orders\";}}}s:31:\"admin/report/customers/accounts\";a:3:{s:8:\"instance\";r:1254;s:6:\"parent\";r:1132;s:8:\"children\";a:0:{}}s:29:\"admin/report/customers/totals\";a:3:{s:8:\"instance\";r:1256;s:6:\"parent\";r:1132;s:8:\"children\";a:0:{}}s:29:\"admin/report/customers/orders\";a:3:{s:8:\"instance\";r:1258;s:6:\"parent\";r:1132;s:8:\"children\";a:0:{}}s:19:\"admin/report/review\";a:3:{s:8:\"instance\";r:1134;s:6:\"parent\";r:196;s:8:\"children\";a:2:{s:28:\"admin/report/review/customer\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:28:\"admin/report/review/customer\";}s:27:\"admin/report/review/product\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/report/review/product\";}}}s:28:\"admin/report/review/customer\";a:3:{s:8:\"instance\";r:1276;s:6:\"parent\";r:1134;s:8:\"children\";a:0:{}}s:27:\"admin/report/review/product\";a:3:{s:8:\"instance\";r:1278;s:6:\"parent\";r:1134;s:8:\"children\";a:0:{}}s:17:\"admin/report/tags\";a:3:{s:8:\"instance\";r:1136;s:6:\"parent\";r:196;s:8:\"children\";a:3:{s:26:\"admin/report/tags/customer\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:26:\"admin/report/tags/customer\";}s:25:\"admin/report/tags/popular\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:25:\"admin/report/tags/popular\";}s:25:\"admin/report/tags/product\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:25:\"admin/report/tags/product\";}}}s:26:\"admin/report/tags/customer\";a:3:{s:8:\"instance\";r:1292;s:6:\"parent\";r:1136;s:8:\"children\";a:0:{}}s:25:\"admin/report/tags/popular\";a:3:{s:8:\"instance\";r:1294;s:6:\"parent\";r:1136;s:8:\"children\";a:0:{}}s:25:\"admin/report/tags/product\";a:3:{s:8:\"instance\";r:1296;s:6:\"parent\";r:1136;s:8:\"children\";a:0:{}}s:19:\"admin/report/search\";a:3:{s:8:\"instance\";r:1138;s:6:\"parent\";r:196;s:8:\"children\";a:0:{}}s:23:\"admin/report/statistics\";a:3:{s:8:\"instance\";r:1140;s:6:\"parent\";r:196;s:8:\"children\";a:0:{}}s:16:\"admin/newsletter\";a:3:{s:8:\"instance\";r:198;s:6:\"parent\";r:176;s:8:\"children\";a:4:{s:24:\"admin/newsletter/problem\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:24:\"admin/newsletter/problem\";}s:22:\"admin/newsletter/queue\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:22:\"admin/newsletter/queue\";}s:27:\"admin/newsletter/subscriber\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:27:\"admin/newsletter/subscriber\";}s:25:\"admin/newsletter/template\";O:29:\"Mage_Admin_Model_Acl_Resource\":1:{s:14:\"\0*\0_resourceId\";s:25:\"admin/newsletter/template\";}}}s:24:\"admin/newsletter/problem\";a:3:{s:8:\"instance\";r:1322;s:6:\"parent\";r:198;s:8:\"children\";a:0:{}}s:22:\"admin/newsletter/queue\";a:3:{s:8:\"instance\";r:1324;s:6:\"parent\";r:198;s:8:\"children\";a:0:{}}s:27:\"admin/newsletter/subscriber\";a:3:{s:8:\"instance\";r:1326;s:6:\"parent\";r:198;s:8:\"children\";a:0:{}}s:25:\"admin/newsletter/template\";a:3:{s:8:\"instance\";r:1328;s:6:\"parent\";r:198;s:8:\"children\";a:0:{}}s:16:\"admin/page_cache\";a:3:{s:8:\"instance\";r:200;s:6:\"parent\";r:176;s:8:\"children\";a:0:{}}}s:17:\"\0*\0_isAllowedRole\";r:152;s:21:\"\0*\0_isAllowedResource\";r:740;s:22:\"\0*\0_isAllowedPrivilege\";N;s:9:\"\0*\0_rules\";a:2:{s:12:\"allResources\";a:2:{s:8:\"allRoles\";a:2:{s:13:\"allPrivileges\";a:2:{s:4:\"type\";s:9:\"TYPE_DENY\";s:6:\"assert\";N;}s:13:\"byPrivilegeId\";a:0:{}}s:8:\"byRoleId\";a:1:{s:2:\"G1\";a:2:{s:13:\"byPrivilegeId\";a:0:{}s:13:\"allPrivileges\";a:2:{s:4:\"type\";s:10:\"TYPE_ALLOW\";s:6:\"assert\";N;}}}}s:12:\"byResourceId\";a:1:{s:3:\"all\";a:1:{s:8:\"byRoleId\";a:1:{s:2:\"G1\";a:2:{s:13:\"byPrivilegeId\";a:0:{}s:13:\"allPrivileges\";a:2:{s:4:\"type\";s:10:\"TYPE_ALLOW\";s:6:\"assert\";N;}}}}}}}}');
...
DROP TABLE IF EXISTS `shop_core_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_store` (
  ...
  UNIQUE KEY `UNQ_SHOP_CORE_STORE_CODE` (`code`),
  KEY `IDX_SHOP_CORE_STORE_WEBSITE_ID` (`website_id`),
  KEY `IDX_SHOP_CORE_STORE_IS_ACTIVE_SORT_ORDER` (`is_active`,`sort_order`),
  KEY `IDX_SHOP_CORE_STORE_GROUP_ID` (`group_id`),
  CONSTRAINT `FK_SHOP_CORE_STORE_GROUP_ID_SHOP_CORE_STORE_GROUP_GROUP_ID` FOREIGN KEY (`group_id`) REFERENCES `shop_core_store_group` (`group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CORE_STORE_WEBSITE_ID_SHOP_CORE_WEBSITE_WEBSITE_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_core_store_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_store_group` (
  ...
  KEY `IDX_SHOP_CORE_STORE_GROUP_WEBSITE_ID` (`website_id`),
  KEY `IDX_SHOP_CORE_STORE_GROUP_DEFAULT_STORE_ID` (`default_store_id`),
...
DROP TABLE IF EXISTS `shop_core_translate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_translate` (
  ...
  PRIMARY KEY (`key_id`),
  UNIQUE KEY `UNQ_SHOP_CORE_TRANSLATE_STORE_ID_LOCALE_CRC_STRING_STRING` (`store_id`,`locale`,`crc_string`,`string`),
  KEY `IDX_SHOP_CORE_TRANSLATE_STORE_ID` (`store_id`),
...
DROP TABLE IF EXISTS `shop_core_url_rewrite`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_url_rewrite` (
  ...
  UNIQUE KEY `UNQ_SHOP_CORE_URL_REWRITE_REQUEST_PATH_STORE_ID` (`request_path`,`store_id`),
  UNIQUE KEY `UNQ_SHOP_CORE_URL_REWRITE_ID_PATH_IS_SYSTEM_STORE_ID` (`id_path`,`is_system`,`store_id`),
  KEY `IDX_SHOP_CORE_URL_REWRITE_TARGET_PATH_STORE_ID` (`target_path`,`store_id`),
  KEY `IDX_SHOP_CORE_URL_REWRITE_ID_PATH` (`id_path`),
  KEY `IDX_SHOP_CORE_URL_REWRITE_STORE_ID` (`store_id`),
  KEY `FK_SHOP_CORE_URL_REWRITE_CTGR_ID_SHOP_CAT_CTGR_ENTT_ENTT_ID` (`category_id`),
  KEY `FK_SHOP_CORE_URL_REWRITE_PRD_ID_SHOP_CAT_CTGR_ENTT_ENTT_ID` (`product_id`),
...
INSERT INTO `shop_core_url_rewrite` VALUES (1,1,'product/1','botelya.html','catalog/product/view/id/1',1,NULL,NULL,NULL,1),(3,1,'product/2','simple-2.html','catalog/product/view/id/2',1,NULL,NULL,NULL,2);
...
DROP TABLE IF EXISTS `shop_core_variable`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_variable` (
...
DROP TABLE IF EXISTS `shop_core_variable_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_variable_value` (
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CORE_VARIABLE_VALUE_VARIABLE_ID_STORE_ID` (`variable_id`,`store_id`),
  KEY `IDX_SHOP_CORE_VARIABLE_VALUE_VARIABLE_ID` (`variable_id`),
  KEY `IDX_SHOP_CORE_VARIABLE_VALUE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_B7C5B6891F9EB6E2C6BDF807846A69B3` FOREIGN KEY (`variable_id`) REFERENCES `shop_core_variable` (`variable_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CORE_VARIABLE_VALUE_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_core_website`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_core_website` (
  ...
  PRIMARY KEY (`website_id`),
  UNIQUE KEY `UNQ_SHOP_CORE_WEBSITE_CODE` (`code`),
  KEY `IDX_SHOP_CORE_WEBSITE_SORT_ORDER` (`sort_order`),
...
DROP TABLE IF EXISTS `shop_coupon_aggregated`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_coupon_aggregated` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_COUPON_AGGRED_PERIOD_STORE_ID_ORDER_STS_COUPON_CODE` (`period`,`store_id`,`order_status`,`coupon_code`),
  KEY `IDX_SHOP_COUPON_AGGREGATED_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_COUPON_AGGREGATED_RULE_NAME` (`rule_name`),
  CONSTRAINT `FK_SHOP_COUPON_AGGREGATED_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_coupon_aggregated_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_coupon_aggregated_order` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date NOT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `order_status` varchar(50) DEFAULT NULL COMMENT 'Order Status',
  ...
  `rule_name` varchar(255) DEFAULT NULL COMMENT 'Rule Name',
  PRIMARY KEY (`id`),
  UNIQUE KEY `9AA4C279C377CB7A7EE9FEE578C9AA2E` (`period`,`store_id`,`order_status`,`coupon_code`),
  KEY `IDX_SHOP_COUPON_AGGREGATED_ORDER_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_COUPON_AGGREGATED_ORDER_RULE_NAME` (`rule_name`),
...
DROP TABLE IF EXISTS `shop_coupon_aggregated_updated`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_coupon_aggregated_updated` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date NOT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `order_status` varchar(50) DEFAULT NULL COMMENT 'Order Status',
  ...
  `rule_name` varchar(255) DEFAULT NULL COMMENT 'Rule Name',
  PRIMARY KEY (`id`),
  UNIQUE KEY `BD78A415CEF9800B90CF1766F47B29F4` (`period`,`store_id`,`order_status`,`coupon_code`),
  KEY `IDX_SHOP_COUPON_AGGREGATED_UPDATED_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_COUPON_AGGREGATED_UPDATED_RULE_NAME` (`rule_name`),
  CONSTRAINT `FK_SHOP_COUPON_AGGRED_UPDATED_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Shop Coupon Aggregated Updated';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `shop_cron_schedule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_cron_schedule` (
  ...
  KEY `IDX_SHOP_CRON_SCHEDULE_JOB_CODE` (`job_code`),
  KEY `IDX_SHOP_CRON_SCHEDULE_SCHEDULED_AT_STATUS` (`scheduled_at`,`status`)
...
DROP TABLE IF EXISTS `shop_customer_address_entity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_address_entity` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_set_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Set Id',
  ...
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_PARENT_ID` (`parent_id`),
...
DROP TABLE IF EXISTS `shop_customer_address_entity_datetime`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_address_entity_datetime` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CUSTOMER_ADDRESS_ENTITY_DATETIME_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_DATETIME_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_DATETIME_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_DATETIME_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CSTR_ADDR_ENTT_DTIME_ENTT_ID_ATTR_ID_VAL` (`entity_id`,`attribute_id`,`value`),
  CONSTRAINT `FK_1365B915D914595DEC21E83A01B56853` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ADDR_ENTT_DTIME_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ADDR_ENTT_DTIME_ENTT_ID_SHOP_CSTR_ADDR_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_customer_address_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_customer_address_entity_decimal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_address_entity_decimal` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  `value` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CUSTOMER_ADDRESS_ENTITY_DECIMAL_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_DECIMAL_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_DECIMAL_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CSTR_ADDR_ENTT_DEC_ENTT_ID_ATTR_ID_VAL` (`entity_id`,`attribute_id`,`value`),
  CONSTRAINT `FK_DE563C0056763CC4B8FA148FCA503D44` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ADDR_ENTT_DEC_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_customer_address_entity_int`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_address_entity_int` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  `value` int(11) NOT NULL DEFAULT '0' COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CUSTOMER_ADDRESS_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_INT_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_INT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_INT_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CSTR_ADDR_ENTT_INT_ENTT_ID_ATTR_ID_VAL` (`entity_id`,`attribute_id`,`value`),
  CONSTRAINT `FK_C44446BF790755DCB92B43AA2373C32C` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ADDR_ENTT_INT_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ADDR_ENTT_INT_ENTT_ID_SHOP_CSTR_ADDR_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_customer_address_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_customer_address_entity_text`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_address_entity_text` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CUSTOMER_ADDRESS_ENTITY_TEXT_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_TEXT_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_TEXT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_TEXT_ENTITY_ID` (`entity_id`),
  CONSTRAINT `FK_CD5204B0DA61B885102094EB618548B7` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ADDR_ENTT_TEXT_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_customer_address_entity_varchar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_address_entity_varchar` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  `value` varchar(255) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CUSTOMER_ADDRESS_ENTITY_VARCHAR_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_VARCHAR_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_VARCHAR_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ADDRESS_ENTITY_VARCHAR_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CSTR_ADDR_ENTT_VCHR_ENTT_ID_ATTR_ID_VAL` (`entity_id`,`attribute_id`,`value`),
  CONSTRAINT `FK_737A2B42C5EF75D4EE3BC98C8C1EC956` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ADDR_ENTT_VCHR_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ADDR_ENTT_VCHR_ENTT_ID_SHOP_CSTR_ADDR_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_customer_address_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_customer_eav_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_eav_attribute` (
  `attribute_id` smallint(5) unsigned NOT NULL COMMENT 'Attribute Id',
  `is_visible` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'Is Visible',
  ...
  PRIMARY KEY (`attribute_id`),
  CONSTRAINT `FK_SHOP_CSTR_EAV_ATTR_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_customer_eav_attribute_website`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_eav_attribute_website` (
  `attribute_id` smallint(5) unsigned NOT NULL COMMENT 'Attribute Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  ...
  KEY `IDX_SHOP_CUSTOMER_EAV_ATTRIBUTE_WEBSITE_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_SHOP_CSTR_EAV_ATTR_WS_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_customer_entity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_entity` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_set_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Set Id',
  ...
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `UNQ_SHOP_CUSTOMER_ENTITY_EMAIL_WEBSITE_ID` (`email`,`website_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_EMAIL_WEBSITE_ID` (`email`,`website_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_SHOP_CUSTOMER_ENTITY_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CUSTOMER_ENTITY_WEBSITE_ID_SHOP_CORE_WEBSITE_WEBSITE_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_customer_entity_datetime`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_entity_datetime` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  `value` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CUSTOMER_ENTITY_DATETIME_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_DATETIME_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_DATETIME_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_DATETIME_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_DATETIME_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`),
  CONSTRAINT `FK_09B5B9EFE037652782A1906E2941B106` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ENTT_DTIME_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_customer_entity_decimal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_entity_decimal` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  `value` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CUSTOMER_ENTITY_DECIMAL_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_DECIMAL_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_DECIMAL_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_DECIMAL_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`),
  CONSTRAINT `FK_08715F1E78B58DF4414A6C286018A0F0` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ENTT_DEC_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ENTT_DEC_ENTT_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_customer_entity_int`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_entity_int` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  `value` int(11) NOT NULL DEFAULT '0' COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CUSTOMER_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_INT_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_INT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_INT_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`),
  CONSTRAINT `FK_BC80D0BACD09A25845D8FEF4C72AF698` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ENTT_INT_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ENTT_INT_ENTT_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_customer_entity_text`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_entity_text` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  `value` text NOT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CUSTOMER_ENTITY_TEXT_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_TEXT_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_TEXT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_TEXT_ENTITY_ID` (`entity_id`),
  CONSTRAINT `FK_5ACD895915CCB96E9214EA15114DCD72` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ENTT_TEXT_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_customer_entity_varchar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_entity_varchar` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  `value` varchar(255) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_CUSTOMER_ENTITY_VARCHAR_ENTITY_ID_ATTRIBUTE_ID` (`entity_id`,`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_VARCHAR_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_VARCHAR_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_VARCHAR_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_CUSTOMER_ENTITY_VARCHAR_ENTITY_ID_ATTRIBUTE_ID_VALUE` (`entity_id`,`attribute_id`,`value`),
  CONSTRAINT `FK_99D0D30B3E2E10B1E920CBB506819E5C` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ENTT_VCHR_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_CSTR_ENTT_VCHR_ENTT_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_customer_form_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_customer_form_attribute` (
  `form_code` varchar(32) NOT NULL COMMENT 'Form Code',
  `attribute_id` smallint(5) unsigned NOT NULL COMMENT 'Attribute Id',
  PRIMARY KEY (`form_code`,`attribute_id`),
  KEY `IDX_SHOP_CUSTOMER_FORM_ATTRIBUTE_ATTRIBUTE_ID` (`attribute_id`),
  CONSTRAINT `FK_SHOP_CSTR_FORM_ATTR_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_dataflow_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_dataflow_batch` (
  ...
  KEY `IDX_SHOP_DATAFLOW_BATCH_PROFILE_ID` (`profile_id`),
  KEY `IDX_SHOP_DATAFLOW_BATCH_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_DATAFLOW_BATCH_CREATED_AT` (`created_at`),
  CONSTRAINT `FK_905A17A6EB35D0300332DA4B0F0A2F6B` FOREIGN KEY (`profile_id`) REFERENCES `shop_dataflow_profile` (`profile_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `FK_SHOP_DATAFLOW_BATCH_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
DROP TABLE IF EXISTS `shop_dataflow_batch_export`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_dataflow_batch_export` (
  `batch_export_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Batch Export Id',
  `batch_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Batch Id',
  `batch_data` longtext COMMENT 'Batch Data',
  `status` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Status',
  PRIMARY KEY (`batch_export_id`),
  KEY `IDX_SHOP_DATAFLOW_BATCH_EXPORT_BATCH_ID` (`batch_id`),
...
DROP TABLE IF EXISTS `shop_dataflow_batch_import`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_dataflow_batch_import` (
  `batch_import_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Batch Import Id',
  `batch_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Batch Id',
  `batch_data` longtext COMMENT 'Batch Data',
  `status` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Status',
  PRIMARY KEY (`batch_import_id`),
  KEY `IDX_SHOP_DATAFLOW_BATCH_IMPORT_BATCH_ID` (`batch_id`),
  CONSTRAINT `FK_FF12CAAC5CF551C6232940707C455EA5` FOREIGN KEY (`batch_id`) REFERENCES `shop_dataflow_batch` (`batch_id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
DROP TABLE IF EXISTS `shop_dataflow_import_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_dataflow_import_data` (
  ...
  KEY `IDX_SHOP_DATAFLOW_IMPORT_DATA_SESSION_ID` (`session_id`),
...
DROP TABLE IF EXISTS `shop_dataflow_profile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_dataflow_profile` (
...
DROP TABLE IF EXISTS `shop_dataflow_profile_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_dataflow_profile_history` (
  ...
  KEY `IDX_SHOP_DATAFLOW_PROFILE_HISTORY_PROFILE_ID` (`profile_id`),
...
DROP TABLE IF EXISTS `shop_dataflow_session`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_dataflow_session` (
...
DROP TABLE IF EXISTS `shop_design_change`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_design_change` (
  ...
  KEY `IDX_SHOP_DESIGN_CHANGE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_DESIGN_CHANGE_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_directory_country`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_directory_country` (
...
DROP TABLE IF EXISTS `shop_directory_country_format`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_directory_country_format` (
  `country_format_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Country Format Id',
  `country_id` varchar(2) DEFAULT NULL COMMENT 'Country Id in ISO-2',
  `type` varchar(30) DEFAULT NULL COMMENT 'Country Format Type',
  `format` text NOT NULL COMMENT 'Country Format',
  PRIMARY KEY (`country_format_id`),
  UNIQUE KEY `UNQ_SHOP_DIRECTORY_COUNTRY_FORMAT_COUNTRY_ID_TYPE` (`country_id`,`type`)
...
DROP TABLE IF EXISTS `shop_directory_country_region`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_directory_country_region` (
...
DROP TABLE IF EXISTS `shop_directory_country_region_name`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_directory_country_region_name` (
  `locale` varchar(8) NOT NULL DEFAULT '' COMMENT 'Locale',
  `region_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Region Id',
  `name` varchar(255) DEFAULT NULL COMMENT 'Region Name',
  PRIMARY KEY (`locale`,`region_id`),
  KEY `IDX_SHOP_DIRECTORY_COUNTRY_REGION_NAME_REGION_ID` (`region_id`),
  CONSTRAINT `FK_DA9E72E8D5BE6A3915C0964EECFD02B7` FOREIGN KEY (`region_id`) REFERENCES `shop_directory_country_region` (`region_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_directory_currency_rate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_directory_currency_rate` (
...
DROP TABLE IF EXISTS `shop_downloadable_link`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_downloadable_link` (
  `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Link ID',
  `product_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Product ID',
  `sort_order` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Sort order',
  ...
  PRIMARY KEY (`link_id`),
  KEY `IDX_SHOP_DOWNLOADABLE_LINK_PRODUCT_ID` (`product_id`),
  KEY `IDX_SHOP_DOWNLOADABLE_LINK_PRODUCT_ID_SORT_ORDER` (`product_id`,`sort_order`),
  CONSTRAINT `FK_SHOP_DL_LNK_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_downloadable_link_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_downloadable_link_price` (
  `price_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Price ID',
  `link_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Link ID',
  `website_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Website ID',
  `price` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Price',
  PRIMARY KEY (`price_id`),
  KEY `IDX_SHOP_DOWNLOADABLE_LINK_PRICE_LINK_ID` (`link_id`),
  KEY `IDX_SHOP_DOWNLOADABLE_LINK_PRICE_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_SHOP_DL_LNK_PRICE_LNK_ID_SHOP_DL_LNK_LNK_ID` FOREIGN KEY (`link_id`) REFERENCES `shop_downloadable_link` (`link_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_downloadable_link_purchased`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_downloadable_link_purchased` (
  ...
  KEY `IDX_SHOP_DOWNLOADABLE_LINK_PURCHASED_ORDER_ID` (`order_id`),
  KEY `IDX_SHOP_DOWNLOADABLE_LINK_PURCHASED_ORDER_ITEM_ID` (`order_item_id`),
  KEY `IDX_SHOP_DOWNLOADABLE_LINK_PURCHASED_CUSTOMER_ID` (`customer_id`),
  CONSTRAINT `FK_SHOP_DL_LNK_PURCHASED_CSTR_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_downloadable_link_purchased_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_downloadable_link_purchased_item` (
  `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Item ID',
  ...
  PRIMARY KEY (`item_id`),
  KEY `IDX_SHOP_DOWNLOADABLE_LINK_PURCHASED_ITEM_LINK_HASH` (`link_hash`),
  KEY `IDX_SHOP_DOWNLOADABLE_LINK_PURCHASED_ITEM_ORDER_ITEM_ID` (`order_item_id`),
  KEY `IDX_SHOP_DOWNLOADABLE_LINK_PURCHASED_ITEM_PURCHASED_ID` (`purchased_id`),
  CONSTRAINT `FK_C0BCCC289E63FBB7B233698885D08D50` FOREIGN KEY (`order_item_id`) REFERENCES `shop_sales_flat_order_item` (`item_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_C86ADD84A2D143CBCB2E02D79CAB64E8` FOREIGN KEY (`purchased_id`) REFERENCES `shop_downloadable_link_purchased` (`purchased_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_downloadable_link_title`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_downloadable_link_title` (
  `title_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Title ID',
  `link_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Link ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  `title` varchar(255) DEFAULT NULL COMMENT 'Title',
  PRIMARY KEY (`title_id`),
  UNIQUE KEY `UNQ_SHOP_DOWNLOADABLE_LINK_TITLE_LINK_ID_STORE_ID` (`link_id`,`store_id`),
  KEY `IDX_SHOP_DOWNLOADABLE_LINK_TITLE_LINK_ID` (`link_id`),
  KEY `IDX_SHOP_DOWNLOADABLE_LINK_TITLE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_DL_LNK_TTL_LNK_ID_SHOP_DL_LNK_LNK_ID` FOREIGN KEY (`link_id`) REFERENCES `shop_downloadable_link` (`link_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_downloadable_sample`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_downloadable_sample` (
  ...
  KEY `IDX_SHOP_DOWNLOADABLE_SAMPLE_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_SHOP_DL_SAMPLE_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_downloadable_sample_title`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_downloadable_sample_title` (
  `title_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Title ID',
  `sample_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Sample ID',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store ID',
  `title` varchar(255) DEFAULT NULL COMMENT 'Title',
  PRIMARY KEY (`title_id`),
  UNIQUE KEY `UNQ_SHOP_DOWNLOADABLE_SAMPLE_TITLE_SAMPLE_ID_STORE_ID` (`sample_id`,`store_id`),
  KEY `IDX_SHOP_DOWNLOADABLE_SAMPLE_TITLE_SAMPLE_ID` (`sample_id`),
  KEY `IDX_SHOP_DOWNLOADABLE_SAMPLE_TITLE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_DL_SAMPLE_TTL_SAMPLE_ID_SHOP_DL_SAMPLE_SAMPLE_ID` FOREIGN KEY (`sample_id`) REFERENCES `shop_downloadable_sample` (`sample_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_eav_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_attribute` (
  ...
  PRIMARY KEY (`attribute_id`),
  UNIQUE KEY `UNQ_SHOP_EAV_ATTRIBUTE_ENTITY_TYPE_ID_ATTRIBUTE_CODE` (`entity_type_id`,`attribute_code`),
  KEY `IDX_SHOP_EAV_ATTRIBUTE_ENTITY_TYPE_ID` (`entity_type_id`),
  CONSTRAINT `FK_SHOP_EAV_ATTR_ENTT_TYPE_ID_SHOP_EAV_ENTT_TYPE_ENTT_TYPE_ID` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_eav_attribute_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_attribute_group` (
  ...
  UNIQUE KEY `UNQ_SHOP_EAV_ATTR_GROUP_ATTR_SET_ID_ATTR_GROUP_NAME` (`attribute_set_id`,`attribute_group_name`),
  KEY `IDX_SHOP_EAV_ATTRIBUTE_GROUP_ATTRIBUTE_SET_ID_SORT_ORDER` (`attribute_set_id`,`sort_order`),
...
DROP TABLE IF EXISTS `shop_eav_attribute_label`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_attribute_label` (
  `attribute_label_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Attribute Label Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store Id',
  `value` varchar(255) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`attribute_label_id`),
  KEY `IDX_SHOP_EAV_ATTRIBUTE_LABEL_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_EAV_ATTRIBUTE_LABEL_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_EAV_ATTRIBUTE_LABEL_ATTRIBUTE_ID_STORE_ID` (`attribute_id`,`store_id`),
  CONSTRAINT `FK_SHOP_EAV_ATTRIBUTE_LABEL_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_ATTR_LBL_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_eav_attribute_option`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_attribute_option` (
  `option_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `sort_order` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Sort Order',
  PRIMARY KEY (`option_id`),
  KEY `IDX_SHOP_EAV_ATTRIBUTE_OPTION_ATTRIBUTE_ID` (`attribute_id`),
...
DROP TABLE IF EXISTS `shop_eav_attribute_option_value`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_attribute_option_value` (
  `value_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `option_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Option Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store Id',
  `value` varchar(255) DEFAULT NULL COMMENT 'Value',
  PRIMARY KEY (`value_id`),
  KEY `IDX_SHOP_EAV_ATTRIBUTE_OPTION_VALUE_OPTION_ID` (`option_id`),
  KEY `IDX_SHOP_EAV_ATTRIBUTE_OPTION_VALUE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_EAV_ATTR_OPT_VAL_OPT_ID_SHOP_EAV_ATTR_OPT_OPT_ID` FOREIGN KEY (`option_id`) REFERENCES `shop_eav_attribute_option` (`option_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_ATTR_OPT_VAL_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_eav_attribute_set`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_attribute_set` (
  `attribute_set_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Attribute Set Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_set_name` varchar(255) DEFAULT NULL COMMENT 'Attribute Set Name',
  `sort_order` smallint(6) NOT NULL DEFAULT '0' COMMENT 'Sort Order',
  PRIMARY KEY (`attribute_set_id`),
  UNIQUE KEY `UNQ_SHOP_EAV_ATTRIBUTE_SET_ENTITY_TYPE_ID_ATTRIBUTE_SET_NAME` (`entity_type_id`,`attribute_set_name`),
  KEY `IDX_SHOP_EAV_ATTRIBUTE_SET_ENTITY_TYPE_ID_SORT_ORDER` (`entity_type_id`,`sort_order`),
...
DROP TABLE IF EXISTS `shop_eav_entity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_entity` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_set_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Set Id',
  `increment_id` varchar(50) DEFAULT NULL COMMENT 'Increment Id',
  ...
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_EAV_ENTITY_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_EAV_ENTITY_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_EAV_ENTITY_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_ENTT_ENTT_TYPE_ID_SHOP_EAV_ENTT_TYPE_ENTT_TYPE_ID` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_eav_entity_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_entity_attribute` (
  ...
  UNIQUE KEY `UNQ_SHOP_EAV_ENTITY_ATTRIBUTE_ATTRIBUTE_SET_ID_ATTRIBUTE_ID` (`attribute_set_id`,`attribute_id`),
  UNIQUE KEY `UNQ_SHOP_EAV_ENTITY_ATTRIBUTE_ATTRIBUTE_GROUP_ID_ATTRIBUTE_ID` (`attribute_group_id`,`attribute_id`),
  KEY `IDX_SHOP_EAV_ENTITY_ATTRIBUTE_ATTRIBUTE_SET_ID_SORT_ORDER` (`attribute_set_id`,`sort_order`),
  KEY `IDX_SHOP_EAV_ENTITY_ATTRIBUTE_ATTRIBUTE_ID` (`attribute_id`),
  CONSTRAINT `FK_AEE7D56103963D40CCF7701FFB85028C` FOREIGN KEY (`attribute_group_id`) REFERENCES `shop_eav_attribute_group` (`attribute_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_eav_entity_datetime`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_entity_datetime` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store Id',
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_EAV_ENTITY_DATETIME_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_EAV_ENTITY_DATETIME_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_EAV_ENTITY_DATETIME_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_EAV_ENTITY_DATETIME_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_EAV_ENTITY_DATETIME_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_EAV_ENTITY_DATETIME_ATTRIBUTE_ID_VALUE` (`attribute_id`,`value`),
  KEY `IDX_SHOP_EAV_ENTITY_DATETIME_ENTITY_TYPE_ID_VALUE` (`entity_type_id`,`value`),
  CONSTRAINT `FK_36FA30105D0BE04F0EB0AC41D8E6370A` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_ENTITY_DATETIME_ENTITY_ID_SHOP_EAV_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_eav_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_ENTITY_DATETIME_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_eav_entity_decimal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_entity_decimal` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store Id',
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_EAV_ENTITY_DECIMAL_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_EAV_ENTITY_DECIMAL_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_EAV_ENTITY_DECIMAL_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_EAV_ENTITY_DECIMAL_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_EAV_ENTITY_DECIMAL_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_EAV_ENTITY_DECIMAL_ATTRIBUTE_ID_VALUE` (`attribute_id`,`value`),
  KEY `IDX_SHOP_EAV_ENTITY_DECIMAL_ENTITY_TYPE_ID_VALUE` (`entity_type_id`,`value`),
  CONSTRAINT `FK_C5B0763E50FA61F6556E456920B8FF8F` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_ENTITY_DECIMAL_ENTITY_ID_SHOP_EAV_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_eav_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_eav_entity_int`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_entity_int` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store Id',
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_EAV_ENTITY_INT_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_EAV_ENTITY_INT_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_EAV_ENTITY_INT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_EAV_ENTITY_INT_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_EAV_ENTITY_INT_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_EAV_ENTITY_INT_ATTRIBUTE_ID_VALUE` (`attribute_id`,`value`),
  KEY `IDX_SHOP_EAV_ENTITY_INT_ENTITY_TYPE_ID_VALUE` (`entity_type_id`,`value`),
  CONSTRAINT `FK_62625868A52189CD744FEB7C68AD9722` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_ENTITY_INT_ENTITY_ID_SHOP_EAV_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_eav_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_ENTITY_INT_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Eav Entity Value Prefix';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `shop_eav_entity_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_entity_store` (
  ...
  KEY `IDX_SHOP_EAV_ENTITY_STORE_ENTITY_TYPE_ID` (`entity_type_id`),
...
DROP TABLE IF EXISTS `shop_eav_entity_text`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_entity_text` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store Id',
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_EAV_ENTITY_TEXT_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_EAV_ENTITY_TEXT_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_EAV_ENTITY_TEXT_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_EAV_ENTITY_TEXT_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_EAV_ENTITY_TEXT_ENTITY_ID` (`entity_id`),
  CONSTRAINT `FK_C2FC8DFBBFAA65D464B09CCD54274B1A` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_ENTITY_TEXT_ENTITY_ID_SHOP_EAV_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_eav_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_eav_entity_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_entity_type` (
  ...
  KEY `IDX_SHOP_EAV_ENTITY_TYPE_ENTITY_TYPE_CODE` (`entity_type_code`)
...
DROP TABLE IF EXISTS `shop_eav_entity_varchar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_entity_varchar` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `entity_type_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Type Id',
  `attribute_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Attribute Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store Id',
  ...
  PRIMARY KEY (`value_id`),
  UNIQUE KEY `UNQ_SHOP_EAV_ENTITY_VARCHAR_ENTITY_ID_ATTRIBUTE_ID_STORE_ID` (`entity_id`,`attribute_id`,`store_id`),
  KEY `IDX_SHOP_EAV_ENTITY_VARCHAR_ENTITY_TYPE_ID` (`entity_type_id`),
  KEY `IDX_SHOP_EAV_ENTITY_VARCHAR_ATTRIBUTE_ID` (`attribute_id`),
  KEY `IDX_SHOP_EAV_ENTITY_VARCHAR_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_EAV_ENTITY_VARCHAR_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_EAV_ENTITY_VARCHAR_ATTRIBUTE_ID_VALUE` (`attribute_id`,`value`),
  KEY `IDX_SHOP_EAV_ENTITY_VARCHAR_ENTITY_TYPE_ID_VALUE` (`entity_type_id`,`value`),
  CONSTRAINT `FK_2EDD86729761E4864C782917C59EE399` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_ENTITY_VARCHAR_ENTITY_ID_SHOP_EAV_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_eav_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_ENTITY_VARCHAR_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Eav Entity Value Prefix';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `shop_eav_form_element`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_form_element` (
  ...
  UNIQUE KEY `UNQ_SHOP_EAV_FORM_ELEMENT_TYPE_ID_ATTRIBUTE_ID` (`type_id`,`attribute_id`),
  KEY `IDX_SHOP_EAV_FORM_ELEMENT_TYPE_ID` (`type_id`),
  KEY `IDX_SHOP_EAV_FORM_ELEMENT_FIELDSET_ID` (`fieldset_id`),
  KEY `IDX_SHOP_EAV_FORM_ELEMENT_ATTRIBUTE_ID` (`attribute_id`),
  CONSTRAINT `FK_SHOP_EAV_FORM_ELEMENT_TYPE_ID_SHOP_EAV_FORM_TYPE_TYPE_ID` FOREIGN KEY (`type_id`) REFERENCES `shop_eav_form_type` (`type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_FORM_ELM_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_EAV_FORM_ELM_FSET_ID_SHOP_EAV_FORM_FSET_FSET_ID` FOREIGN KEY (`fieldset_id`) REFERENCES `shop_eav_form_fieldset` (`fieldset_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_eav_form_fieldset`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_form_fieldset` (
  `fieldset_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Fieldset Id',
  `type_id` smallint(5) unsigned NOT NULL COMMENT 'Type Id',
  `code` varchar(64) NOT NULL COMMENT 'Code',
  `sort_order` int(11) NOT NULL DEFAULT '0' COMMENT 'Sort Order',
  PRIMARY KEY (`fieldset_id`),
  UNIQUE KEY `UNQ_SHOP_EAV_FORM_FIELDSET_TYPE_ID_CODE` (`type_id`,`code`),
  KEY `IDX_SHOP_EAV_FORM_FIELDSET_TYPE_ID` (`type_id`),
  CONSTRAINT `FK_SHOP_EAV_FORM_FIELDSET_TYPE_ID_SHOP_EAV_FORM_TYPE_TYPE_ID` FOREIGN KEY (`type_id`) REFERENCES `shop_eav_form_type` (`type_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_eav_form_fieldset_label`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_form_fieldset_label` (
  `fieldset_id` smallint(5) unsigned NOT NULL COMMENT 'Fieldset Id',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store Id',
  `label` varchar(255) NOT NULL COMMENT 'Label',
  PRIMARY KEY (`fieldset_id`,`store_id`),
  KEY `IDX_SHOP_EAV_FORM_FIELDSET_LABEL_FIELDSET_ID` (`fieldset_id`),
  KEY `IDX_SHOP_EAV_FORM_FIELDSET_LABEL_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_EAV_FORM_FSET_LBL_FSET_ID_SHOP_EAV_FORM_FSET_FSET_ID` FOREIGN KEY (`fieldset_id`) REFERENCES `shop_eav_form_fieldset` (`fieldset_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_eav_form_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_form_type` (
  ...
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store Id',
  PRIMARY KEY (`type_id`),
  UNIQUE KEY `UNQ_SHOP_EAV_FORM_TYPE_CODE_THEME_STORE_ID` (`code`,`theme`,`store_id`),
  KEY `IDX_SHOP_EAV_FORM_TYPE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_EAV_FORM_TYPE_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_eav_form_type_entity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_eav_form_type_entity` (
  `type_id` smallint(5) unsigned NOT NULL COMMENT 'Type Id',
  `entity_type_id` smallint(5) unsigned NOT NULL COMMENT 'Entity Type Id',
  PRIMARY KEY (`type_id`,`entity_type_id`),
  KEY `IDX_SHOP_EAV_FORM_TYPE_ENTITY_ENTITY_TYPE_ID` (`entity_type_id`),
  CONSTRAINT `FK_1895042BC11C03F8F4B44FCF920B1FDA` FOREIGN KEY (`entity_type_id`) REFERENCES `shop_eav_entity_type` (`entity_type_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_gift_message`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_gift_message` (
...
DROP TABLE IF EXISTS `shop_importexport_importdata`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_importexport_importdata` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
...
DROP TABLE IF EXISTS `shop_index_event`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_index_event` (
...
DROP TABLE IF EXISTS `shop_index_process`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_index_process` (
  ...
  UNIQUE KEY `UNQ_SHOP_INDEX_PROCESS_INDEXER_CODE` (`indexer_code`)
...
INSERT INTO `shop_index_process` VALUES (1,'catalog_product_attribute','pending','2015-07-03 22:38:04','2015-07-03 22:38:04','real_time'),(2,'catalog_product_price','pending','2015-07-03 22:38:04','2015-07-03 22:38:06','real_time'),(3,'catalog_url','pending','2015-07-03 22:38:06','2015-07-03 22:38:06','real_time'),(4,'catalog_product_flat','pending','2015-07-01 04:32:39','2015-07-01 04:32:39','real_time'),(5,'catalog_category_flat','pending','2015-07-01 04:32:39','2015-07-01 04:32:39','real_time'),(6,'catalog_category_product','pending','2015-07-03 22:38:06','2015-07-03 22:38:07','real_time'),(7,'catalogsearch_fulltext','pending','2015-07-03 22:38:07','2015-07-03 22:38:07','real_time'),(8,'cataloginventory_stock','pending','2015-07-03 22:38:03','2015-07-03 22:38:04','real_time'),(9,'tag_summary','pending','2015-07-03 22:38:07','2015-07-03 22:38:07','real_time');
...
DROP TABLE IF EXISTS `shop_index_process_event`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_index_process_event` (
  `process_id` int(10) unsigned NOT NULL COMMENT 'Process Id',
  `event_id` bigint(20) unsigned NOT NULL COMMENT 'Event Id',
  `status` varchar(7) NOT NULL DEFAULT 'new' COMMENT 'Status',
  PRIMARY KEY (`process_id`,`event_id`),
  KEY `IDX_SHOP_INDEX_PROCESS_EVENT_EVENT_ID` (`event_id`),
  CONSTRAINT `FK_SHOP_IDX_PROCESS_EVENT_PROCESS_ID_SHOP_IDX_PROCESS_PROCESS_ID` FOREIGN KEY (`process_id`) REFERENCES `shop_index_process` (`process_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_log_customer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_log_customer` (
  ...
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store ID',
  PRIMARY KEY (`log_id`),
  KEY `IDX_SHOP_LOG_CUSTOMER_VISITOR_ID` (`visitor_id`)
...
DROP TABLE IF EXISTS `shop_log_quote`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_log_quote` (
...
INSERT INTO `shop_log_quote` VALUES (1,6,'2015-07-02 07:35:13',NULL);
...
DROP TABLE IF EXISTS `shop_log_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_log_summary` (
...
DROP TABLE IF EXISTS `shop_log_summary_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_log_summary_type` (
  `type_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Type ID',
...
DROP TABLE IF EXISTS `shop_log_url`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_log_url` (
  `url_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT 'URL ID',
  `visitor_id` bigint(20) unsigned DEFAULT NULL COMMENT 'Visitor ID',
  `visit_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Visit Time',
  KEY `IDX_SHOP_LOG_URL_VISITOR_ID` (`visitor_id`),
  KEY `url_id` (`url_id`)
...
INSERT INTO `shop_log_url` VALUES (1,1,'2015-07-01 04:31:09'),(2,1,'2015-07-01 04:35:32'),(3,1,'2015-07-01 04:37:43'),(4,1,'2015-07-01 04:37:46'),(5,1,'2015-07-01 04:37:47'),(6,1,'2015-07-01 04:37:50'),(7,1,'2015-07-01 04:37:52'),(8,1,'2015-07-01 04:38:29'),(9,1,'2015-07-01 04:38:30'),(10,1,'2015-07-01 04:38:32'),(11,1,'2015-07-01 04:38:35'),(12,1,'2015-07-01 04:38:36'),(13,1,'2015-07-01 04:38:40'),(14,1,'2015-07-01 04:38:41'),(15,1,'2015-07-01 04:38:42'),(16,1,'2015-07-01 04:38:48'),(17,1,'2015-07-01 04:38:52'),(18,1,'2015-07-01 04:38:53'),(19,1,'2015-07-01 04:38:57'),(20,1,'2015-07-01 04:38:58'),(21,1,'2015-07-01 04:39:22'),(22,1,'2015-07-01 04:39:22'),(23,2,'2015-07-01 04:49:35'),(24,2,'2015-07-01 04:49:48'),(25,2,'2015-07-01 04:49:53'),(26,2,'2015-07-01 04:56:31'),(27,2,'2015-07-01 04:56:41'),(28,2,'2015-07-01 04:56:44'),(29,2,'2015-07-01 05:37:22'),(30,2,'2015-07-01 05:37:33'),(31,2,'2015-07-01 05:37:33'),(32,3,'2015-07-01 07:12:11'),(33,4,'2015-07-01 07:19:42'),(34,4,'2015-07-01 07:20:43'),(35,4,'2015-07-01 07:22:23'),(36,4,'2015-07-01 07:22:50'),(38,6,'2015-07-02 05:25:01'),(37,5,'2015-07-02 05:25:01'),(39,6,'2015-07-02 05:26:55'),(41,6,'2015-07-02 05:27:56'),(40,6,'2015-07-02 05:27:56'),(42,6,'2015-07-02 05:28:12'),(43,6,'2015-07-02 05:28:15'),(44,6,'2015-07-02 05:28:15'),(45,6,'2015-07-02 05:28:18'),(46,6,'2015-07-02 05:30:40'),(47,6,'2015-07-02 05:30:47'),(48,6,'2015-07-02 05:31:23'),(49,6,'2015-07-02 05:31:29'),(50,6,'2015-07-02 05:35:13'),(51,6,'2015-07-02 05:35:19'),(52,6,'2015-07-02 05:37:27'),(53,6,'2015-07-02 05:37:29'),(54,6,'2015-07-02 05:37:31'),(55,6,'2015-07-02 05:44:14'),(56,6,'2015-07-02 06:07:44'),(57,6,'2015-07-02 06:07:48'),(58,6,'2015-07-02 06:08:17'),(59,6,'2015-07-02 06:08:46'),(60,6,'2015-07-02 06:10:05'),(61,6,'2015-07-02 06:10:51'),(62,6,'2015-07-02 06:11:33'),(63,6,'2015-07-02 06:11:55'),(64,6,'2015-07-02 06:13:00'),(65,6,'2015-07-02 06:13:02'),(66,6,'2015-07-02 06:13:02'),(67,6,'2015-07-02 06:13:03'),(68,6,'2015-07-02 06:13:03'),(69,6,'2015-07-02 06:13:03'),(70,6,'2015-07-02 06:13:32'),(71,6,'2015-07-02 06:15:26'),(72,6,'2015-07-02 06:16:01'),(73,6,'2015-07-02 06:16:06'),(74,6,'2015-07-02 06:16:21'),(75,6,'2015-07-02 06:34:09'),(76,6,'2015-07-02 06:34:10'),(77,6,'2015-07-02 06:56:00'),(78,6,'2015-07-02 07:12:16'),(79,6,'2015-07-02 07:15:29'),(80,6,'2015-07-02 07:16:25'),(81,6,'2015-07-02 07:18:21'),(82,6,'2015-07-02 07:18:56'),(83,6,'2015-07-02 07:19:29'),(84,6,'2015-07-02 07:19:32'),(85,6,'2015-07-02 07:28:40'),(86,6,'2015-07-02 07:28:45'),(87,6,'2015-07-02 07:29:07'),(88,6,'2015-07-02 07:31:06'),(89,6,'2015-07-02 07:35:13'),(90,6,'2015-07-02 07:35:14'),(91,6,'2015-07-02 07:35:22'),(92,6,'2015-07-02 07:43:13'),(93,6,'2015-07-02 07:43:36'),(94,6,'2015-07-02 07:44:25'),(95,6,'2015-07-02 07:44:34'),(96,6,'2015-07-02 07:44:53'),(97,6,'2015-07-02 07:45:02'),(98,6,'2015-07-02 07:47:18'),(99,6,'2015-07-02 07:47:56'),(100,6,'2015-07-02 07:47:58'),(101,6,'2015-07-02 07:48:10'),(102,6,'2015-07-02 07:48:11'),(103,6,'2015-07-02 07:48:14'),(104,6,'2015-07-02 07:48:14'),(105,6,'2015-07-02 07:48:15'),(106,6,'2015-07-02 07:48:16'),(107,6,'2015-07-02 07:48:20'),(108,6,'2015-07-02 07:48:21'),(109,6,'2015-07-02 07:48:29'),(110,6,'2015-07-02 07:52:01'),(111,6,'2015-07-02 07:52:07'),(112,6,'2015-07-02 07:52:08'),(113,6,'2015-07-02 07:52:11'),(114,6,'2015-07-02 07:52:14'),(115,6,'2015-07-02 07:52:15'),(116,6,'2015-07-02 07:52:17'),(117,6,'2015-07-02 07:57:39'),(118,6,'2015-07-02 07:57:41'),(119,6,'2015-07-02 07:57:42'),(120,6,'2015-07-02 07:57:47'),(121,6,'2015-07-02 07:57:52'),(122,6,'2015-07-02 07:57:55'),(123,6,'2015-07-02 07:57:57'),(124,6,'2015-07-02 07:57:58'),(125,6,'2015-07-02 08:17:48'),(126,6,'2015-07-02 08:17:53'),(127,6,'2015-07-02 08:18:05'),(128,6,'2015-07-02 08:42:13'),(129,6,'2015-07-02 08:43:17'),(130,6,'2015-07-02 08:43:23'),(131,6,'2015-07-02 08:43:23'),(132,6,'2015-07-02 08:43:35'),(133,6,'2015-07-02 08:43:36'),(134,6,'2015-07-02 08:43:42'),(135,6,'2015-07-02 08:45:36'),(136,6,'2015-07-02 08:46:39'),(137,6,'2015-07-02 08:48:23'),(138,6,'2015-07-02 08:49:09'),(139,6,'2015-07-02 08:49:12'),(140,6,'2015-07-02 08:49:13'),(141,6,'2015-07-02 08:50:38'),(142,6,'2015-07-02 08:51:00'),(143,6,'2015-07-02 08:51:09'),(144,6,'2015-07-02 08:51:10'),(145,6,'2015-07-02 08:51:48'),(146,6,'2015-07-02 08:52:01'),(147,6,'2015-07-02 08:52:30'),(148,6,'2015-07-02 08:52:34'),(149,6,'2015-07-02 08:52:35'),(150,6,'2015-07-02 08:52:58'),(151,6,'2015-07-02 08:53:55'),(152,6,'2015-07-02 08:54:00'),(153,6,'2015-07-02 08:54:00'),(154,6,'2015-07-02 08:56:06'),(155,6,'2015-07-02 08:57:18'),(156,6,'2015-07-02 08:57:28'),(157,6,'2015-07-02 09:00:28'),(158,6,'2015-07-02 09:00:34'),(159,6,'2015-07-02 09:00:35'),(160,6,'2015-07-02 09:01:36'),(161,6,'2015-07-02 09:01:41'),(162,6,'2015-07-02 09:01:42'),(163,6,'2015-07-02 09:02:04'),(164,6,'2015-07-02 09:02:39'),(165,6,'2015-07-02 09:02:39'),(166,6,'2015-07-02 09:09:36'),(167,6,'2015-07-02 09:09:36'),(168,6,'2015-07-02 09:09:36'),(169,6,'2015-07-02 09:09:37'),(170,6,'2015-07-02 09:09:43'),(171,6,'2015-07-02 09:10:14'),(172,6,'2015-07-02 09:10:18'),(173,6,'2015-07-02 09:10:22'),(174,6,'2015-07-02 09:10:22'),(175,6,'2015-07-02 09:10:22'),(176,6,'2015-07-02 09:10:22'),(177,6,'2015-07-02 09:10:23'),(178,6,'2015-07-02 09:10:23'),(179,6,'2015-07-02 09:10:28'),(180,6,'2015-07-02 09:10:34'),(181,6,'2015-07-02 09:10:37'),(182,6,'2015-07-02 09:10:40'),(183,6,'2015-07-02 09:10:42'),(184,6,'2015-07-02 09:10:42'),(185,6,'2015-07-02 09:10:42'),(186,6,'2015-07-02 09:11:12'),(187,6,'2015-07-02 09:11:15'),(188,6,'2015-07-02 09:11:16'),(189,6,'2015-07-02 09:11:22'),(190,6,'2015-07-02 09:11:44'),(191,6,'2015-07-02 09:14:01'),(192,6,'2015-07-02 09:14:07'),(193,6,'2015-07-02 09:14:08'),(194,6,'2015-07-02 09:14:40'),(195,6,'2015-07-02 09:17:27'),(196,6,'2015-07-02 09:17:33'),(197,6,'2015-07-02 09:17:34'),(198,6,'2015-07-02 09:20:23'),(199,6,'2015-07-02 09:20:26'),(200,6,'2015-07-02 09:20:27'),(201,6,'2015-07-02 09:20:34'),(202,6,'2015-07-02 09:20:37'),(203,6,'2015-07-02 09:20:38'),(204,6,'2015-07-02 09:21:22'),(205,6,'2015-07-02 09:21:24'),(206,6,'2015-07-02 09:21:25'),(207,6,'2015-07-02 09:21:55'),(208,6,'2015-07-02 09:21:57'),(209,6,'2015-07-02 09:21:58'),(210,6,'2015-07-02 09:23:09'),(211,6,'2015-07-02 09:23:11'),(212,6,'2015-07-02 09:23:11'),(213,6,'2015-07-02 09:23:20'),(214,6,'2015-07-02 09:23:22'),(215,6,'2015-07-02 09:23:23'),(216,6,'2015-07-02 09:25:59'),(217,6,'2015-07-02 09:26:00'),(218,6,'2015-07-02 09:37:32'),(219,6,'2015-07-02 09:37:37'),(220,6,'2015-07-02 09:37:38'),(221,6,'2015-07-02 09:41:35'),(222,6,'2015-07-02 09:41:38'),(223,6,'2015-07-02 09:41:39'),(224,6,'2015-07-02 09:41:55'),(225,6,'2015-07-02 09:41:57'),(226,6,'2015-07-02 09:41:57'),(227,6,'2015-07-02 09:42:56'),(228,6,'2015-07-02 09:43:01'),(229,6,'2015-07-02 09:43:01'),(230,6,'2015-07-02 09:44:25'),(231,6,'2015-07-02 09:44:28'),(232,6,'2015-07-02 09:44:28'),(233,6,'2015-07-02 09:45:00'),(234,6,'2015-07-02 09:45:02'),(235,6,'2015-07-02 09:45:02'),(236,6,'2015-07-02 09:45:32'),(237,6,'2015-07-02 09:45:34'),(238,6,'2015-07-02 09:45:35'),(239,6,'2015-07-02 09:46:41'),(240,6,'2015-07-02 09:46:46'),(241,6,'2015-07-02 09:46:49'),(242,6,'2015-07-02 09:46:51'),(243,6,'2015-07-02 09:46:54'),(244,6,'2015-07-02 09:46:54'),(245,6,'2015-07-02 09:47:01'),(246,6,'2015-07-02 09:47:01'),(247,6,'2015-07-02 09:47:10'),(248,6,'2015-07-02 09:47:13'),(249,6,'2015-07-02 09:47:23'),(250,6,'2015-07-02 09:47:26'),(251,6,'2015-07-02 09:47:26'),(252,6,'2015-07-02 09:47:28'),(253,6,'2015-07-02 09:47:30'),(254,6,'2015-07-02 09:48:47'),(255,6,'2015-07-02 09:48:47'),(256,6,'2015-07-02 09:49:29'),(257,6,'2015-07-02 09:51:45'),(258,6,'2015-07-02 09:53:14'),(259,6,'2015-07-02 09:53:15'),(260,6,'2015-07-02 10:00:04'),(261,6,'2015-07-02 10:00:05'),(262,6,'2015-07-02 10:00:11'),(263,6,'2015-07-02 10:00:13'),(264,6,'2015-07-02 10:00:14'),(265,6,'2015-07-02 10:00:23'),(266,6,'2015-07-02 10:00:30'),(267,6,'2015-07-02 10:00:30'),(268,6,'2015-07-02 10:00:33'),(269,6,'2015-07-02 10:00:38'),(270,6,'2015-07-02 10:00:38'),(271,6,'2015-07-02 10:00:41'),(272,6,'2015-07-02 10:00:43'),(273,6,'2015-07-02 10:00:44'),(274,6,'2015-07-02 10:00:49'),(275,6,'2015-07-02 10:00:49'),(276,6,'2015-07-02 10:00:52'),(277,6,'2015-07-02 10:00:53'),(278,6,'2015-07-02 10:01:24'),(279,6,'2015-07-02 10:07:14'),(280,6,'2015-07-02 10:07:15'),(281,6,'2015-07-02 10:07:24'),(282,7,'2015-07-03 02:03:10'),(283,7,'2015-07-03 02:03:21'),(284,7,'2015-07-03 02:03:32'),(285,7,'2015-07-03 02:03:35'),(286,7,'2015-07-03 02:03:35'),(287,8,'2015-07-03 21:49:25'),(288,8,'2015-07-03 21:49:32'),(289,8,'2015-07-03 21:52:18'),(290,8,'2015-07-03 21:52:48'),(291,8,'2015-07-03 21:54:28'),(292,8,'2015-07-03 21:54:32'),(293,9,'2015-07-03 22:25:04'),(294,9,'2015-07-03 22:25:24'),(295,9,'2015-07-03 22:38:17');
...
DROP TABLE IF EXISTS `shop_log_url_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_log_url_info` (
  `url_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'URL ID',
  `url` varchar(255) DEFAULT NULL COMMENT 'URL',
  `referer` varchar(255) DEFAULT NULL COMMENT 'Referrer',
  PRIMARY KEY (`url_id`)
) ENGINE=InnoDB AUTO_INCREMENT=296 DEFAULT CHARSET=utf8 COMMENT='Log URL Info Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shop_log_url_info` VALUES (1,'http://local.ship.net/index.php/','http://local.ship.net/index.php/install/wizard/end/'),(2,'http://local.ship.net/customer/account/login/','http://local.ship.net/index.php/'),(3,'http://local.ship.net/catalogsearch/ajax/suggest/?q=bot','http://local.ship.net/customer/account/login/'),(4,'http://local.ship.net/catalogsearch/ajax/suggest/?q=botelya','http://local.ship.net/customer/account/login/'),(5,'http://local.ship.net/catalogsearch/result/?q=botelya','http://local.ship.net/customer/account/login/'),(6,'http://local.ship.net/','http://local.ship.net/catalogsearch/result/?q=botelya'),(7,'http://local.ship.net/','http://local.ship.net/catalogsearch/result/?q=botelya'),(8,'http://local.ship.net/catalogsearch/ajax/suggest/?q=botel','http://local.ship.net/'),(9,'http://local.ship.net/catalogsearch/ajax/suggest/?q=botelya','http://local.ship.net/'),(10,'http://local.ship.net/catalogsearch/result/?q=botelya','http://local.ship.net/'),(11,'http://local.ship.net/catalogsearch/ajax/suggest/?q=bote','http://local.ship.net/catalogsearch/result/?q=botelya'),(12,'http://local.ship.net/catalogsearch/result/?q=bote','http://local.ship.net/catalogsearch/result/?q=botelya'),(13,'http://local.ship.net/catalogsearch/ajax/suggest/?q=bit','http://local.ship.net/catalogsearch/result/?q=bote'),(14,'http://local.ship.net/catalogsearch/ajax/suggest/?q=bot','http://local.ship.net/catalogsearch/result/?q=bote'),(15,'http://local.ship.net/catalogsearch/result/?q=bot','http://local.ship.net/catalogsearch/result/?q=bote'),(16,'http://local.ship.net/','http://local.ship.net/catalogsearch/result/?q=bot'),(17,'http://local.ship.net/poll/vote/add/poll_id/1/','http://local.ship.net/'),(18,'http://local.ship.net/','http://local.ship.net/'),(19,'http://local.ship.net/','http://local.ship.net/'),(20,'http://local.ship.net/','http://local.ship.net/'),(21,'http://local.ship.net/',NULL),(22,'http://local.ship.net/catalog/product/view/id/1',NULL),(23,'http://local.ship.net/',NULL),(24,'http://local.ship.net/customer/account/login/','http://local.ship.net/'),(25,'http://local.ship.net/customer/account/create/','http://local.ship.net/customer/account/login/'),(26,'http://local.ship.net/sample-page/?___store=default','http://local.ship.net/index.php/admin/cms_page/index/key/3553439b9968f49615061f0bf6423620/'),(27,'http://local.ship.net/sample-page/?___store=default','http://local.ship.net/index.php/admin/cms_page/index/key/3553439b9968f49615061f0bf6423620/'),(28,'http://local.ship.net/sample-page/?___store=default','http://local.ship.net/index.php/admin/cms_page/index/key/3553439b9968f49615061f0bf6423620/'),(29,'http://local.ship.net/',NULL),(30,'http://local.ship.net/poll/vote/add/poll_id/1/','http://local.ship.net/'),(31,'http://local.ship.net/','http://local.ship.net/'),(32,'http://local.ship.net/',NULL),(33,'http://local.ship.net/',NULL),(34,'http://local.ship.net/',NULL),(35,'http://local.ship.net/',NULL),(36,'http://local.ship.net/',NULL),(37,'http://projshipment.com/',NULL),(38,'http://projshipment.com/',NULL),(39,'http://projshipment.com/',NULL),(40,'http://projshipment.com/',NULL),(41,'http://projshipment.com/',NULL),(42,'http://projshipment.com/',NULL),(43,'http://projshipment.com/',NULL),(44,'http://projshipment.com/',NULL),(45,'http://projshipment.com/',NULL),(46,'http://projshipment.com/',NULL),(47,'http://projshipment.com/',NULL),(48,'http://projshipment.com/',NULL),(49,'http://projshipment.com/',NULL),(50,'http://projshipment.com/',NULL),(51,'http://projshipment.com/',NULL),(52,'http://projshipment.com/',NULL),(53,'http://projshipment.com/',NULL),(54,'http://projshipment.com/customer/account/login/','http://projshipment.com/'),(55,'http://projshipment.com/',NULL),(56,'http://projshipment.com/',NULL),(57,'http://projshipment.com/',NULL),(58,'http://projshipment.com/',NULL),(59,'http://projshipment.com/',NULL),(60,'http://projshipment.com/',NULL),(61,'http://projshipment.com/',NULL),(62,'http://projshipment.com/',NULL),(63,'http://projshipment.com/',NULL),(64,'http://projshipment.com/',NULL),(65,'http://projshipment.com/',NULL),(66,'http://projshipment.com/',NULL),(67,'http://projshipment.com/',NULL),(68,'http://projshipment.com/',NULL),(69,'http://projshipment.com/',NULL),(70,'http://projshipment.com/',NULL),(71,'http://projshipment.com/',NULL),(72,'http://projshipment.com/',NULL),(73,'http://projshipment.com/',NULL),(74,'http://projshipment.com/',NULL),(75,'http://projshipment.com/',NULL),(76,'http://projshipment.com/',NULL),(77,'http://projshipment.com/',NULL),(78,'http://projshipment.com/',NULL),(79,'http://projshipment.com/',NULL),(80,'http://projshipment.com/',NULL),(81,'http://projshipment.com/',NULL),(82,'http://projshipment.com/',NULL),(83,'http://projshipment.com/?mode=list','http://projshipment.com/'),(84,'http://projshipment.com/?mode=grid','http://projshipment.com/?mode=list'),(85,'http://projshipment.com/catalog/product/view/id/1','http://projshipment.com/?mode=grid'),(86,'http://projshipment.com/?mode=grid','http://projshipment.com/?mode=list'),(87,'http://projshipment.com/catalog/product/view/id/1','http://projshipment.com/?mode=grid'),(88,'http://projshipment.com/?mode=grid','http://projshipment.com/?mode=list'),(89,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20vYm90ZWx5YS5odG1sP19fX1NJRD1V/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/botelya.html'),(90,'http://projshipment.com/checkout/cart/','http://projshipment.com/botelya.html'),(91,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(92,'http://projshipment.com/?mode=grid','http://projshipment.com/?mode=list'),(93,'http://projshipment.com/?mode=grid','http://projshipment.com/?mode=list'),(94,'http://projshipment.com/?mode=grid','http://projshipment.com/?mode=list'),(95,'http://projshipment.com/?mode=grid','http://projshipment.com/?mode=list'),(96,'http://projshipment.com/?mode=grid','http://projshipment.com/?mode=list'),(97,'http://projshipment.com/?mode=grid','http://projshipment.com/?mode=list'),(98,'http://projshipment.com/?mode=list','http://projshipment.com/?mode=grid'),(99,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20vP21vZGU9bGlzdA,,/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/?mode=list'),(100,'http://projshipment.com/checkout/cart/','http://projshipment.com/?mode=list'),(101,'http://projshipment.com/checkout/cart/delete/id/2/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20vY2hlY2tvdXQvY2FydC8,/','http://projshipment.com/checkout/cart/'),(102,'http://projshipment.com/checkout/cart/','http://projshipment.com/checkout/cart/'),(103,'http://projshipment.com/checkout/cart/delete/id/1/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20vY2hlY2tvdXQvY2FydC8,/','http://projshipment.com/checkout/cart/'),(104,'http://projshipment.com/checkout/cart/','http://projshipment.com/checkout/cart/'),(105,'http://projshipment.com/checkout/cart/','http://projshipment.com/checkout/cart/'),(106,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(107,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(108,'http://projshipment.com/checkout/cart/','http://projshipment.com/'),(109,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(110,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(111,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(112,'http://projshipment.com/checkout/cart/','http://projshipment.com/'),(113,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(114,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(115,'http://projshipment.com/checkout/cart/','http://projshipment.com/'),(116,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(117,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(118,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(119,'http://projshipment.com/catalog/product/view/id/1','http://projshipment.com/'),(120,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(121,'http://projshipment.com/checkout/cart/ajaxDelete/id/4/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/','http://projshipment.com/'),(122,'http://projshipment.com/checkout/cart/ajaxDelete/id/3/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20vY2hlY2tvdXQvY2FydC9hamF4RGVsZXRlL2lkLzQvdWVuYy9hSFIwY0RvdkwzQnliMnB6YUdsd2JXVnVkQzVqYjIwdi8,/?___SID=U','http://projshipment.com/'),(123,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(124,'http://projshipment.com/','http://projshipment.com/'),(125,'http://projshipment.com/','http://projshipment.com/'),(126,'http://projshipment.com/catalog/product/view/id/1','http://projshipment.com/'),(127,'http://projshipment.com/','http://projshipment.com/'),(128,'http://projshipment.com/','http://projshipment.com/'),(129,'http://projshipment.com/','http://projshipment.com/'),(130,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(131,'http://projshipment.com/','http://projshipment.com/'),(132,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(133,'http://projshipment.com/','http://projshipment.com/'),(134,'http://projshipment.com/checkout/cart/ajaxDelete/id/5/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/','http://projshipment.com/'),(135,'http://projshipment.com/','http://projshipment.com/'),(136,'http://projshipment.com/','http://projshipment.com/'),(137,'http://projshipment.com/','http://projshipment.com/'),(138,'http://projshipment.com/','http://projshipment.com/'),(139,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(140,'http://projshipment.com/','http://projshipment.com/'),(141,'http://projshipment.com/','http://projshipment.com/'),(142,'http://projshipment.com/','http://projshipment.com/'),(143,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(144,'http://projshipment.com/','http://projshipment.com/'),(145,'http://projshipment.com/','http://projshipment.com/'),(146,'http://projshipment.com/','http://projshipment.com/'),(147,'http://projshipment.com/catalog/product/view/id/1','http://projshipment.com/'),(148,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20vYm90ZWx5YS5odG1sP19fX1NJRD1V/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/botelya.html'),(149,'http://projshipment.com/catalog/product/view/id/1','http://projshipment.com/botelya.html'),(150,'http://projshipment.com/checkout/cart/ajaxDelete/id/6/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20vYm90ZWx5YS5odG1s/','http://projshipment.com/botelya.html'),(151,'http://projshipment.com/','http://projshipment.com/'),(152,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(153,'http://projshipment.com/','http://projshipment.com/'),(154,'http://projshipment.com/','http://projshipment.com/'),(155,'http://projshipment.com/','http://projshipment.com/'),(156,'http://projshipment.com/','http://projshipment.com/'),(157,'http://projshipment.com/','http://projshipment.com/'),(158,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(159,'http://projshipment.com/','http://projshipment.com/'),(160,'http://projshipment.com/','http://projshipment.com/'),(161,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(162,'http://projshipment.com/','http://projshipment.com/'),(163,'http://projshipment.com/','http://projshipment.com/'),(164,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(165,'http://projshipment.com/','http://projshipment.com/'),(166,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(167,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(168,'http://projshipment.com/','http://projshipment.com/'),(169,'http://projshipment.com/','http://projshipment.com/'),(170,'http://projshipment.com/','http://projshipment.com/'),(171,'http://projshipment.com/checkout/cart/ajaxDelete/id/8/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/','http://projshipment.com/'),(172,'http://projshipment.com/checkout/cart/ajaxDelete/id/7/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20vY2hlY2tvdXQvY2FydC9hamF4RGVsZXRlL2lkLzgvdWVuYy9hSFIwY0RvdkwzQnliMnB6YUdsd2JXVnVkQzVqYjIwdi8,/?___SID=U','http://projshipment.com/'),(173,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(174,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(175,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(176,'http://projshipment.com/','http://projshipment.com/'),(177,'http://projshipment.com/','http://projshipment.com/'),(178,'http://projshipment.com/','http://projshipment.com/'),(179,'http://projshipment.com/','http://projshipment.com/'),(180,'http://projshipment.com/checkout/cart/ajaxDelete/id/11/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/','http://projshipment.com/'),(181,'http://projshipment.com/checkout/cart/ajaxDelete/id/10/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20vY2hlY2tvdXQvY2FydC9hamF4RGVsZXRlL2lkLzExL3VlbmMvYUhSMGNEb3ZMM0J5YjJwemFHbHdiV1Z1ZEM1amIyMHYv/?___SID=U','http://projshipment.com/'),(182,'http://projshipment.com/checkout/cart/ajaxDelete/id/9/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20vY2hlY2tvdXQvY2FydC9hamF4RGVsZXRlL2lkLzEwL3VlbmMvYUhSMGNEb3ZMM0J5YjJwemFHbHdiV1Z1ZEM1amIyMHZZMmhsWTJ0dmRYUXZZMkZ5ZEM5aGFtRjRSR1ZzWlhSbEwybGtMekV4TDNWbGJtTXZZVWh','http://projshipment.com/'),(183,'http://projshipment.com/','http://projshipment.com/'),(184,'http://projshipment.com/','http://projshipment.com/'),(185,'http://projshipment.com/','http://projshipment.com/'),(186,'http://projshipment.com/','http://projshipment.com/'),(187,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(188,'http://projshipment.com/','http://projshipment.com/'),(189,'http://projshipment.com/','http://projshipment.com/'),(190,'http://projshipment.com/','http://projshipment.com/'),(191,'http://projshipment.com/','http://projshipment.com/'),(192,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(193,'http://projshipment.com/','http://projshipment.com/'),(194,'http://projshipment.com/','http://projshipment.com/'),(195,'http://projshipment.com/','http://projshipment.com/'),(196,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(197,'http://projshipment.com/','http://projshipment.com/'),(198,'http://projshipment.com/','http://projshipment.com/'),(199,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(200,'http://projshipment.com/','http://projshipment.com/'),(201,'http://projshipment.com/','http://projshipment.com/'),(202,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(203,'http://projshipment.com/','http://projshipment.com/'),(204,'http://projshipment.com/','http://projshipment.com/'),(205,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(206,'http://projshipment.com/','http://projshipment.com/'),(207,'http://projshipment.com/','http://projshipment.com/'),(208,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(209,'http://projshipment.com/','http://projshipment.com/'),(210,'http://projshipment.com/','http://projshipment.com/'),(211,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(212,'http://projshipment.com/','http://projshipment.com/'),(213,'http://projshipment.com/','http://projshipment.com/'),(214,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(215,'http://projshipment.com/','http://projshipment.com/'),(216,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(217,'http://projshipment.com/','http://projshipment.com/'),(218,'http://projshipment.com/','http://projshipment.com/'),(219,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(220,'http://projshipment.com/','http://projshipment.com/'),(221,'http://projshipment.com/','http://projshipment.com/'),(222,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(223,'http://projshipment.com/catalog/product/view/id/2','http://projshipment.com/'),(224,'http://projshipment.com/','http://projshipment.com/'),(225,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(226,'http://projshipment.com/catalog/product/view/id/2','http://projshipment.com/'),(227,'http://projshipment.com/','http://projshipment.com/'),(228,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(229,'http://projshipment.com/','http://projshipment.com/'),(230,'http://projshipment.com/','http://projshipment.com/'),(231,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(232,'http://projshipment.com/catalog/product/view/id/2','http://projshipment.com/'),(233,'http://projshipment.com/','http://projshipment.com/'),(234,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(235,'http://projshipment.com/catalog/product/view/id/2','http://projshipment.com/'),(236,'http://projshipment.com/','http://projshipment.com/'),(237,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(238,'http://projshipment.com/catalog/product/view/id/2','http://projshipment.com/'),(239,'http://projshipment.com/','http://projshipment.com/'),(240,'http://projshipment.com/checkout/cart/ajaxDelete/id/13/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/','http://projshipment.com/'),(241,'http://projshipment.com/checkout/cart/ajaxDelete/id/12/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20vY2hlY2tvdXQvY2FydC9hamF4RGVsZXRlL2lkLzEzL3VlbmMvYUhSMGNEb3ZMM0J5YjJwemFHbHdiV1Z1ZEM1amIyMHYv/?___SID=U','http://projshipment.com/'),(242,'http://projshipment.com/','http://projshipment.com/'),(243,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(244,'http://projshipment.com/','http://projshipment.com/'),(245,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(246,'http://projshipment.com/','http://projshipment.com/'),(247,'http://projshipment.com/checkout/cart/','http://projshipment.com/'),(248,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(249,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(250,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(251,'http://projshipment.com/','http://projshipment.com/'),(252,'http://projshipment.com/checkout/cart/','http://projshipment.com/'),(253,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(254,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(255,'http://projshipment.com/','http://projshipment.com/'),(256,'http://projshipment.com/checkout/cart/','http://projshipment.com/'),(257,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(258,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(259,'http://projshipment.com/','http://projshipment.com/'),(260,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(261,'http://projshipment.com/catalog/product/view/id/1','http://projshipment.com/'),(262,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(263,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(264,'http://projshipment.com/catalog/product/view/id/1','http://projshipment.com/'),(265,'http://projshipment.com/','http://projshipment.com/'),(266,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(267,'http://projshipment.com/catalog/product/view/id/1','http://projshipment.com/'),(268,'http://projshipment.com/checkout/cart/','http://projshipment.com/'),(269,'http://projshipment.com/checkout/cart/delete/id/14/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20vY2hlY2tvdXQvY2FydC8,/','http://projshipment.com/checkout/cart/'),(270,'http://projshipment.com/checkout/cart/','http://projshipment.com/checkout/cart/'),(271,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(272,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(273,'http://projshipment.com/','http://projshipment.com/'),(274,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(275,'http://projshipment.com/','http://projshipment.com/'),(276,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/2/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(277,'http://projshipment.com/','http://projshipment.com/'),(278,'http://projshipment.com/checkout/cart/','http://projshipment.com/'),(279,'http://projshipment.com/checkout/cart/add/uenc/aHR0cDovL3Byb2pzaGlwbWVudC5jb20v/product/1/form_key/A1zpV3UjfDxoFfr5/','http://projshipment.com/'),(280,'http://projshipment.com/','http://projshipment.com/'),(281,'http://projshipment.com/checkout/cart/','http://projshipment.com/'),(282,'http://projshipment.com/','http://projshipment.com/checkout/cart/'),(283,'http://projshipment.com/?mode=list','http://projshipment.com/'),(284,'http://projshipment.com/?mode=grid','http://projshipment.com/?mode=list'),(285,'http://projshipment.com/',NULL),(286,'http://projshipment.com/',NULL),(287,'http://projshipment.com/',NULL),(288,'http://projshipment.com/?mode=list','http://projshipment.com/'),(289,'http://projshipment.com/?mode=list','http://projshipment.com/'),(290,'http://projshipment.com/?mode=list','http://projshipment.com/'),(291,'http://projshipment.com/?mode=list','http://projshipment.com/'),(292,'http://projshipment.com/catalog/product/view/id/2','http://projshipment.com/?mode=list'),(293,'http://projshipment.com/',NULL),(294,'http://projshipment.com/?mode=list','http://projshipment.com/'),(295,'http://projshipment.com/',NULL);
...
DROP TABLE IF EXISTS `shop_log_visitor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_log_visitor` (
...
INSERT INTO `shop_log_visitor` VALUES (1,'gh0omlicol9nf2dt1hrb1k4531','2015-07-01 04:31:09','2015-07-01 04:39:22',22,1),(2,'cej0ip0tdut59tui0oji5tp490','2015-07-01 04:49:35','2015-07-01 05:37:33',31,1),(3,'ddo7fhtipsjfq12i9uncl395c3','2015-07-01 07:12:11','2015-07-01 07:12:11',32,1),(4,'q01372p5jje2uvt73acm02sfa5','2015-07-01 07:19:42','2015-07-01 07:22:50',36,1),(5,'mqtr4iss457qhn1bffbstj2st4','2015-07-02 05:25:00','2015-07-02 05:25:01',37,1),(6,'mqtr4iss457qhn1bffbstj2st4','2015-07-02 05:25:01','2015-07-02 10:07:24',281,1),(7,'rhfsphal30nnhvtqb5k6cep7o6','2015-07-03 02:03:07','2015-07-03 02:03:35',286,1),(8,'ce1d7b66jlq60u1dn6k0m6thr2','2015-07-03 21:49:18','2015-07-03 21:54:32',292,1),(9,'3fqbd2jd5m4l34mgho7b39j5f6','2015-07-03 22:25:01','2015-07-03 22:38:17',295,1);
...
DROP TABLE IF EXISTS `shop_log_visitor_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_log_visitor_info` (
...
INSERT INTO `shop_log_visitor_info` VALUES (1,'http://local.ship.net/index.php/install/wizard/end/','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/600.6.3 (KHTML, like Gecko) Version/8.0.6 Safari/600.6.3',NULL,'en-us',2130706433,2130706433),(2,NULL,'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36',NULL,'en-US,en;q=0.8',3232300551,3232300546),(3,NULL,'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/600.6.3 (KHTML, like Gecko) Version/8.0.6 Safari/600.6.3',NULL,'en-us',2130706433,2130706433),(4,NULL,'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36',NULL,'en-US,en;q=0.8',3232300551,3232300546),(5,NULL,'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36',NULL,'en-US,en;q=0.8',2130706433,2130706433),(6,NULL,'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36',NULL,'en-US,en;q=0.8',2130706433,2130706433),(7,'http://projshipment.com/checkout/cart/','Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36',NULL,'en-US,en;q=0.8',2130706433,2130706433),(8,NULL,'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36',NULL,'en-US,en;q=0.8',2130706433,2130706433),(9,NULL,'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.130 Safari/537.36',NULL,'en-US,en;q=0.8',2130706433,2130706433);
...
DROP TABLE IF EXISTS `shop_log_visitor_online`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_log_visitor_online` (
  `visitor_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Visitor ID',
  ...
  PRIMARY KEY (`visitor_id`),
  KEY `IDX_SHOP_LOG_VISITOR_ONLINE_VISITOR_TYPE` (`visitor_type`),
  KEY `IDX_SHOP_LOG_VISITOR_ONLINE_FIRST_VISIT_AT_LAST_VISIT_AT` (`first_visit_at`,`last_visit_at`),
  KEY `IDX_SHOP_LOG_VISITOR_ONLINE_CUSTOMER_ID` (`customer_id`)
...
DROP TABLE IF EXISTS `shop_newsletter_problem`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_newsletter_problem` (
  ...
  KEY `IDX_SHOP_NEWSLETTER_PROBLEM_SUBSCRIBER_ID` (`subscriber_id`),
  KEY `IDX_SHOP_NEWSLETTER_PROBLEM_QUEUE_ID` (`queue_id`),
  CONSTRAINT `FK_0383B2203E73861C51DB3C4D6640405A` FOREIGN KEY (`subscriber_id`) REFERENCES `shop_newsletter_subscriber` (`subscriber_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_newsletter_queue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_newsletter_queue` (
  ...
  KEY `IDX_SHOP_NEWSLETTER_QUEUE_TEMPLATE_ID` (`template_id`),
  CONSTRAINT `FK_SHOP_NLTTR_QUEUE_TEMPLATE_ID_SHOP_NLTTR_TEMPLATE_TEMPLATE_ID` FOREIGN KEY (`template_id`) REFERENCES `shop_newsletter_template` (`template_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_newsletter_queue_link`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_newsletter_queue_link` (
  `queue_link_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Queue Link Id',
  `queue_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Queue Id',
  `subscriber_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Subscriber Id',
  `letter_sent_at` timestamp NULL DEFAULT NULL COMMENT 'Letter Sent At',
  PRIMARY KEY (`queue_link_id`),
  KEY `IDX_SHOP_NEWSLETTER_QUEUE_LINK_SUBSCRIBER_ID` (`subscriber_id`),
  KEY `IDX_SHOP_NEWSLETTER_QUEUE_LINK_QUEUE_ID` (`queue_id`),
  KEY `IDX_SHOP_NEWSLETTER_QUEUE_LINK_QUEUE_ID_LETTER_SENT_AT` (`queue_id`,`letter_sent_at`),
  CONSTRAINT `FK_555168DEEE01C1A68FCEA61C936789D3` FOREIGN KEY (`subscriber_id`) REFERENCES `shop_newsletter_subscriber` (`subscriber_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_NLTTR_QUEUE_LNK_QUEUE_ID_SHOP_NLTTR_QUEUE_QUEUE_ID` FOREIGN KEY (`queue_id`) REFERENCES `shop_newsletter_queue` (`queue_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_newsletter_queue_store_link`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_newsletter_queue_store_link` (
  `queue_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Queue Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store Id',
  PRIMARY KEY (`queue_id`,`store_id`),
  KEY `IDX_SHOP_NEWSLETTER_QUEUE_STORE_LINK_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_NLTTR_QUEUE_STORE_LNK_QUEUE_ID_SHOP_NLTTR_QUEUE_QUEUE_ID` FOREIGN KEY (`queue_id`) REFERENCES `shop_newsletter_queue` (`queue_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_newsletter_subscriber`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_newsletter_subscriber` (
  ...
  KEY `IDX_SHOP_NEWSLETTER_SUBSCRIBER_CUSTOMER_ID` (`customer_id`),
  KEY `IDX_SHOP_NEWSLETTER_SUBSCRIBER_STORE_ID` (`store_id`),
...
DROP TABLE IF EXISTS `shop_newsletter_template`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_newsletter_template` (
  `template_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Template Id',
  ...
  PRIMARY KEY (`template_id`),
  KEY `IDX_SHOP_NEWSLETTER_TEMPLATE_TEMPLATE_ACTUAL` (`template_actual`),
  KEY `IDX_SHOP_NEWSLETTER_TEMPLATE_ADDED_AT` (`added_at`),
  KEY `IDX_SHOP_NEWSLETTER_TEMPLATE_MODIFIED_AT` (`modified_at`)
...
DROP TABLE IF EXISTS `shop_oauth_consumer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_oauth_consumer` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created At',
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'Updated At',
  ...
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `UNQ_SHOP_SHOP_OAUTH_CONSUMER_KEY` (`key`),
  UNIQUE KEY `UNQ_SHOP_SHOP_OAUTH_CONSUMER_SECRET` (`secret`),
  KEY `IDX_SHOP_OAUTH_CONSUMER_CREATED_AT` (`created_at`),
  KEY `IDX_SHOP_OAUTH_CONSUMER_UPDATED_AT` (`updated_at`)
...
DROP TABLE IF EXISTS `shop_oauth_nonce`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_oauth_nonce` (
...
DROP TABLE IF EXISTS `shop_oauth_token`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_oauth_token` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity ID',
  ...
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `UNQ_SHOP_SHOP_OAUTH_TOKEN_TOKEN` (`token`),
  KEY `IDX_SHOP_SHOP_OAUTH_TOKEN_CONSUMER_ID` (`consumer_id`),
  KEY `FK_SHOP_OAUTH_TOKEN_ADMIN_ID_SHOP_SHOP_ADMIN_USER_USER_ID` (`admin_id`),
  KEY `FK_SHOP_OAUTH_TOKEN_CSTR_ID_SHOP_SHOP_CSTR_ENTT_ENTT_ID` (`customer_id`),
  CONSTRAINT `FK_SHOP_OAUTH_TOKEN_ADMIN_ID_SHOP_SHOP_ADMIN_USER_USER_ID` FOREIGN KEY (`admin_id`) REFERENCES `shop_admin_user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_OAUTH_TOKEN_CONSUMER_ID_SHOP_OAUTH_CONSUMER_ENTITY_ID` FOREIGN KEY (`consumer_id`) REFERENCES `shop_oauth_consumer` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_OAUTH_TOKEN_CSTR_ID_SHOP_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_paypal_cert`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_paypal_cert` (
  `cert_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Cert Id',
  `website_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Website Id',
  `content` text COMMENT 'Content',
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'Updated At',
  PRIMARY KEY (`cert_id`),
  KEY `IDX_SHOP_PAYPAL_CERT_WEBSITE_ID` (`website_id`),
...
DROP TABLE IF EXISTS `shop_paypal_payment_transaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_paypal_payment_transaction` (
  `transaction_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `txn_id` varchar(100) DEFAULT NULL COMMENT 'Txn Id',
  `additional_information` blob COMMENT 'Additional Information',
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'Created At',
  PRIMARY KEY (`transaction_id`),
  UNIQUE KEY `UNQ_SHOP_PAYPAL_PAYMENT_TRANSACTION_TXN_ID` (`txn_id`)
...
DROP TABLE IF EXISTS `shop_paypal_settlement_report`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_paypal_settlement_report` (
...
DROP TABLE IF EXISTS `shop_paypal_settlement_report_row`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_paypal_settlement_report_row` (
  ...
  PRIMARY KEY (`row_id`),
  KEY `IDX_SHOP_PAYPAL_SETTLEMENT_REPORT_ROW_REPORT_ID` (`report_id`),
  CONSTRAINT `FK_27A2A55847B8B17BF0B83BBCBF053BAB` FOREIGN KEY (`report_id`) REFERENCES `shop_paypal_settlement_report` (`report_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_persistent_session`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_persistent_session` (
  ...
  UNIQUE KEY `IDX_SHOP_PERSISTENT_SESSION_KEY` (`key`),
  UNIQUE KEY `IDX_SHOP_PERSISTENT_SESSION_CUSTOMER_ID` (`customer_id`),
  KEY `IDX_SHOP_PERSISTENT_SESSION_UPDATED_AT` (`updated_at`),
  KEY `FK_SHOP_PERSISTENT_SESS_WS_ID_SHOP_CORE_WS_WS_ID` (`website_id`),
  CONSTRAINT `FK_SHOP_PERSISTENT_SESS_CSTR_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
DROP TABLE IF EXISTS `shop_poll`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_poll` (
  ...
  PRIMARY KEY (`poll_id`),
  KEY `IDX_SHOP_POLL_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_POLL_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_poll_answer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_poll_answer` (
  ...
  KEY `IDX_SHOP_POLL_ANSWER_POLL_ID` (`poll_id`),
  CONSTRAINT `FK_SHOP_POLL_ANSWER_POLL_ID_SHOP_POLL_POLL_ID` FOREIGN KEY (`poll_id`) REFERENCES `shop_poll` (`poll_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_poll_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_poll_store` (
  `poll_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Poll Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store id',
  PRIMARY KEY (`poll_id`,`store_id`),
  KEY `IDX_SHOP_POLL_STORE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_POLL_STORE_POLL_ID_SHOP_POLL_POLL_ID` FOREIGN KEY (`poll_id`) REFERENCES `shop_poll` (`poll_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_poll_vote`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_poll_vote` (
  ...
  PRIMARY KEY (`vote_id`),
  KEY `IDX_SHOP_POLL_VOTE_POLL_ANSWER_ID` (`poll_answer_id`),
...
DROP TABLE IF EXISTS `shop_product_alert_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_product_alert_price` (
  ...
  KEY `IDX_SHOP_PRODUCT_ALERT_PRICE_CUSTOMER_ID` (`customer_id`),
  KEY `IDX_SHOP_PRODUCT_ALERT_PRICE_PRODUCT_ID` (`product_id`),
  KEY `IDX_SHOP_PRODUCT_ALERT_PRICE_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_SHOP_PRD_ALERT_PRICE_CSTR_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_PRD_ALERT_PRICE_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_PRD_ALERT_PRICE_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_product_alert_stock`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_product_alert_stock` (
  ...
  KEY `IDX_SHOP_PRODUCT_ALERT_STOCK_CUSTOMER_ID` (`customer_id`),
  KEY `IDX_SHOP_PRODUCT_ALERT_STOCK_PRODUCT_ID` (`product_id`),
  KEY `IDX_SHOP_PRODUCT_ALERT_STOCK_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_SHOP_PRD_ALERT_STOCK_CSTR_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_PRD_ALERT_STOCK_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_PRD_ALERT_STOCK_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `shop_rating` (
  ...
  UNIQUE KEY `UNQ_SHOP_RATING_RATING_CODE` (`rating_code`),
  KEY `IDX_SHOP_RATING_ENTITY_ID` (`entity_id`),
  CONSTRAINT `FK_SHOP_RATING_ENTITY_ID_SHOP_RATING_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_rating_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_rating_entity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_rating_entity` (
...
DROP TABLE IF EXISTS `shop_rating_option`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_rating_option` (
  ...
  PRIMARY KEY (`option_id`),
  KEY `IDX_SHOP_RATING_OPTION_RATING_ID` (`rating_id`),
...
DROP TABLE IF EXISTS `shop_rating_option_vote`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_rating_option_vote` (
  ...
  PRIMARY KEY (`vote_id`),
  KEY `IDX_SHOP_RATING_OPTION_VOTE_OPTION_ID` (`option_id`),
  KEY `FK_SHOP_RATING_OPTION_VOTE_REVIEW_ID_SHOP_REVIEW_REVIEW_ID` (`review_id`),
  CONSTRAINT `FK_SHOP_RATING_OPTION_VOTE_REVIEW_ID_SHOP_REVIEW_REVIEW_ID` FOREIGN KEY (`review_id`) REFERENCES `shop_review` (`review_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_RATING_OPT_VOTE_OPT_ID_SHOP_RATING_OPT_OPT_ID` FOREIGN KEY (`option_id`) REFERENCES `shop_rating_option` (`option_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_rating_option_vote_aggregated`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_rating_option_vote_aggregated` (
  ...
  KEY `IDX_SHOP_RATING_OPTION_VOTE_AGGREGATED_RATING_ID` (`rating_id`),
  KEY `IDX_SHOP_RATING_OPTION_VOTE_AGGREGATED_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_RATING_OPT_VOTE_AGGRED_RATING_ID_SHOP_RATING_RATING_ID` FOREIGN KEY (`rating_id`) REFERENCES `shop_rating` (`rating_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_RATING_OPT_VOTE_AGGRED_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_rating_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_rating_store` (
  `rating_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Rating id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store id',
  PRIMARY KEY (`rating_id`,`store_id`),
  KEY `IDX_SHOP_RATING_STORE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_RATING_STORE_RATING_ID_SHOP_RATING_RATING_ID` FOREIGN KEY (`rating_id`) REFERENCES `shop_rating` (`rating_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
DROP TABLE IF EXISTS `shop_rating_title`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_rating_title` (
  `rating_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Rating Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store Id',
  `value` varchar(255) NOT NULL COMMENT 'Rating Label',
  PRIMARY KEY (`rating_id`,`store_id`),
  KEY `IDX_SHOP_RATING_TITLE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_RATING_TITLE_RATING_ID_SHOP_RATING_RATING_ID` FOREIGN KEY (`rating_id`) REFERENCES `shop_rating` (`rating_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_report_compared_product_index`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_report_compared_product_index` (
  ...
  UNIQUE KEY `UNQ_SHOP_REPORT_COMPARED_PRODUCT_INDEX_VISITOR_ID_PRODUCT_ID` (`visitor_id`,`product_id`),
  UNIQUE KEY `UNQ_SHOP_REPORT_COMPARED_PRODUCT_INDEX_CUSTOMER_ID_PRODUCT_ID` (`customer_id`,`product_id`),
  KEY `IDX_SHOP_REPORT_COMPARED_PRODUCT_INDEX_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_REPORT_COMPARED_PRODUCT_INDEX_ADDED_AT` (`added_at`),
  KEY `IDX_SHOP_REPORT_COMPARED_PRODUCT_INDEX_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_SHOP_REPORT_CMPD_PRD_IDX_CSTR_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_REPORT_CMPD_PRD_IDX_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_REPORT_CMPD_PRD_IDX_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_report_event`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_report_event` (
  `event_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Event Id',
  ...
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store Id',
  PRIMARY KEY (`event_id`),
  KEY `IDX_SHOP_REPORT_EVENT_EVENT_TYPE_ID` (`event_type_id`),
  KEY `IDX_SHOP_REPORT_EVENT_SUBJECT_ID` (`subject_id`),
  KEY `IDX_SHOP_REPORT_EVENT_OBJECT_ID` (`object_id`),
  KEY `IDX_SHOP_REPORT_EVENT_SUBTYPE` (`subtype`),
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='Reports Event Table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shop_report_event` VALUES (1,'2015-07-01 04:39:22',1,1,1,1,1),(2,'2015-07-02 07:28:39',1,1,6,1,1),(3,'2015-07-02 07:29:07',1,1,6,1,1),(4,'2015-07-02 07:35:13',4,1,6,1,1),(5,'2015-07-02 07:47:56',4,2,6,1,1),(6,'2015-07-02 07:48:20',4,2,6,1,1),(7,'2015-07-02 07:52:07',4,1,6,1,1),(8,'2015-07-02 07:57:42',1,1,6,1,1),(9,'2015-07-02 07:57:57',4,1,6,1,1),(10,'2015-07-02 08:17:53',1,1,6,1,1),(11,'2015-07-02 08:18:08',1,1,6,1,1),(12,'2015-07-02 08:49:12',4,1,6,1,1),(13,'2015-07-02 08:52:04',1,1,6,1,1),(14,'2015-07-02 08:52:29',1,1,6,1,1),(15,'2015-07-02 08:52:34',1,1,6,1,1),(16,'2015-07-02 08:53:59',4,1,6,1,1),(17,'2015-07-02 09:02:38',4,2,6,1,1),(18,'2015-07-02 09:10:22',4,1,6,1,1),(19,'2015-07-02 09:10:22',4,1,6,1,1),(20,'2015-07-02 09:10:22',4,1,6,1,1),(21,'2015-07-02 09:11:15',4,2,6,1,1),(22,'2015-07-02 09:25:59',4,1,6,1,1),(23,'2015-07-02 09:41:38',1,2,6,1,1),(24,'2015-07-02 09:41:57',1,2,6,1,1),(25,'2015-07-02 09:44:28',1,2,6,1,1),(26,'2015-07-02 09:45:02',1,2,6,1,1),(27,'2015-07-02 09:45:34',1,2,6,1,1),(28,'2015-07-02 09:46:54',4,1,6,1,1),(29,'2015-07-02 10:00:05',1,1,6,1,1),(30,'2015-07-02 10:00:13',1,1,6,1,1),(31,'2015-07-02 10:00:30',1,1,6,1,1),(32,'2015-07-02 10:00:43',4,1,6,1,1),(33,'2015-07-02 10:00:52',4,2,6,1,1),(34,'2015-07-03 21:54:31',1,2,8,1,1);
...
DROP TABLE IF EXISTS `shop_report_event_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_report_event_types` (
...
DROP TABLE IF EXISTS `shop_report_viewed_product_aggregated_daily`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_report_viewed_product_aggregated_daily` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_REPORT_VIEWED_PRD_AGGRED_DAILY_PERIOD_STORE_ID_PRD_ID` (`period`,`store_id`,`product_id`),
  KEY `IDX_SHOP_REPORT_VIEWED_PRODUCT_AGGREGATED_DAILY_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_REPORT_VIEWED_PRODUCT_AGGREGATED_DAILY_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_B486B60CFAE3E6239EB7015840EBC1DB` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_FB21701FC51E43A6FB8084D119746763` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_report_viewed_product_aggregated_monthly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_report_viewed_product_aggregated_monthly` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `product_id` int(10) unsigned DEFAULT NULL COMMENT 'Product Id',
  ...
  `rating_pos` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Rating Pos',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_REPORT_VIEWED_PRD_AGGRED_MONTHLY_PERIOD_STORE_ID_PRD_ID` (`period`,`store_id`,`product_id`),
  KEY `IDX_SHOP_REPORT_VIEWED_PRODUCT_AGGREGATED_MONTHLY_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_REPORT_VIEWED_PRODUCT_AGGREGATED_MONTHLY_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_8FA6452357B1319271841CEF00C98F27` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_report_viewed_product_aggregated_yearly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_report_viewed_product_aggregated_yearly` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `product_id` int(10) unsigned DEFAULT NULL COMMENT 'Product Id',
  ...
  `rating_pos` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Rating Pos',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_REPORT_VIEWED_PRD_AGGRED_YEARLY_PERIOD_STORE_ID_PRD_ID` (`period`,`store_id`,`product_id`),
  KEY `IDX_SHOP_REPORT_VIEWED_PRODUCT_AGGREGATED_YEARLY_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_REPORT_VIEWED_PRODUCT_AGGREGATED_YEARLY_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_161DB788FE705E2299B44DA9839959D3` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_529B6FFE5E5D59846C68415005384329` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_report_viewed_product_index`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_report_viewed_product_index` (
  `index_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Index Id',
  `visitor_id` int(10) unsigned DEFAULT NULL COMMENT 'Visitor Id',
  `customer_id` int(10) unsigned DEFAULT NULL COMMENT 'Customer Id',
  `product_id` int(10) unsigned NOT NULL COMMENT 'Product Id',
  ...
  `added_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Added At',
  PRIMARY KEY (`index_id`),
  UNIQUE KEY `UNQ_SHOP_REPORT_VIEWED_PRODUCT_INDEX_VISITOR_ID_PRODUCT_ID` (`visitor_id`,`product_id`),
  UNIQUE KEY `UNQ_SHOP_REPORT_VIEWED_PRODUCT_INDEX_CUSTOMER_ID_PRODUCT_ID` (`customer_id`,`product_id`),
  KEY `IDX_SHOP_REPORT_VIEWED_PRODUCT_INDEX_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_REPORT_VIEWED_PRODUCT_INDEX_ADDED_AT` (`added_at`),
  KEY `IDX_SHOP_REPORT_VIEWED_PRODUCT_INDEX_PRODUCT_ID` (`product_id`),
...
INSERT INTO `shop_report_viewed_product_index` VALUES (1,1,NULL,1,1,'2015-07-01 04:39:22'),(2,6,NULL,1,1,'2015-07-02 10:00:30'),(10,6,NULL,2,1,'2015-07-02 09:45:34'),(11,8,NULL,2,1,'2015-07-03 21:54:31');
...
CREATE TABLE `shop_review` (
  ...
  KEY `IDX_SHOP_REVIEW_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_REVIEW_STATUS_ID` (`status_id`),
  KEY `IDX_SHOP_REVIEW_ENTITY_PK_VALUE` (`entity_pk_value`),
  CONSTRAINT `FK_SHOP_REVIEW_ENTITY_ID_SHOP_REVIEW_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_review_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `shop_review_detail` (
  ...
  KEY `IDX_SHOP_REVIEW_DETAIL_REVIEW_ID` (`review_id`),
  KEY `IDX_SHOP_REVIEW_DETAIL_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_REVIEW_DETAIL_CUSTOMER_ID` (`customer_id`),
  CONSTRAINT `FK_SHOP_REVIEW_DETAIL_CUSTOMER_ID_SHOP_CUSTOMER_ENTITY_ENTITY_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_REVIEW_DETAIL_REVIEW_ID_SHOP_REVIEW_REVIEW_ID` FOREIGN KEY (`review_id`) REFERENCES `shop_review` (`review_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_REVIEW_DETAIL_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_review_entity`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_review_entity` (
...
DROP TABLE IF EXISTS `shop_review_entity_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_review_entity_summary` (
  ...
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store id',
  PRIMARY KEY (`primary_id`),
  KEY `IDX_SHOP_REVIEW_ENTITY_SUMMARY_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_REVIEW_ENTITY_SUMMARY_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_review_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_review_status` (
...
DROP TABLE IF EXISTS `shop_review_store`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_review_store` (
  `review_id` bigint(20) unsigned NOT NULL COMMENT 'Review Id',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store Id',
  PRIMARY KEY (`review_id`,`store_id`),
  KEY `IDX_SHOP_REVIEW_STORE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_REVIEW_STORE_REVIEW_ID_SHOP_REVIEW_REVIEW_ID` FOREIGN KEY (`review_id`) REFERENCES `shop_review` (`review_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_sales_bestsellers_aggregated_daily`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_bestsellers_aggregated_daily` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `product_id` int(10) unsigned DEFAULT NULL COMMENT 'Product Id',
  ...
  `rating_pos` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Rating Pos',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_SALES_BESTSELLERS_AGGRED_DAILY_PERIOD_STORE_ID_PRD_ID` (`period`,`store_id`,`product_id`),
  KEY `IDX_SHOP_SALES_BESTSELLERS_AGGREGATED_DAILY_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SALES_BESTSELLERS_AGGREGATED_DAILY_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_D715B8EEAAF380AE122FAA62A65CC620` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_ED17763844EDBCDFD886B6044382D27B` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_bestsellers_aggregated_monthly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_bestsellers_aggregated_monthly` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `product_id` int(10) unsigned DEFAULT NULL COMMENT 'Product Id',
  ...
  `rating_pos` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Rating Pos',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_SALES_BESTSELLERS_AGGRED_MONTHLY_PERIOD_STORE_ID_PRD_ID` (`period`,`store_id`,`product_id`),
  KEY `IDX_SHOP_SALES_BESTSELLERS_AGGREGATED_MONTHLY_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SALES_BESTSELLERS_AGGREGATED_MONTHLY_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_4C1BEDAB591B13A7F17850EC91D6CC6B` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_sales_bestsellers_aggregated_yearly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_bestsellers_aggregated_yearly` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `product_id` int(10) unsigned DEFAULT NULL COMMENT 'Product Id',
  ...
  `rating_pos` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Rating Pos',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_SALES_BESTSELLERS_AGGRED_YEARLY_PERIOD_STORE_ID_PRD_ID` (`period`,`store_id`,`product_id`),
  KEY `IDX_SHOP_SALES_BESTSELLERS_AGGREGATED_YEARLY_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SALES_BESTSELLERS_AGGREGATED_YEARLY_PRODUCT_ID` (`product_id`),
  CONSTRAINT `FK_8C1A702B8BCBBEB0A99D1F39FA7DBF41` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_A2E219DC1526C3E4CE00399702F57368` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_billing_agreement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_billing_agreement` (
  `agreement_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Agreement Id',
  ...
  PRIMARY KEY (`agreement_id`),
  KEY `IDX_SHOP_SALES_BILLING_AGREEMENT_CUSTOMER_ID` (`customer_id`),
  KEY `IDX_SHOP_SALES_BILLING_AGREEMENT_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_SALES_BILLING_AGRT_CSTR_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_SALES_BILLING_AGRT_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_billing_agreement_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_billing_agreement_order` (
  `agreement_id` int(10) unsigned NOT NULL COMMENT 'Agreement Id',
  `order_id` int(10) unsigned NOT NULL COMMENT 'Order Id',
  PRIMARY KEY (`agreement_id`,`order_id`),
  KEY `IDX_SHOP_SALES_BILLING_AGREEMENT_ORDER_ORDER_ID` (`order_id`),
  CONSTRAINT `FK_0AA3C46F5303F368C18A7210529DA8FE` FOREIGN KEY (`agreement_id`) REFERENCES `shop_sales_billing_agreement` (`agreement_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_sales_flat_creditmemo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_creditmemo` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  ...
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `UNQ_SHOP_SALES_FLAT_CREDITMEMO_INCREMENT_ID` (`increment_id`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_ORDER_ID` (`order_id`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_CREDITMEMO_STATUS` (`creditmemo_status`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_STATE` (`state`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_CREATED_AT` (`created_at`),
  CONSTRAINT `FK_D917D9D50674364AA92BCD991A7B6ED1` FOREIGN KEY (`order_id`) REFERENCES `shop_sales_flat_order` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_SALES_FLAT_CREDITMEMO_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_flat_creditmemo_comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_creditmemo_comment` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent Id',
  ...
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'Created At',
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_COMMENT_CREATED_AT` (`created_at`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_COMMENT_PARENT_ID` (`parent_id`),
...
DROP TABLE IF EXISTS `shop_sales_flat_creditmemo_grid`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_creditmemo_grid` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity Id',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `store_to_order_rate` decimal(12,4) DEFAULT NULL COMMENT 'Store To Order Rate',
  `base_to_order_rate` decimal(12,4) DEFAULT NULL COMMENT 'Base To Order Rate',
  ...
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `UNQ_SHOP_SALES_FLAT_CREDITMEMO_GRID_INCREMENT_ID` (`increment_id`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_GRID_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_GRID_GRAND_TOTAL` (`grand_total`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_GRID_BASE_GRAND_TOTAL` (`base_grand_total`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_GRID_ORDER_ID` (`order_id`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_GRID_CREDITMEMO_STATUS` (`creditmemo_status`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_GRID_STATE` (`state`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_GRID_ORDER_INCREMENT_ID` (`order_increment_id`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_GRID_CREATED_AT` (`created_at`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_GRID_ORDER_CREATED_AT` (`order_created_at`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_GRID_BILLING_NAME` (`billing_name`),
  CONSTRAINT `FK_376210F6BD44881027712E62D88B0E89` FOREIGN KEY (`entity_id`) REFERENCES `shop_sales_flat_creditmemo` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_D923D24C162FF579D9092BC8DB2F24E8` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_flat_creditmemo_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_creditmemo_item` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent Id',
  ...
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_SALES_FLAT_CREDITMEMO_ITEM_PARENT_ID` (`parent_id`),
...
DROP TABLE IF EXISTS `shop_sales_flat_invoice`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_invoice` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `base_grand_total` decimal(12,4) DEFAULT NULL COMMENT 'Base Grand Total',
  `shipping_tax_amount` decimal(12,4) DEFAULT NULL COMMENT 'Shipping Tax Amount',
  ...
  `discount_description` varchar(255) DEFAULT NULL COMMENT 'Discount Description',
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `UNQ_SHOP_SALES_FLAT_INVOICE_INCREMENT_ID` (`increment_id`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_GRAND_TOTAL` (`grand_total`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_ORDER_ID` (`order_id`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_STATE` (`state`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_CREATED_AT` (`created_at`),
  CONSTRAINT `FK_2C530F9E7DB5949F9542307AA763D466` FOREIGN KEY (`order_id`) REFERENCES `shop_sales_flat_order` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_SALES_FLAT_INVOICE_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_flat_invoice_comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_invoice_comment` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent Id',
  ...
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'Created At',
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_COMMENT_CREATED_AT` (`created_at`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_COMMENT_PARENT_ID` (`parent_id`),
...
DROP TABLE IF EXISTS `shop_sales_flat_invoice_grid`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_invoice_grid` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity Id',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `base_grand_total` decimal(12,4) DEFAULT NULL COMMENT 'Base Grand Total',
  `grand_total` decimal(12,4) DEFAULT NULL COMMENT 'Grand Total',
  ...
  `billing_name` varchar(255) DEFAULT NULL COMMENT 'Billing Name',
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `UNQ_SHOP_SALES_FLAT_INVOICE_GRID_INCREMENT_ID` (`increment_id`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_GRID_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_GRID_GRAND_TOTAL` (`grand_total`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_GRID_ORDER_ID` (`order_id`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_GRID_STATE` (`state`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_GRID_ORDER_INCREMENT_ID` (`order_increment_id`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_GRID_CREATED_AT` (`created_at`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_GRID_ORDER_CREATED_AT` (`order_created_at`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_GRID_BILLING_NAME` (`billing_name`),
  CONSTRAINT `FK_8139F215B6F0F96E4791A3C8E847BE2E` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_sales_flat_invoice_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_invoice_item` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent Id',
  `base_price` decimal(12,4) DEFAULT NULL COMMENT 'Base Price',
  `tax_amount` decimal(12,4) DEFAULT NULL COMMENT 'Tax Amount',
  ...
  `base_weee_tax_row_disposition` decimal(12,4) DEFAULT NULL COMMENT 'Base Weee Tax Row Disposition',
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_SALES_FLAT_INVOICE_ITEM_PARENT_ID` (`parent_id`),
...
DROP TABLE IF EXISTS `shop_sales_flat_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_order` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  ...
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `UNQ_SHOP_SALES_FLAT_ORDER_INCREMENT_ID` (`increment_id`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_STATUS` (`status`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_STATE` (`state`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_CREATED_AT` (`created_at`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_CUSTOMER_ID` (`customer_id`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_EXT_ORDER_ID` (`ext_order_id`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_QUOTE_ID` (`quote_id`),
...
DROP TABLE IF EXISTS `shop_sales_flat_order_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_order_address` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `parent_id` int(10) unsigned DEFAULT NULL COMMENT 'Parent Id',
...
DROP TABLE IF EXISTS `shop_sales_flat_order_grid`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_order_grid` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity Id',
  `status` varchar(32) DEFAULT NULL COMMENT 'Status',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `store_name` varchar(255) DEFAULT NULL COMMENT 'Store Name',
  ...
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'Updated At',
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `UNQ_SHOP_SALES_FLAT_ORDER_GRID_INCREMENT_ID` (`increment_id`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_GRID_STATUS` (`status`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_GRID_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_GRID_BASE_GRAND_TOTAL` (`base_grand_total`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_GRID_BASE_TOTAL_PAID` (`base_total_paid`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_GRID_GRAND_TOTAL` (`grand_total`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_GRID_TOTAL_PAID` (`total_paid`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_GRID_SHIPPING_NAME` (`shipping_name`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_GRID_BILLING_NAME` (`billing_name`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_GRID_CREATED_AT` (`created_at`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_GRID_CUSTOMER_ID` (`customer_id`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_GRID_UPDATED_AT` (`updated_at`),
  CONSTRAINT `FK_DC3C0243E774B887CEDE45E88A6DB700` FOREIGN KEY (`entity_id`) REFERENCES `shop_sales_flat_order` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_SALES_FLAT_ORDER_GRID_CSTR_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_sales_flat_order_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_order_item` (
  `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Item Id',
  ...
  `base_weee_tax_row_disposition` decimal(12,4) DEFAULT NULL COMMENT 'Base Weee Tax Row Disposition',
  PRIMARY KEY (`item_id`),
  KEY `IDX_SHOP_SALES_FLAT_ORDER_ITEM_ORDER_ID` (`order_id`),
...
DROP TABLE IF EXISTS `shop_sales_flat_order_payment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_order_payment` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent Id',
...
DROP TABLE IF EXISTS `shop_sales_flat_order_status_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_order_status_history` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent Id',
  `is_customer_notified` int(11) DEFAULT NULL COMMENT 'Is Customer Notified',
  `is_visible_on_front` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Is Visible On Front',
...
DROP TABLE IF EXISTS `shop_sales_flat_quote`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_quote` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store Id',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Updated At',
...
INSERT INTO `shop_sales_flat_quote` VALUES (1,1,'2015-07-02 07:35:13','2015-07-02 10:07:24',NULL,1,0,0,2,4.0000,0,1.0000,1.0000,'USD','USD','USD',141.0000,141.0000,NULL,NULL,3,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,'127.0.0.1',NULL,NULL,NULL,NULL,'USD',1.0000,1.0000,NULL,NULL,141.0000,141.0000,141.0000,141.0000,1,0,NULL,NULL,0);
...
DROP TABLE IF EXISTS `shop_sales_flat_quote_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_quote_address` (
...
INSERT INTO `shop_sales_flat_quote_address` VALUES (1,1,'2015-07-02 07:35:13','2015-07-02 10:07:24',NULL,0,NULL,'billing',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,0,NULL,NULL,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,NULL,'a:0:{}',NULL,NULL,NULL,0.0000,NULL,NULL,NULL,NULL,NULL,0.0000,0.0000,NULL,NULL,NULL,NULL,NULL,NULL),(2,1,'2015-07-02 07:35:13','2015-07-02 10:07:24',NULL,0,NULL,'shipping',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,0,NULL,NULL,147.0000,141.0000,141.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,141.0000,141.0000,NULL,'a:0:{}',NULL,0.0000,0.0000,141.0000,NULL,0.0000,0.0000,0.0000,NULL,0.0000,0.0000,NULL,NULL,NULL,NULL,NULL,NULL);
...
DROP TABLE IF EXISTS `shop_sales_flat_quote_address_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_quote_address_item` (
  ...
  KEY `IDX_SHOP_SALES_FLAT_QUOTE_ADDRESS_ITEM_QUOTE_ADDRESS_ID` (`quote_address_id`),
  KEY `IDX_SHOP_SALES_FLAT_QUOTE_ADDRESS_ITEM_PARENT_ITEM_ID` (`parent_item_id`),
  KEY `IDX_SHOP_SALES_FLAT_QUOTE_ADDRESS_ITEM_QUOTE_ITEM_ID` (`quote_item_id`),
  CONSTRAINT `FK_0C8D43CD5D4DACA204423493927520B5` FOREIGN KEY (`quote_item_id`) REFERENCES `shop_sales_flat_quote_item` (`item_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_A964F4E8D02F8C18EEF84856B7D29B3A` FOREIGN KEY (`parent_item_id`) REFERENCES `shop_sales_flat_quote_address_item` (`address_item_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_sales_flat_quote_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_quote_item` (
  `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Item Id',
  `quote_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Quote Id',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Updated At',
  ...
  `base_weee_tax_applied_row_amnt` decimal(12,4) DEFAULT NULL COMMENT 'Base Weee Tax Applied Row Amnt',
  PRIMARY KEY (`item_id`),
  KEY `IDX_SHOP_SALES_FLAT_QUOTE_ITEM_PARENT_ITEM_ID` (`parent_item_id`),
  KEY `IDX_SHOP_SALES_FLAT_QUOTE_ITEM_PRODUCT_ID` (`product_id`),
  KEY `IDX_SHOP_SALES_FLAT_QUOTE_ITEM_QUOTE_ID` (`quote_id`),
  KEY `IDX_SHOP_SALES_FLAT_QUOTE_ITEM_STORE_ID` (`store_id`),
  CONSTRAINT `FK_513150D1C91775308653D881845C4BDD` FOREIGN KEY (`quote_id`) REFERENCES `shop_sales_flat_quote` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `shop_sales_flat_quote_item` VALUES (15,1,'2015-07-02 10:00:43','2015-07-02 10:07:14',1,1,NULL,0,'k','Botelya',NULL,NULL,NULL,0,0,0,12.0000,3.0000,10.0000,10.0000,NULL,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,30.0000,30.0000,0.0000,36.0000,'simple',NULL,NULL,NULL,NULL,NULL,10.0000,10.0000,30.0000,30.0000,0.0000,0.0000,NULL,0.0000,0.0000,0.0000,0.0000,'a:0:{}',0.0000,0.0000,0.0000,NULL),(16,1,'2015-07-02 10:00:52','2015-07-02 10:00:52',2,1,NULL,0,'3333','simple 2',NULL,NULL,NULL,0,0,0,111.0000,1.0000,111.0000,111.0000,NULL,0.0000,0.0000,0.0000,0.0000,0.0000,0.0000,111.0000,111.0000,0.0000,111.0000,'simple',NULL,NULL,NULL,NULL,NULL,111.0000,111.0000,111.0000,111.0000,0.0000,0.0000,NULL,0.0000,0.0000,0.0000,0.0000,'a:0:{}',0.0000,0.0000,0.0000,NULL);
...
DROP TABLE IF EXISTS `shop_sales_flat_quote_item_option`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_quote_item_option` (
  `option_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Id',
...
INSERT INTO `shop_sales_flat_quote_item_option` VALUES (15,15,1,'info_buyRequest','a:4:{s:4:\"uenc\";s:32:\"aHR0cDovL3Byb2pzaGlwbWVudC5jb20v\";s:7:\"product\";s:1:\"1\";s:8:\"form_key\";s:16:\"A1zpV3UjfDxoFfr5\";s:3:\"qty\";s:1:\"1\";}'),(16,16,2,'info_buyRequest','a:4:{s:4:\"uenc\";s:32:\"aHR0cDovL3Byb2pzaGlwbWVudC5jb20v\";s:7:\"product\";s:1:\"2\";s:8:\"form_key\";s:16:\"A1zpV3UjfDxoFfr5\";s:3:\"qty\";s:1:\"1\";}');
...
DROP TABLE IF EXISTS `shop_sales_flat_quote_payment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_quote_payment` (
...
DROP TABLE IF EXISTS `shop_sales_flat_quote_shipping_rate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_quote_shipping_rate` (
...
DROP TABLE IF EXISTS `shop_sales_flat_shipment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_shipment` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  ...
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `UNQ_SHOP_SALES_FLAT_SHIPMENT_INCREMENT_ID` (`increment_id`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_TOTAL_QTY` (`total_qty`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_ORDER_ID` (`order_id`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_CREATED_AT` (`created_at`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_UPDATED_AT` (`updated_at`),
  CONSTRAINT `FK_DF7C9A63D5D367C647D3A74FBA8719AA` FOREIGN KEY (`order_id`) REFERENCES `shop_sales_flat_order` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_SALES_FLAT_SHIPMENT_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_flat_shipment_comment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_shipment_comment` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent Id',
  `is_customer_notified` int(11) DEFAULT NULL COMMENT 'Is Customer Notified',
  `is_visible_on_front` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Is Visible On Front',
  ...
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'Created At',
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_COMMENT_CREATED_AT` (`created_at`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_COMMENT_PARENT_ID` (`parent_id`),
...
DROP TABLE IF EXISTS `shop_sales_flat_shipment_grid`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_shipment_grid` (
  `entity_id` int(10) unsigned NOT NULL COMMENT 'Entity Id',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `total_qty` decimal(12,4) DEFAULT NULL COMMENT 'Total Qty',
  `order_id` int(10) unsigned NOT NULL COMMENT 'Order Id',
  ...
  `shipping_name` varchar(255) DEFAULT NULL COMMENT 'Shipping Name',
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `UNQ_SHOP_SALES_FLAT_SHIPMENT_GRID_INCREMENT_ID` (`increment_id`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_GRID_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_GRID_TOTAL_QTY` (`total_qty`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_GRID_ORDER_ID` (`order_id`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_GRID_SHIPMENT_STATUS` (`shipment_status`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_GRID_ORDER_INCREMENT_ID` (`order_increment_id`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_GRID_CREATED_AT` (`created_at`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_GRID_ORDER_CREATED_AT` (`order_created_at`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_GRID_SHIPPING_NAME` (`shipping_name`),
  CONSTRAINT `FK_626D1FE78E21975F8E2E28C6EE8412D3` FOREIGN KEY (`entity_id`) REFERENCES `shop_sales_flat_shipment` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_ADC3C222E4B5D939570F62E052DD3ED5` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_flat_shipment_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_shipment_item` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent Id',
  `row_total` decimal(12,4) DEFAULT NULL COMMENT 'Row Total',
  `price` decimal(12,4) DEFAULT NULL COMMENT 'Price',
  ...
  `sku` varchar(255) DEFAULT NULL COMMENT 'Sku',
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_ITEM_PARENT_ID` (`parent_id`),
...
DROP TABLE IF EXISTS `shop_sales_flat_shipment_track`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_flat_shipment_track` (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `parent_id` int(10) unsigned NOT NULL COMMENT 'Parent Id',
  `weight` decimal(12,4) DEFAULT NULL COMMENT 'Weight',
  `qty` decimal(12,4) DEFAULT NULL COMMENT 'Qty',
  ...
  `updated_at` timestamp NULL DEFAULT NULL COMMENT 'Updated At',
  PRIMARY KEY (`entity_id`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_TRACK_PARENT_ID` (`parent_id`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_TRACK_ORDER_ID` (`order_id`),
  KEY `IDX_SHOP_SALES_FLAT_SHIPMENT_TRACK_CREATED_AT` (`created_at`),
  CONSTRAINT `FK_33ADBCF7B45F5FC70CC068612D6F0616` FOREIGN KEY (`parent_id`) REFERENCES `shop_sales_flat_shipment` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_invoiced_aggregated`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_invoiced_aggregated` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `order_status` varchar(50) DEFAULT NULL COMMENT 'Order Status',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_SALES_INVOICED_AGGREGATED_PERIOD_STORE_ID_ORDER_STATUS` (`period`,`store_id`,`order_status`),
  KEY `IDX_SHOP_SALES_INVOICED_AGGREGATED_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_SALES_INVOICED_AGGRED_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_invoiced_aggregated_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_invoiced_aggregated_order` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  ...
  `invoiced_not_captured` decimal(12,4) DEFAULT NULL COMMENT 'Invoiced Not Captured',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_SALES_INVOICED_AGGRED_ORDER_PERIOD_STORE_ID_ORDER_STS` (`period`,`store_id`,`order_status`),
  KEY `IDX_SHOP_SALES_INVOICED_AGGREGATED_ORDER_STORE_ID` (`store_id`),
...
DROP TABLE IF EXISTS `shop_sales_order_aggregated_created`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_order_aggregated_created` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `order_status` varchar(50) NOT NULL DEFAULT '' COMMENT 'Order Status',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_SALES_ORDER_AGGRED_CREATED_PERIOD_STORE_ID_ORDER_STS` (`period`,`store_id`,`order_status`),
  KEY `IDX_SHOP_SALES_ORDER_AGGREGATED_CREATED_STORE_ID` (`store_id`),
  CONSTRAINT `FK_40C8B8B519B87D072205A72A07E3A563` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_order_aggregated_updated`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_order_aggregated_updated` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  ...
  `total_discount_amount_actual` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Total Discount Amount Actual',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_SALES_ORDER_AGGRED_UPDATED_PERIOD_STORE_ID_ORDER_STS` (`period`,`store_id`,`order_status`),
  KEY `IDX_SHOP_SALES_ORDER_AGGREGATED_UPDATED_STORE_ID` (`store_id`),
  CONSTRAINT `FK_55ECF8FEEBBD12BC237A21A26473E19F` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Shop Sales Order Aggregated Updated';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `shop_sales_order_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_order_status` (
...
DROP TABLE IF EXISTS `shop_sales_order_status_label`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_order_status_label` (
  `status` varchar(32) NOT NULL COMMENT 'Status',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store Id',
  `label` varchar(128) NOT NULL COMMENT 'Label',
  PRIMARY KEY (`status`,`store_id`),
  KEY `IDX_SHOP_SALES_ORDER_STATUS_LABEL_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_SALES_ORDER_STS_LBL_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_SALES_ORDER_STS_LBL_STS_SHOP_SALES_ORDER_STS_STS` FOREIGN KEY (`status`) REFERENCES `shop_sales_order_status` (`status`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_order_status_state`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_order_status_state` (
  `status` varchar(32) NOT NULL COMMENT 'Status',
...
DROP TABLE IF EXISTS `shop_sales_order_tax`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_order_tax` (
  ...
  PRIMARY KEY (`tax_id`),
  KEY `IDX_SHOP_SALES_ORDER_TAX_ORDER_ID_PRIORITY_POSITION` (`order_id`,`priority`,`position`)
...
DROP TABLE IF EXISTS `shop_sales_order_tax_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_order_tax_item` (
  `tax_item_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Tax Item Id',
  `tax_id` int(10) unsigned NOT NULL COMMENT 'Tax Id',
  `item_id` int(10) unsigned NOT NULL COMMENT 'Item Id',
  `tax_percent` decimal(12,4) NOT NULL COMMENT 'Real Tax Percent For Item',
  PRIMARY KEY (`tax_item_id`),
  UNIQUE KEY `UNQ_SHOP_SALES_ORDER_TAX_ITEM_TAX_ID_ITEM_ID` (`tax_id`,`item_id`),
  KEY `IDX_SHOP_SALES_ORDER_TAX_ITEM_TAX_ID` (`tax_id`),
  KEY `IDX_SHOP_SALES_ORDER_TAX_ITEM_ITEM_ID` (`item_id`),
  CONSTRAINT `FK_47CE12E66BDF255FCFDA31CA313598BA` FOREIGN KEY (`item_id`) REFERENCES `shop_sales_flat_order_item` (`item_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_sales_payment_transaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_payment_transaction` (
  ...
  `created_at` timestamp NULL DEFAULT NULL COMMENT 'Created At',
  PRIMARY KEY (`transaction_id`),
  UNIQUE KEY `UNQ_SHOP_SALES_PAYMENT_TRANSACTION_ORDER_ID_PAYMENT_ID_TXN_ID` (`order_id`,`payment_id`,`txn_id`),
  KEY `IDX_SHOP_SALES_PAYMENT_TRANSACTION_ORDER_ID` (`order_id`),
  KEY `IDX_SHOP_SALES_PAYMENT_TRANSACTION_PARENT_ID` (`parent_id`),
  KEY `IDX_SHOP_SALES_PAYMENT_TRANSACTION_PAYMENT_ID` (`payment_id`),
...
DROP TABLE IF EXISTS `shop_sales_recurring_profile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_recurring_profile` (
  `profile_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Profile Id',
  ...
  PRIMARY KEY (`profile_id`),
  UNIQUE KEY `UNQ_SHOP_SALES_RECURRING_PROFILE_INTERNAL_REFERENCE_ID` (`internal_reference_id`),
  KEY `IDX_SHOP_SALES_RECURRING_PROFILE_CUSTOMER_ID` (`customer_id`),
  KEY `IDX_SHOP_SALES_RECURRING_PROFILE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_68FD06A7A7DF845258C83CCFA3450EEC` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_SALES_RECURRING_PROFILE_CSTR_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_recurring_profile_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_recurring_profile_order` (
  `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Link Id',
  `profile_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Profile Id',
  `order_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Order Id',
  PRIMARY KEY (`link_id`),
  UNIQUE KEY `UNQ_SHOP_SALES_RECURRING_PROFILE_ORDER_PROFILE_ID_ORDER_ID` (`profile_id`,`order_id`),
  KEY `IDX_SHOP_SALES_RECURRING_PROFILE_ORDER_ORDER_ID` (`order_id`),
  CONSTRAINT `FK_0B7CFFEB171DA26BB7E890393EF938A1` FOREIGN KEY (`order_id`) REFERENCES `shop_sales_flat_order` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_sales_refunded_aggregated`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_refunded_aggregated` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `order_status` varchar(50) NOT NULL DEFAULT '' COMMENT 'Order Status',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_SALES_REFUNDED_AGGREGATED_PERIOD_STORE_ID_ORDER_STATUS` (`period`,`store_id`,`order_status`),
  KEY `IDX_SHOP_SALES_REFUNDED_AGGREGATED_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_SALES_REFUNDED_AGGRED_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_refunded_aggregated_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_refunded_aggregated_order` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `order_status` varchar(50) DEFAULT NULL COMMENT 'Order Status',
  ...
  `offline_refunded` decimal(12,4) DEFAULT NULL COMMENT 'Offline Refunded',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_SHOP_SALES_REFUNDED_AGGRED_ORDER_PERIOD_STORE_ID_ORDER_STS` (`period`,`store_id`,`order_status`),
  KEY `IDX_SHOP_SALES_REFUNDED_AGGREGATED_ORDER_STORE_ID` (`store_id`),
...
DROP TABLE IF EXISTS `shop_sales_shipping_aggregated`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_shipping_aggregated` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `order_status` varchar(50) DEFAULT NULL COMMENT 'Order Status',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `F93C1F5386A15AF38FB85A23E0BD68E3` (`period`,`store_id`,`order_status`,`shipping_description`),
  KEY `IDX_SHOP_SALES_SHIPPING_AGGREGATED_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_SALES_SHPP_AGGRED_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sales_shipping_aggregated_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sales_shipping_aggregated_order` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `order_status` varchar(50) DEFAULT NULL COMMENT 'Order Status',
  ...
  `total_shipping_actual` decimal(12,4) DEFAULT NULL COMMENT 'Total Shipping Actual',
  PRIMARY KEY (`id`),
  UNIQUE KEY `6DC58EC26E732089576A16E0402AD2B6` (`period`,`store_id`,`order_status`,`shipping_description`),
  KEY `IDX_SHOP_SALES_SHIPPING_AGGREGATED_ORDER_STORE_ID` (`store_id`),
...
DROP TABLE IF EXISTS `shop_salesrule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_salesrule` (
  `rule_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Rule Id',
  `name` varchar(255) DEFAULT NULL COMMENT 'Name',
  `description` text COMMENT 'Description',
  ...
  PRIMARY KEY (`rule_id`),
  KEY `IDX_SHOP_SALESRULE_IS_ACTIVE_SORT_ORDER_TO_DATE_FROM_DATE` (`is_active`,`sort_order`,`to_date`,`from_date`)
...
DROP TABLE IF EXISTS `shop_salesrule_coupon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_salesrule_coupon` (
  ...
  UNIQUE KEY `UNQ_SHOP_SALESRULE_COUPON_CODE` (`code`),
  UNIQUE KEY `UNQ_SHOP_SALESRULE_COUPON_RULE_ID_IS_PRIMARY` (`rule_id`,`is_primary`),
  KEY `IDX_SHOP_SALESRULE_COUPON_RULE_ID` (`rule_id`),
  CONSTRAINT `FK_SHOP_SALESRULE_COUPON_RULE_ID_SHOP_SALESRULE_RULE_ID` FOREIGN KEY (`rule_id`) REFERENCES `shop_salesrule` (`rule_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_salesrule_coupon_usage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_salesrule_coupon_usage` (
  `coupon_id` int(10) unsigned NOT NULL COMMENT 'Coupon Id',
  `customer_id` int(10) unsigned NOT NULL COMMENT 'Customer Id',
  `times_used` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Times Used',
  PRIMARY KEY (`coupon_id`,`customer_id`),
  KEY `IDX_SHOP_SALESRULE_COUPON_USAGE_COUPON_ID` (`coupon_id`),
  KEY `IDX_SHOP_SALESRULE_COUPON_USAGE_CUSTOMER_ID` (`customer_id`),
  CONSTRAINT `FK_748383104D65AA118DA59D38C74B0493` FOREIGN KEY (`coupon_id`) REFERENCES `shop_salesrule_coupon` (`coupon_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_salesrule_customer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_salesrule_customer` (
  `rule_customer_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Rule Customer Id',
  `rule_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Rule Id',
  `customer_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Customer Id',
  `times_used` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Times Used',
  PRIMARY KEY (`rule_customer_id`),
  KEY `IDX_SHOP_SALESRULE_CUSTOMER_RULE_ID_CUSTOMER_ID` (`rule_id`,`customer_id`),
  KEY `IDX_SHOP_SALESRULE_CUSTOMER_CUSTOMER_ID_RULE_ID` (`customer_id`,`rule_id`),
  CONSTRAINT `FK_SHOP_SALESRULE_CSTR_CSTR_ID_SHOP_CSTR_ENTT_ENTT_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_SALESRULE_CUSTOMER_RULE_ID_SHOP_SALESRULE_RULE_ID` FOREIGN KEY (`rule_id`) REFERENCES `shop_salesrule` (`rule_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_salesrule_customer_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_salesrule_customer_group` (
  `rule_id` int(10) unsigned NOT NULL COMMENT 'Rule Id',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group Id',
  PRIMARY KEY (`rule_id`,`customer_group_id`),
  KEY `IDX_SHOP_SALESRULE_CUSTOMER_GROUP_RULE_ID` (`rule_id`),
  KEY `IDX_SHOP_SALESRULE_CUSTOMER_GROUP_CUSTOMER_GROUP_ID` (`customer_group_id`),
  CONSTRAINT `FK_5472D52088526220E35DAA79AFC9FCF5` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_salesrule_label`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_salesrule_label` (
  `label_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Label Id',
  `rule_id` int(10) unsigned NOT NULL COMMENT 'Rule Id',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store Id',
  `label` varchar(255) DEFAULT NULL COMMENT 'Label',
  PRIMARY KEY (`label_id`),
  UNIQUE KEY `UNQ_SHOP_SALESRULE_LABEL_RULE_ID_STORE_ID` (`rule_id`,`store_id`),
  KEY `IDX_SHOP_SALESRULE_LABEL_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_SALESRULE_LABEL_RULE_ID` (`rule_id`),
  CONSTRAINT `FK_SHOP_SALESRULE_LABEL_RULE_ID_SHOP_SALESRULE_RULE_ID` FOREIGN KEY (`rule_id`) REFERENCES `shop_salesrule` (`rule_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_salesrule_product_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_salesrule_product_attribute` (
  `rule_id` int(10) unsigned NOT NULL COMMENT 'Rule Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group Id',
  `attribute_id` smallint(5) unsigned NOT NULL COMMENT 'Attribute Id',
  PRIMARY KEY (`rule_id`,`website_id`,`customer_group_id`,`attribute_id`),
  KEY `IDX_SHOP_SALESRULE_PRODUCT_ATTRIBUTE_WEBSITE_ID` (`website_id`),
  KEY `IDX_SHOP_SALESRULE_PRODUCT_ATTRIBUTE_CUSTOMER_GROUP_ID` (`customer_group_id`),
  KEY `IDX_SHOP_SALESRULE_PRODUCT_ATTRIBUTE_ATTRIBUTE_ID` (`attribute_id`),
  CONSTRAINT `FK_1D75F0C86D35AD126464B36A6ADF842B` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `FK_SHOP_SALESRULE_PRD_ATTR_ATTR_ID_SHOP_EAV_ATTR_ATTR_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `FK_SHOP_SALESRULE_PRD_ATTR_RULE_ID_SHOP_SALESRULE_RULE_ID` FOREIGN KEY (`rule_id`) REFERENCES `shop_salesrule` (`rule_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `FK_SHOP_SALESRULE_PRD_ATTR_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
DROP TABLE IF EXISTS `shop_salesrule_website`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_salesrule_website` (
  `rule_id` int(10) unsigned NOT NULL COMMENT 'Rule Id',
  `website_id` smallint(5) unsigned NOT NULL COMMENT 'Website Id',
  PRIMARY KEY (`rule_id`,`website_id`),
  KEY `IDX_SHOP_SALESRULE_WEBSITE_RULE_ID` (`rule_id`),
  KEY `IDX_SHOP_SALESRULE_WEBSITE_WEBSITE_ID` (`website_id`),
  CONSTRAINT `FK_SHOP_SALESRULE_WEBSITE_RULE_ID_SHOP_SALESRULE_RULE_ID` FOREIGN KEY (`rule_id`) REFERENCES `shop_salesrule` (`rule_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_SALESRULE_WS_WS_ID_SHOP_CORE_WS_WS_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_sendfriend_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sendfriend_log` (
  `log_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Log ID',
  `ip` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT 'Customer IP address',
  `time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Log time',
  `website_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Website ID',
  PRIMARY KEY (`log_id`),
  KEY `IDX_SHOP_SENDFRIEND_LOG_IP` (`ip`),
...
DROP TABLE IF EXISTS `shop_shipping_tablerate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_shipping_tablerate` (
  ...
  PRIMARY KEY (`pk`),
  UNIQUE KEY `8372AC2A300B45FCF83351BF409FA298` (`website_id`,`dest_country_id`,`dest_region_id`,`dest_zip`,`condition_name`,`condition_value`)
...
DROP TABLE IF EXISTS `shop_sitemap`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_sitemap` (
  ...
  KEY `IDX_SHOP_SITEMAP_STORE_ID` (`store_id`),
...
CREATE TABLE `shop_tag` (
  ...
  PRIMARY KEY (`tag_id`),
  KEY `FK_SHOP_TAG_FIRST_CUSTOMER_ID_SHOP_CUSTOMER_ENTITY_ENTITY_ID` (`first_customer_id`),
  KEY `FK_SHOP_TAG_FIRST_STORE_ID_SHOP_CORE_STORE_STORE_ID` (`first_store_id`),
  CONSTRAINT `FK_SHOP_TAG_FIRST_CUSTOMER_ID_SHOP_CUSTOMER_ENTITY_ENTITY_ID` FOREIGN KEY (`first_customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  CONSTRAINT `FK_SHOP_TAG_FIRST_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`first_store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE NO ACTION
...
DROP TABLE IF EXISTS `shop_tag_properties`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_tag_properties` (
  `tag_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Tag Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store Id',
  `base_popularity` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Base Popularity',
  PRIMARY KEY (`tag_id`,`store_id`),
  KEY `IDX_SHOP_TAG_PROPERTIES_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_TAG_PROPERTIES_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_tag_relation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_tag_relation` (
  ...
  UNIQUE KEY `UNQ_SHOP_TAG_RELATION_TAG_ID_CUSTOMER_ID_PRODUCT_ID_STORE_ID` (`tag_id`,`customer_id`,`product_id`,`store_id`),
  KEY `IDX_SHOP_TAG_RELATION_PRODUCT_ID` (`product_id`),
  KEY `IDX_SHOP_TAG_RELATION_TAG_ID` (`tag_id`),
  KEY `IDX_SHOP_TAG_RELATION_CUSTOMER_ID` (`customer_id`),
  KEY `IDX_SHOP_TAG_RELATION_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_TAG_RELATION_CUSTOMER_ID_SHOP_CUSTOMER_ENTITY_ENTITY_ID` FOREIGN KEY (`customer_id`) REFERENCES `shop_customer_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_TAG_RELATION_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_TAG_RELATION_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_TAG_RELATION_TAG_ID_SHOP_TAG_TAG_ID` FOREIGN KEY (`tag_id`) REFERENCES `shop_tag` (`tag_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_tag_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_tag_summary` (
  `tag_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Tag Id',
  `store_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Store Id',
  ...
  `base_popularity` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Base Popularity',
  PRIMARY KEY (`tag_id`,`store_id`),
  KEY `IDX_SHOP_TAG_SUMMARY_STORE_ID` (`store_id`),
  KEY `IDX_SHOP_TAG_SUMMARY_TAG_ID` (`tag_id`),
  CONSTRAINT `FK_SHOP_TAG_SUMMARY_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_tax_calculation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_tax_calculation` (
  ...
  KEY `IDX_SHOP_TAX_CALCULATION_TAX_CALCULATION_RULE_ID` (`tax_calculation_rule_id`),
  KEY `IDX_SHOP_TAX_CALCULATION_TAX_CALCULATION_RATE_ID` (`tax_calculation_rate_id`),
  KEY `IDX_SHOP_TAX_CALCULATION_CUSTOMER_TAX_CLASS_ID` (`customer_tax_class_id`),
  KEY `IDX_SHOP_TAX_CALCULATION_PRODUCT_TAX_CLASS_ID` (`product_tax_class_id`),
  KEY `9F4F6EBA0D40EF45589C3F674080A735` (`tax_calculation_rate_id`,`customer_tax_class_id`,`product_tax_class_id`),
  CONSTRAINT `FK_06A6D325A088EEEBFE98E0919264D5EA` FOREIGN KEY (`tax_calculation_rule_id`) REFERENCES `shop_tax_calculation_rule` (`tax_calculation_rule_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_98F24A7BBE2332308FBBFD930E8B2DAA` FOREIGN KEY (`tax_calculation_rate_id`) REFERENCES `shop_tax_calculation_rate` (`tax_calculation_rate_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_TAX_CALC_CSTR_TAX_CLASS_ID_SHOP_TAX_CLASS_CLASS_ID` FOREIGN KEY (`customer_tax_class_id`) REFERENCES `shop_tax_class` (`class_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_TAX_CALC_PRD_TAX_CLASS_ID_SHOP_TAX_CLASS_CLASS_ID` FOREIGN KEY (`product_tax_class_id`) REFERENCES `shop_tax_class` (`class_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_tax_calculation_rate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_tax_calculation_rate` (
  ...
  KEY `IDX_SHOP_TAX_CALC_RATE_TAX_COUNTRY_ID_TAX_REGION_ID_TAX_POSTCODE` (`tax_country_id`,`tax_region_id`,`tax_postcode`),
  KEY `IDX_SHOP_TAX_CALCULATION_RATE_CODE` (`code`),
  KEY `1D9492B5D15FA216460FFCAE8D3A18F2` (`tax_calculation_rate_id`,`tax_country_id`,`tax_region_id`,`zip_is_range`,`tax_postcode`)
...
DROP TABLE IF EXISTS `shop_tax_calculation_rate_title`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_tax_calculation_rate_title` (
  `tax_calculation_rate_title_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Tax Calculation Rate Title Id',
  `tax_calculation_rate_id` int(11) NOT NULL COMMENT 'Tax Calculation Rate Id',
  `store_id` smallint(5) unsigned NOT NULL COMMENT 'Store Id',
  `value` varchar(255) NOT NULL COMMENT 'Value',
  PRIMARY KEY (`tax_calculation_rate_title_id`),
  KEY `IDX_SHOP_TAX_CALC_RATE_TTL_TAX_CALC_RATE_ID_STORE_ID` (`tax_calculation_rate_id`,`store_id`),
  KEY `IDX_SHOP_TAX_CALCULATION_RATE_TITLE_TAX_CALCULATION_RATE_ID` (`tax_calculation_rate_id`),
  KEY `IDX_SHOP_TAX_CALCULATION_RATE_TITLE_STORE_ID` (`store_id`),
  CONSTRAINT `FK_277BCD8C3A233644F13CAE4948856FEE` FOREIGN KEY (`tax_calculation_rate_id`) REFERENCES `shop_tax_calculation_rate` (`tax_calculation_rate_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_TAX_CALC_RATE_TTL_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_tax_calculation_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_tax_calculation_rule` (
  ...
  KEY `IDX_SHOP_TAX_CALC_RULE_PRIORITY_POSITION_TAX_CALC_RULE_ID` (`priority`,`position`,`tax_calculation_rule_id`),
  KEY `IDX_SHOP_TAX_CALCULATION_RULE_CODE` (`code`)
...
DROP TABLE IF EXISTS `shop_tax_order_aggregated_created`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_tax_order_aggregated_created` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `code` varchar(255) NOT NULL COMMENT 'Code',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `1A7927BFE75CE5D5D32C6F4A56D561D6` (`period`,`store_id`,`code`,`percent`,`order_status`),
  KEY `IDX_SHOP_TAX_ORDER_AGGREGATED_CREATED_STORE_ID` (`store_id`),
  CONSTRAINT `FK_C896E4840D5FC1CB6761A0AA12C42920` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_tax_order_aggregated_updated`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_tax_order_aggregated_updated` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Id',
  `period` date DEFAULT NULL COMMENT 'Period',
  `store_id` smallint(5) unsigned DEFAULT NULL COMMENT 'Store Id',
  `code` varchar(255) NOT NULL COMMENT 'Code',
  ...
  `tax_base_amount_sum` float DEFAULT NULL COMMENT 'Tax Base Amount Sum',
  PRIMARY KEY (`id`),
  UNIQUE KEY `EFD340A8C4AC5298C4D8EEF099CFB3FC` (`period`,`store_id`,`code`,`percent`,`order_status`),
  KEY `IDX_SHOP_TAX_ORDER_AGGREGATED_UPDATED_STORE_ID` (`store_id`),
  CONSTRAINT `FK_5AB906CB488698A8A679F5C4D9ED0FAD` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Shop Tax Order Aggregated Updated';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `shop_weee_discount`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_weee_discount` (
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  `website_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Website Id',
  `customer_group_id` smallint(5) unsigned NOT NULL COMMENT 'Customer Group Id',
  `value` decimal(12,4) NOT NULL DEFAULT '0.0000' COMMENT 'Value',
  KEY `IDX_SHOP_WEEE_DISCOUNT_WEBSITE_ID` (`website_id`),
  KEY `IDX_SHOP_WEEE_DISCOUNT_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_WEEE_DISCOUNT_CUSTOMER_GROUP_ID` (`customer_group_id`),
  CONSTRAINT `FK_07D663806C2BEB9256D762138FA66941` FOREIGN KEY (`customer_group_id`) REFERENCES `shop_customer_group` (`customer_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_WEEE_DISCOUNT_ENTT_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS `shop_weee_tax`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_weee_tax` (
  `value_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Value Id',
  `website_id` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT 'Website Id',
  `entity_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Entity Id',
  ...
  `entity_type_id` smallint(5) unsigned NOT NULL COMMENT 'Entity Type Id',
  PRIMARY KEY (`value_id`),
  KEY `IDX_SHOP_WEEE_TAX_WEBSITE_ID` (`website_id`),
  KEY `IDX_SHOP_WEEE_TAX_ENTITY_ID` (`entity_id`),
  KEY `IDX_SHOP_WEEE_TAX_COUNTRY` (`country`),
  KEY `IDX_SHOP_WEEE_TAX_ATTRIBUTE_ID` (`attribute_id`),
  CONSTRAINT `FK_SHOP_WEEE_TAX_ATTRIBUTE_ID_SHOP_EAV_ATTRIBUTE_ATTRIBUTE_ID` FOREIGN KEY (`attribute_id`) REFERENCES `shop_eav_attribute` (`attribute_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_WEEE_TAX_COUNTRY_SHOP_DIRECTORY_COUNTRY_COUNTRY_ID` FOREIGN KEY (`country`) REFERENCES `shop_directory_country` (`country_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_WEEE_TAX_ENTITY_ID_SHOP_CATALOG_PRODUCT_ENTITY_ENTITY_ID` FOREIGN KEY (`entity_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_WEEE_TAX_WEBSITE_ID_SHOP_CORE_WEBSITE_WEBSITE_ID` FOREIGN KEY (`website_id`) REFERENCES `shop_core_website` (`website_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_widget`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_widget` (
...
DROP TABLE IF EXISTS `shop_widget_instance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_widget_instance` (
...
DROP TABLE IF EXISTS `shop_widget_instance_page`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_widget_instance_page` (
  ...
  PRIMARY KEY (`page_id`),
  KEY `IDX_SHOP_WIDGET_INSTANCE_PAGE_INSTANCE_ID` (`instance_id`),
  CONSTRAINT `FK_503D386F1A6D9C3999F8D12722E3185D` FOREIGN KEY (`instance_id`) REFERENCES `shop_widget_instance` (`instance_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_widget_instance_page_layout`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_widget_instance_page_layout` (
  `page_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Page Id',
  `layout_update_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Layout Update Id',
  UNIQUE KEY `UNQ_SHOP_WIDGET_INSTANCE_PAGE_LAYOUT_LAYOUT_UPDATE_ID_PAGE_ID` (`layout_update_id`,`page_id`),
  KEY `IDX_SHOP_WIDGET_INSTANCE_PAGE_LAYOUT_PAGE_ID` (`page_id`),
  KEY `IDX_SHOP_WIDGET_INSTANCE_PAGE_LAYOUT_LAYOUT_UPDATE_ID` (`layout_update_id`),
  CONSTRAINT `FK_CDC4E118229C8DAF8CC6C7162750708D` FOREIGN KEY (`layout_update_id`) REFERENCES `shop_core_layout_update` (`layout_update_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `shop_wishlist` (
  ...
  UNIQUE KEY `UNQ_SHOP_WISHLIST_CUSTOMER_ID` (`customer_id`),
  KEY `IDX_SHOP_WISHLIST_SHARED` (`shared`),
...
DROP TABLE IF EXISTS `shop_wishlist_item`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_wishlist_item` (
  ...
  KEY `IDX_SHOP_WISHLIST_ITEM_WISHLIST_ID` (`wishlist_id`),
  KEY `IDX_SHOP_WISHLIST_ITEM_PRODUCT_ID` (`product_id`),
  KEY `IDX_SHOP_WISHLIST_ITEM_STORE_ID` (`store_id`),
  CONSTRAINT `FK_SHOP_WISHLIST_ITEM_PRD_ID_SHOP_CAT_PRD_ENTT_ENTT_ID` FOREIGN KEY (`product_id`) REFERENCES `shop_catalog_product_entity` (`entity_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_WISHLIST_ITEM_STORE_ID_SHOP_CORE_STORE_STORE_ID` FOREIGN KEY (`store_id`) REFERENCES `shop_core_store` (`store_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_SHOP_WISHLIST_ITEM_WISHLIST_ID_SHOP_WISHLIST_WISHLIST_ID` FOREIGN KEY (`wishlist_id`) REFERENCES `shop_wishlist` (`wishlist_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
DROP TABLE IF EXISTS `shop_wishlist_item_option`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shop_wishlist_item_option` (
  `option_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Option Id',
  ...
  `value` text COMMENT 'Value',
  PRIMARY KEY (`option_id`),
  KEY `FK_3E143B1B04D70B59F08F99BE7D8C2195` (`wishlist_item_id`),
...
-- Dump completed on 2015-07-03  8:42:16
